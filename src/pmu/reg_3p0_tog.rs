#[doc = "Reader of register REG_3P0_TOG"]
pub type R = crate::R<u32, super::REG_3P0_TOG>;
#[doc = "Writer for register REG_3P0_TOG"]
pub type W = crate::W<u32, super::REG_3P0_TOG>;
#[doc = "Register REG_3P0_TOG `reset()`'s with value 0x0f74"]
impl crate::ResetValue for super::REG_3P0_TOG {
    type Type = u32;
    #[inline(always)]
...
impl From<VBUS_SEL_A> for bool {
    ...
    fn from(variant: VBUS_SEL_A) -> Self {
        match variant {
            VBUS_SEL_A::USB_OTG2_VBUS => false,
            VBUS_SEL_A::USB_OTG1_VBUS => true,
        }
    }
}
