#[doc = "Reader of register REG_1P1_CLR"]
pub type R = crate::R<u32, super::REG_1P1_CLR>;
#[doc = "Writer for register REG_1P1_CLR"]
pub type W = crate::W<u32, super::REG_1P1_CLR>;
#[doc = "Register REG_1P1_CLR `reset()`'s with value 0x1073"]
impl crate::ResetValue for super::REG_1P1_CLR {
    type Type = u32;
    #[inline(always)]
...
impl From<SELREF_WEAK_LINREG_A> for bool {
    ...
    fn from(variant: SELREF_WEAK_LINREG_A) -> Self {
        match variant {
            SELREF_WEAK_LINREG_A::SELREF_WEAK_LINREG_0 => false,
            SELREF_WEAK_LINREG_A::SELREF_WEAK_LINREG_1 => true,
        }
    }
}
