#[doc = "Reader of register MISC0_TOG"]
pub type R = crate::R<u32, super::MISC0_TOG>;
#[doc = "Writer for register MISC0_TOG"]
pub type W = crate::W<u32, super::MISC0_TOG>;
#[doc = "Register MISC0_TOG `reset()`'s with value 0x0400_0000"]
impl crate::ResetValue for super::MISC0_TOG {
    type Type = u32;
    #[inline(always)]
...
impl From<VID_PLL_PREDIV_A> for bool {
    ...
    fn from(variant: VID_PLL_PREDIV_A) -> Self {
        match variant {
            VID_PLL_PREDIV_A::VID_PLL_PREDIV_0 => false,
            VID_PLL_PREDIV_A::VID_PLL_PREDIV_1 => true,
        }
    }
}
