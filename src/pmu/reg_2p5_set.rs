#[doc = "Reader of register REG_2P5_SET"]
pub type R = crate::R<u32, super::REG_2P5_SET>;
#[doc = "Writer for register REG_2P5_SET"]
pub type W = crate::W<u32, super::REG_2P5_SET>;
#[doc = "Register REG_2P5_SET `reset()`'s with value 0x1073"]
impl crate::ResetValue for super::REG_2P5_SET {
    type Type = u32;
    #[inline(always)]
