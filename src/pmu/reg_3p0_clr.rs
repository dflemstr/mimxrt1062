#[doc = "Reader of register REG_3P0_CLR"]
pub type R = crate::R<u32, super::REG_3P0_CLR>;
#[doc = "Writer for register REG_3P0_CLR"]
pub type W = crate::W<u32, super::REG_3P0_CLR>;
#[doc = "Register REG_3P0_CLR `reset()`'s with value 0x0f74"]
impl crate::ResetValue for super::REG_3P0_CLR {
    type Type = u32;
    #[inline(always)]
