...
pub enum IMB_A {
    #[doc = "0: If CAN_ESR2\\[VPS\\] is asserted, the CAN_ESR2\\[LPTM\\] is not an inactive Mailbox."]
    IMB_0,
    #[doc = "1: If CAN_ESR2\\[VPS\\] is asserted, there is at least one inactive Mailbox. LPTM content is the number of the first one."]
    IMB_1,
}
