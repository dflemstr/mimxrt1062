...
impl From<BOFFREC_A> for bool {
    ...
    fn from(variant: BOFFREC_A) -> Self {
        match variant {
            BOFFREC_A::BOFFREC_0 => false,
            BOFFREC_A::BOFFREC_1 => true,
        }
    }
}
...
impl From<RWRNMSK_A> for bool {
    ...
    fn from(variant: RWRNMSK_A) -> Self {
        match variant {
            RWRNMSK_A::RWRNMSK_0 => false,
            RWRNMSK_A::RWRNMSK_1 => true,
        }
    }
}
...
impl From<TWRNMSK_A> for bool {
    ...
    fn from(variant: TWRNMSK_A) -> Self {
        match variant {
            TWRNMSK_A::TWRNMSK_0 => false,
            TWRNMSK_A::TWRNMSK_1 => true,
        }
    }
}
...
impl From<CLKSRC_A> for bool {
    ...
    fn from(variant: CLKSRC_A) -> Self {
        match variant {
            CLKSRC_A::CLKSRC_0 => false,
            CLKSRC_A::CLKSRC_1 => true,
        }
    }
}
...
impl CLKSRC_R {
    ...
    pub fn variant(&self) -> CLKSRC_A {
        match self.bits {
            false => CLKSRC_A::CLKSRC_0,
            true => CLKSRC_A::CLKSRC_1,
        }
    }
...
impl From<ERRMSK_A> for bool {
    ...
    fn from(variant: ERRMSK_A) -> Self {
        match variant {
            ERRMSK_A::ERRMSK_0 => false,
            ERRMSK_A::ERRMSK_1 => true,
        }
    }
}
...
impl From<BOFFMSK_A> for bool {
    ...
    fn from(variant: BOFFMSK_A) -> Self {
        match variant {
            BOFFMSK_A::BOFFMSK_0 => false,
            BOFFMSK_A::BOFFMSK_1 => true,
        }
    }
}
