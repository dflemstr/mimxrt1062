...
impl From<WAKINT_A> for bool {
    ...
    fn from(variant: WAKINT_A) -> Self {
        match variant {
            WAKINT_A::WAKINT_0 => false,
            WAKINT_A::WAKINT_1 => true,
        }
    }
}
...
impl From<ERRINT_A> for bool {
    ...
    fn from(variant: ERRINT_A) -> Self {
        match variant {
            ERRINT_A::ERRINT_0 => false,
            ERRINT_A::ERRINT_1 => true,
        }
    }
}
...
impl From<BOFFINT_A> for bool {
    ...
    fn from(variant: BOFFINT_A) -> Self {
        match variant {
            BOFFINT_A::BOFFINT_0 => false,
            BOFFINT_A::BOFFINT_1 => true,
        }
    }
}
...
impl From<FLTCONF_A> for u8 {
    ...
    fn from(variant: FLTCONF_A) -> Self {
        match variant {
            FLTCONF_A::FLTCONF_0 => 0,
            FLTCONF_A::FLTCONF_1 => 1,
            FLTCONF_A::FLTCONF_2 => 2,
        }
    }
}
...
impl From<RXWRN_A> for bool {
    ...
    fn from(variant: RXWRN_A) -> Self {
        match variant {
            RXWRN_A::RXWRN_0 => false,
            RXWRN_A::RXWRN_1 => true,
        }
    }
}
...
impl From<TXWRN_A> for bool {
    ...
    fn from(variant: TXWRN_A) -> Self {
        match variant {
            TXWRN_A::TXWRN_0 => false,
            TXWRN_A::TXWRN_1 => true,
        }
    }
}
...
impl From<STFERR_A> for bool {
    ...
    fn from(variant: STFERR_A) -> Self {
        match variant {
            STFERR_A::STFERR_0 => false,
            STFERR_A::STFERR_1 => true,
        }
    }
}
...
impl From<FRMERR_A> for bool {
    ...
    fn from(variant: FRMERR_A) -> Self {
        match variant {
            FRMERR_A::FRMERR_0 => false,
            FRMERR_A::FRMERR_1 => true,
        }
    }
}
...
impl From<CRCERR_A> for bool {
    ...
    fn from(variant: CRCERR_A) -> Self {
        match variant {
            CRCERR_A::CRCERR_0 => false,
            CRCERR_A::CRCERR_1 => true,
        }
    }
}
...
impl From<ACKERR_A> for bool {
    ...
    fn from(variant: ACKERR_A) -> Self {
        match variant {
            ACKERR_A::ACKERR_0 => false,
            ACKERR_A::ACKERR_1 => true,
        }
    }
}
...
impl From<BIT0ERR_A> for bool {
    ...
    fn from(variant: BIT0ERR_A) -> Self {
        match variant {
            BIT0ERR_A::BIT0ERR_0 => false,
            BIT0ERR_A::BIT0ERR_1 => true,
        }
    }
}
...
impl From<BIT1ERR_A> for bool {
    ...
    fn from(variant: BIT1ERR_A) -> Self {
        match variant {
            BIT1ERR_A::BIT1ERR_0 => false,
            BIT1ERR_A::BIT1ERR_1 => true,
        }
    }
}
...
impl From<RWRNINT_A> for bool {
    ...
    fn from(variant: RWRNINT_A) -> Self {
        match variant {
            RWRNINT_A::RWRNINT_0 => false,
            RWRNINT_A::RWRNINT_1 => true,
        }
    }
}
...
impl From<TWRNINT_A> for bool {
    ...
    fn from(variant: TWRNINT_A) -> Self {
        match variant {
            TWRNINT_A::TWRNINT_0 => false,
            TWRNINT_A::TWRNINT_1 => true,
        }
    }
}
...
impl From<SYNCH_A> for bool {
    ...
    fn from(variant: SYNCH_A) -> Self {
        match variant {
            SYNCH_A::SYNCH_0 => false,
            SYNCH_A::SYNCH_1 => true,
        }
    }
}
...
impl From<BOFFDONEINT_A> for bool {
    ...
    fn from(variant: BOFFDONEINT_A) -> Self {
        match variant {
            BOFFDONEINT_A::BOFFDONEINT_0 => false,
            BOFFDONEINT_A::BOFFDONEINT_1 => true,
        }
    }
}
...
impl From<ERRINT_FAST_A> for bool {
    ...
    fn from(variant: ERRINT_FAST_A) -> Self {
        match variant {
            ERRINT_FAST_A::ERRINT_FAST_0 => false,
            ERRINT_FAST_A::ERRINT_FAST_1 => true,
        }
    }
}
...
impl From<ERROVR_A> for bool {
    ...
    fn from(variant: ERROVR_A) -> Self {
        match variant {
            ERROVR_A::ERROVR_0 => false,
            ERROVR_A::ERROVR_1 => true,
        }
    }
}
...
impl From<STFERR_FAST_A> for bool {
    ...
    fn from(variant: STFERR_FAST_A) -> Self {
        match variant {
            STFERR_FAST_A::STFERR_FAST_0 => false,
            STFERR_FAST_A::STFERR_FAST_1 => true,
        }
    }
}
...
impl From<FRMERR_FAST_A> for bool {
    ...
    fn from(variant: FRMERR_FAST_A) -> Self {
        match variant {
            FRMERR_FAST_A::FRMERR_FAST_0 => false,
            FRMERR_FAST_A::FRMERR_FAST_1 => true,
        }
    }
}
...
impl From<CRCERR_FAST_A> for bool {
    ...
    fn from(variant: CRCERR_FAST_A) -> Self {
        match variant {
            CRCERR_FAST_A::CRCERR_FAST_0 => false,
            CRCERR_FAST_A::CRCERR_FAST_1 => true,
        }
    }
}
...
impl From<BIT0ERR_FAST_A> for bool {
    ...
    fn from(variant: BIT0ERR_FAST_A) -> Self {
        match variant {
            BIT0ERR_FAST_A::BIT0ERR_FAST_0 => false,
            BIT0ERR_FAST_A::BIT0ERR_FAST_1 => true,
        }
    }
}
...
impl From<BIT1ERR_FAST_A> for bool {
    ...
    fn from(variant: BIT1ERR_FAST_A) -> Self {
        match variant {
            BIT1ERR_FAST_A::BIT1ERR_FAST_0 => false,
            BIT1ERR_FAST_A::BIT1ERR_FAST_1 => true,
        }
    }
}
