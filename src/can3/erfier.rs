...
impl From<ERFDAIE_A> for bool {
    ...
    fn from(variant: ERFDAIE_A) -> Self {
        match variant {
            ERFDAIE_A::ERFDAIE_0 => false,
            ERFDAIE_A::ERFDAIE_1 => true,
        }
    }
}
...
impl From<ERFWMIIE_A> for bool {
    ...
    fn from(variant: ERFWMIIE_A) -> Self {
        match variant {
            ERFWMIIE_A::ERFWMIIE_0 => false,
            ERFWMIIE_A::ERFWMIIE_1 => true,
        }
    }
}
...
impl From<ERFOVFIE_A> for bool {
    ...
    fn from(variant: ERFOVFIE_A) -> Self {
        match variant {
            ERFOVFIE_A::ERFOVFIE_0 => false,
            ERFOVFIE_A::ERFOVFIE_1 => true,
        }
    }
}
...
impl From<ERFUFWIE_A> for bool {
    ...
    fn from(variant: ERFUFWIE_A) -> Self {
        match variant {
            ERFUFWIE_A::ERFUFWIE_0 => false,
            ERFUFWIE_A::ERFUFWIE_1 => true,
        }
    }
}
