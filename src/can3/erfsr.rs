...
impl From<ERFCLR_A> for bool {
    ...
    fn from(variant: ERFCLR_A) -> Self {
        match variant {
            ERFCLR_A::ERFCLR_0 => false,
            ERFCLR_A::ERFCLR_1 => true,
        }
    }
}
...
impl From<ERFDA_A> for bool {
    ...
    fn from(variant: ERFDA_A) -> Self {
        match variant {
            ERFDA_A::ERFDA_0 => false,
            ERFDA_A::ERFDA_1 => true,
        }
    }
}
...
impl From<ERFWMI_A> for bool {
    ...
    fn from(variant: ERFWMI_A) -> Self {
        match variant {
            ERFWMI_A::ERFWMI_0 => false,
            ERFWMI_A::ERFWMI_1 => true,
        }
    }
}
...
impl From<ERFOVF_A> for bool {
    ...
    fn from(variant: ERFOVF_A) -> Self {
        match variant {
            ERFOVF_A::ERFOVF_0 => false,
            ERFOVF_A::ERFOVF_1 => true,
        }
    }
}
...
impl From<ERFUFW_A> for bool {
    ...
    fn from(variant: ERFUFW_A) -> Self {
        match variant {
            ERFUFW_A::ERFUFW_0 => false,
            ERFUFW_A::ERFUFW_1 => true,
        }
    }
}
