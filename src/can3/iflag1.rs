...
impl From<BUF0I_A> for bool {
    ...
    fn from(variant: BUF0I_A) -> Self {
        match variant {
            BUF0I_A::BUF0I_0 => false,
            BUF0I_A::BUF0I_1 => true,
        }
    }
}
...
pub enum BUF5I_A {
    ...
    BUF5I_0,
    #[doc = "1: MB5 completed transmission/reception when CAN_MCR\\[RFEN\\]=0, or frame(s) available in the Legacy Rx FIFO when CAN_MCR\\[RFEN\\]=1. It generates a DMA request in case of CAN_MCR\\[RFEN\\] and CAN_MCR\\[DMA\\] are enabled."]
    BUF5I_1,
}
impl From<BUF5I_A> for bool {
    ...
    fn from(variant: BUF5I_A) -> Self {
        match variant {
            BUF5I_A::BUF5I_0 => false,
            BUF5I_A::BUF5I_1 => true,
        }
    }
}
...
impl From<BUF6I_A> for bool {
    ...
    fn from(variant: BUF6I_A) -> Self {
        match variant {
            BUF6I_A::BUF6I_0 => false,
            BUF6I_A::BUF6I_1 => true,
        }
    }
}
...
impl From<BUF7I_A> for bool {
    ...
    fn from(variant: BUF7I_A) -> Self {
        match variant {
            BUF7I_A::BUF7I_0 => false,
            BUF7I_A::BUF7I_1 => true,
        }
    }
}
