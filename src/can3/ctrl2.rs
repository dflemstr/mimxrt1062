...
impl From<TSTAMPCAP_A> for u8 {
    ...
    fn from(variant: TSTAMPCAP_A) -> Self {
        match variant {
            TSTAMPCAP_A::TSTAMPCAP_0 => 0,
            TSTAMPCAP_A::TSTAMPCAP_1 => 1,
            TSTAMPCAP_A::TSTAMPCAP_2 => 2,
            TSTAMPCAP_A::TSTAMPCAP_3 => 3,
        }
    }
}
...
impl From<MBTSBASE_A> for u8 {
    ...
    fn from(variant: MBTSBASE_A) -> Self {
        match variant {
            MBTSBASE_A::MBTSBASE_0 => 0,
            MBTSBASE_A::MBTSBASE_1 => 1,
            MBTSBASE_A::MBTSBASE_2 => 2,
        }
    }
}
...
impl From<EDFLTDIS_A> for bool {
    ...
    fn from(variant: EDFLTDIS_A) -> Self {
        match variant {
            EDFLTDIS_A::EDFLTDIS_0 => false,
            EDFLTDIS_A::EDFLTDIS_1 => true,
        }
    }
}
...
impl From<ISOCANFDEN_A> for bool {
    ...
    fn from(variant: ISOCANFDEN_A) -> Self {
        match variant {
            ISOCANFDEN_A::ISOCANFDEN_0 => false,
            ISOCANFDEN_A::ISOCANFDEN_1 => true,
        }
    }
}
...
impl From<PREXCEN_A> for bool {
    ...
    fn from(variant: PREXCEN_A) -> Self {
        match variant {
            PREXCEN_A::PREXCEN_0 => false,
            PREXCEN_A::PREXCEN_1 => true,
        }
    }
}
...
impl From<TIMER_SRC_A> for bool {
    ...
    fn from(variant: TIMER_SRC_A) -> Self {
        match variant {
            TIMER_SRC_A::TIMER_SRC_0 => false,
            TIMER_SRC_A::TIMER_SRC_1 => true,
        }
    }
}
...
impl From<EACEN_A> for bool {
    ...
    fn from(variant: EACEN_A) -> Self {
        match variant {
            EACEN_A::EACEN_0 => false,
            EACEN_A::EACEN_1 => true,
        }
    }
}
...
impl From<BOFFDONEMSK_A> for bool {
    ...
    fn from(variant: BOFFDONEMSK_A) -> Self {
        match variant {
            BOFFDONEMSK_A::BOFFDONEMSK_0 => false,
            BOFFDONEMSK_A::BOFFDONEMSK_1 => true,
        }
    }
}
...
impl From<ERRMSK_FAST_A> for bool {
    ...
    fn from(variant: ERRMSK_FAST_A) -> Self {
        match variant {
            ERRMSK_FAST_A::ERRMSK_FAST_0 => false,
            ERRMSK_FAST_A::ERRMSK_FAST_1 => true,
        }
    }
}
