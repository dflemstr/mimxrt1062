...
impl From<SATURATE_INSTRS_A> for u8 {
    ...
    fn from(variant: SATURATE_INSTRS_A) -> Self {
        match variant {
            SATURATE_INSTRS_A::SATURATE_INSTRS_0 => 0,
            SATURATE_INSTRS_A::SATURATE_INSTRS_1 => 1,
        }
    }
}
...
pub enum SIMD_INSTRS_A {
    ...
    SIMD_INSTRS_1,
    #[doc = "3: As for 1, and adds support for the PKHBT, PKHTB, QADD16, QADD8, QASX, QSUB16, QSUB8, QSAX, SADD16, SADD8, SASX, SEL, SHADD16, SHADD8, SHASX, SHSUB16, SHSUB8, SHSAX, SSAT16, SSUB16, SSUB8, SSAX, SXTAB16, SXTB16, UADD16, UADD8, UASX, UHADD16, UHADD8, UHASX, UHSUB16, UHSUB8, UHSAX, UQADD16, UQADD8, UQASX, UQSUB16, UQSUB8, UQSAX, USAD8, USADA8, USAT16, USUB16, USUB8, USAX, UXTAB16, and UXTB16 instructions. Also adds support for the GE\\[3:0\\] bits in the PSRs."]
    SIMD_INSTRS_3,
}
impl From<SIMD_INSTRS_A> for u8 {
    ...
    fn from(variant: SIMD_INSTRS_A) -> Self {
        match variant {
            SIMD_INSTRS_A::SIMD_INSTRS_0 => 0,
            SIMD_INSTRS_A::SIMD_INSTRS_1 => 1,
            SIMD_INSTRS_A::SIMD_INSTRS_3 => 3,
        }
    }
}
...
impl From<SVC_INSTRS_A> for u8 {
    ...
    fn from(variant: SVC_INSTRS_A) -> Self {
        match variant {
            SVC_INSTRS_A::SVC_INSTRS_0 => 0,
            SVC_INSTRS_A::SVC_INSTRS_1 => 1,
        }
    }
}
...
impl From<TABBRANCH_INSTRS_A> for u8 {
    ...
    fn from(variant: TABBRANCH_INSTRS_A) -> Self {
        match variant {
            TABBRANCH_INSTRS_A::TABBRANCH_INSTRS_0 => 0,
            TABBRANCH_INSTRS_A::TABBRANCH_INSTRS_1 => 1,
        }
    }
}
...
impl From<THUMBCOPY_INSTRS_A> for u8 {
    ...
    fn from(variant: THUMBCOPY_INSTRS_A) -> Self {
        match variant {
            THUMBCOPY_INSTRS_A::THUMBCOPY_INSTRS_0 => 0,
            THUMBCOPY_INSTRS_A::THUMBCOPY_INSTRS_1 => 1,
        }
    }
}
...
impl From<TRUENOP_INSTRS_A> for u8 {
    ...
    fn from(variant: TRUENOP_INSTRS_A) -> Self {
        match variant {
            TRUENOP_INSTRS_A::TRUENOP_INSTRS_0 => 0,
            TRUENOP_INSTRS_A::TRUENOP_INSTRS_1 => 1,
        }
    }
}
