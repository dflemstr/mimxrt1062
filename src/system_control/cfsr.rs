...
impl From<IACCVIOL_A> for bool {
    ...
    fn from(variant: IACCVIOL_A) -> Self {
        match variant {
            IACCVIOL_A::IACCVIOL_0 => false,
            IACCVIOL_A::IACCVIOL_1 => true,
        }
    }
}
...
impl From<DACCVIOL_A> for bool {
    ...
    fn from(variant: DACCVIOL_A) -> Self {
        match variant {
            DACCVIOL_A::DACCVIOL_0 => false,
            DACCVIOL_A::DACCVIOL_1 => true,
        }
    }
}
...
impl From<MUNSTKERR_A> for bool {
    ...
    fn from(variant: MUNSTKERR_A) -> Self {
        match variant {
            MUNSTKERR_A::MUNSTKERR_0 => false,
            MUNSTKERR_A::MUNSTKERR_1 => true,
        }
    }
}
...
impl From<MSTKERR_A> for bool {
    ...
    fn from(variant: MSTKERR_A) -> Self {
        match variant {
            MSTKERR_A::MSTKERR_0 => false,
            MSTKERR_A::MSTKERR_1 => true,
        }
    }
}
...
impl From<MLSPERR_A> for bool {
    ...
    fn from(variant: MLSPERR_A) -> Self {
        match variant {
            MLSPERR_A::MLSPERR_0 => false,
            MLSPERR_A::MLSPERR_1 => true,
        }
    }
}
...
impl From<MMARVALID_A> for bool {
    ...
    fn from(variant: MMARVALID_A) -> Self {
        match variant {
            MMARVALID_A::MMARVALID_0 => false,
            MMARVALID_A::MMARVALID_1 => true,
        }
    }
}
...
impl From<IBUSERR_A> for bool {
    ...
    fn from(variant: IBUSERR_A) -> Self {
        match variant {
            IBUSERR_A::IBUSERR_0 => false,
            IBUSERR_A::IBUSERR_1 => true,
        }
    }
}
...
impl From<PRECISERR_A> for bool {
    ...
    fn from(variant: PRECISERR_A) -> Self {
        match variant {
            PRECISERR_A::PRECISERR_0 => false,
            PRECISERR_A::PRECISERR_1 => true,
        }
    }
}
...
impl From<IMPRECISERR_A> for bool {
    ...
    fn from(variant: IMPRECISERR_A) -> Self {
        match variant {
            IMPRECISERR_A::IMPRECISERR_0 => false,
            IMPRECISERR_A::IMPRECISERR_1 => true,
        }
    }
}
...
impl From<UNSTKERR_A> for bool {
    ...
    fn from(variant: UNSTKERR_A) -> Self {
        match variant {
            UNSTKERR_A::UNSTKERR_0 => false,
            UNSTKERR_A::UNSTKERR_1 => true,
        }
    }
}
...
impl From<STKERR_A> for bool {
    ...
    fn from(variant: STKERR_A) -> Self {
        match variant {
            STKERR_A::STKERR_0 => false,
            STKERR_A::STKERR_1 => true,
        }
    }
}
...
impl From<LSPERR_A> for bool {
    ...
    fn from(variant: LSPERR_A) -> Self {
        match variant {
            LSPERR_A::LSPERR_0 => false,
            LSPERR_A::LSPERR_1 => true,
        }
    }
}
...
impl From<BFARVALID_A> for bool {
    ...
    fn from(variant: BFARVALID_A) -> Self {
        match variant {
            BFARVALID_A::BFARVALID_0 => false,
            BFARVALID_A::BFARVALID_1 => true,
        }
    }
}
...
impl From<UNDEFINSTR_A> for bool {
    ...
    fn from(variant: UNDEFINSTR_A) -> Self {
        match variant {
            UNDEFINSTR_A::UNDEFINSTR_0 => false,
            UNDEFINSTR_A::UNDEFINSTR_1 => true,
        }
    }
}
...
impl From<INVSTATE_A> for bool {
    ...
    fn from(variant: INVSTATE_A) -> Self {
        match variant {
            INVSTATE_A::INVSTATE_0 => false,
            INVSTATE_A::INVSTATE_1 => true,
        }
    }
}
...
impl From<INVPC_A> for bool {
    ...
    fn from(variant: INVPC_A) -> Self {
        match variant {
            INVPC_A::INVPC_0 => false,
            INVPC_A::INVPC_1 => true,
        }
    }
}
...
impl From<UNALIGNED_A> for bool {
    ...
    fn from(variant: UNALIGNED_A) -> Self {
        match variant {
            UNALIGNED_A::UNALIGNED_0 => false,
            UNALIGNED_A::UNALIGNED_1 => true,
        }
    }
}
...
impl From<DIVBYZERO_A> for bool {
    ...
    fn from(variant: DIVBYZERO_A) -> Self {
        match variant {
            DIVBYZERO_A::DIVBYZERO_0 => false,
            DIVBYZERO_A::DIVBYZERO_1 => true,
        }
    }
}
