...
impl From<SLEEPONEXIT_A> for bool {
    ...
    fn from(variant: SLEEPONEXIT_A) -> Self {
        match variant {
            SLEEPONEXIT_A::SLEEPONEXIT_0 => false,
            SLEEPONEXIT_A::SLEEPONEXIT_1 => true,
        }
    }
}
...
impl From<SLEEPDEEP_A> for bool {
    ...
    fn from(variant: SLEEPDEEP_A) -> Self {
        match variant {
            SLEEPDEEP_A::SLEEPDEEP_0 => false,
            SLEEPDEEP_A::SLEEPDEEP_1 => true,
        }
    }
}
...
impl From<SEVONPEND_A> for bool {
    ...
    fn from(variant: SEVONPEND_A) -> Self {
        match variant {
            SEVONPEND_A::SEVONPEND_0 => false,
            SEVONPEND_A::SEVONPEND_1 => true,
        }
    }
}
