...
impl From<LOADSTORE_INSTRS_A> for u8 {
    ...
    fn from(variant: LOADSTORE_INSTRS_A) -> Self {
        match variant {
            LOADSTORE_INSTRS_A::LOADSTORE_INSTRS_0 => 0,
            LOADSTORE_INSTRS_A::LOADSTORE_INSTRS_1 => 1,
        }
    }
}
...
impl From<MEMHINT_INSTRS_A> for u8 {
    ...
    fn from(variant: MEMHINT_INSTRS_A) -> Self {
        match variant {
            MEMHINT_INSTRS_A::MEMHINT_INSTRS_0 => 0,
            MEMHINT_INSTRS_A::MEMHINT_INSTRS_1 => 1,
            MEMHINT_INSTRS_A::MEMHINT_INSTRS_2 => 2,
            MEMHINT_INSTRS_A::MEMHINT_INSTRS_3 => 3,
        }
    }
}
...
impl From<MULTIACCESSINT_INSTRS_A> for u8 {
    ...
    fn from(variant: MULTIACCESSINT_INSTRS_A) -> Self {
        match variant {
            MULTIACCESSINT_INSTRS_A::MULTIACCESSINT_INSTRS_0 => 0,
            MULTIACCESSINT_INSTRS_A::MULTIACCESSINT_INSTRS_1 => 1,
            MULTIACCESSINT_INSTRS_A::MULTIACCESSINT_INSTRS_2 => 2,
        }
    }
}
...
impl From<MULT_INSTRS_A> for u8 {
    ...
    fn from(variant: MULT_INSTRS_A) -> Self {
        match variant {
            MULT_INSTRS_A::MULT_INSTRS_0 => 0,
            MULT_INSTRS_A::MULT_INSTRS_1 => 1,
            MULT_INSTRS_A::MULT_INSTRS_2 => 2,
        }
    }
}
...
impl From<MULTS_INSTRS_A> for u8 {
    ...
    fn from(variant: MULTS_INSTRS_A) -> Self {
        match variant {
            MULTS_INSTRS_A::MULTS_INSTRS_0 => 0,
            MULTS_INSTRS_A::MULTS_INSTRS_1 => 1,
            MULTS_INSTRS_A::MULTS_INSTRS_2 => 2,
            MULTS_INSTRS_A::MULTS_INSTRS_3 => 3,
        }
    }
}
...
impl From<MULTU_INSTRS_A> for u8 {
    ...
    fn from(variant: MULTU_INSTRS_A) -> Self {
        match variant {
            MULTU_INSTRS_A::MULTU_INSTRS_0 => 0,
            MULTU_INSTRS_A::MULTU_INSTRS_1 => 1,
            MULTU_INSTRS_A::MULTU_INSTRS_2 => 2,
        }
    }
}
...
impl From<REVERSAL_INSTRS_A> for u8 {
    ...
    fn from(variant: REVERSAL_INSTRS_A) -> Self {
        match variant {
            REVERSAL_INSTRS_A::REVERSAL_INSTRS_0 => 0,
            REVERSAL_INSTRS_A::REVERSAL_INSTRS_1 => 1,
            REVERSAL_INSTRS_A::REVERSAL_INSTRS_2 => 2,
        }
    }
}
