...
impl From<MEMFAULTACT_A> for bool {
    ...
    fn from(variant: MEMFAULTACT_A) -> Self {
        match variant {
            MEMFAULTACT_A::MEMFAULTACT_0 => false,
            MEMFAULTACT_A::MEMFAULTACT_1 => true,
        }
    }
}
...
impl From<BUSFAULTACT_A> for bool {
    ...
    fn from(variant: BUSFAULTACT_A) -> Self {
        match variant {
            BUSFAULTACT_A::BUSFAULTACT_0 => false,
            BUSFAULTACT_A::BUSFAULTACT_1 => true,
        }
    }
}
...
impl From<USGFAULTACT_A> for bool {
    ...
    fn from(variant: USGFAULTACT_A) -> Self {
        match variant {
            USGFAULTACT_A::USGFAULTACT_0 => false,
            USGFAULTACT_A::USGFAULTACT_1 => true,
        }
    }
}
...
impl From<SVCALLACT_A> for bool {
    ...
    fn from(variant: SVCALLACT_A) -> Self {
        match variant {
            SVCALLACT_A::SVCALLACT_0 => false,
            SVCALLACT_A::SVCALLACT_1 => true,
        }
    }
}
...
impl From<MONITORACT_A> for bool {
    ...
    fn from(variant: MONITORACT_A) -> Self {
        match variant {
            MONITORACT_A::MONITORACT_0 => false,
            MONITORACT_A::MONITORACT_1 => true,
        }
    }
}
...
impl From<PENDSVACT_A> for bool {
    ...
    fn from(variant: PENDSVACT_A) -> Self {
        match variant {
            PENDSVACT_A::PENDSVACT_0 => false,
            PENDSVACT_A::PENDSVACT_1 => true,
        }
    }
}
...
impl From<SYSTICKACT_A> for bool {
    ...
    fn from(variant: SYSTICKACT_A) -> Self {
        match variant {
            SYSTICKACT_A::SYSTICKACT_0 => false,
            SYSTICKACT_A::SYSTICKACT_1 => true,
        }
    }
}
...
impl From<USGFAULTPENDED_A> for bool {
    ...
    fn from(variant: USGFAULTPENDED_A) -> Self {
        match variant {
            USGFAULTPENDED_A::USGFAULTPENDED_0 => false,
            USGFAULTPENDED_A::USGFAULTPENDED_1 => true,
        }
    }
}
...
impl From<MEMFAULTPENDED_A> for bool {
    ...
    fn from(variant: MEMFAULTPENDED_A) -> Self {
        match variant {
            MEMFAULTPENDED_A::MEMFAULTPENDED_0 => false,
            MEMFAULTPENDED_A::MEMFAULTPENDED_1 => true,
        }
    }
}
...
impl From<BUSFAULTPENDED_A> for bool {
    ...
    fn from(variant: BUSFAULTPENDED_A) -> Self {
        match variant {
            BUSFAULTPENDED_A::BUSFAULTPENDED_0 => false,
            BUSFAULTPENDED_A::BUSFAULTPENDED_1 => true,
        }
    }
}
...
impl From<SVCALLPENDED_A> for bool {
    ...
    fn from(variant: SVCALLPENDED_A) -> Self {
        match variant {
            SVCALLPENDED_A::SVCALLPENDED_0 => false,
            SVCALLPENDED_A::SVCALLPENDED_1 => true,
        }
    }
}
...
impl From<MEMFAULTENA_A> for bool {
    ...
    fn from(variant: MEMFAULTENA_A) -> Self {
        match variant {
            MEMFAULTENA_A::MEMFAULTENA_0 => false,
            MEMFAULTENA_A::MEMFAULTENA_1 => true,
        }
    }
}
...
impl From<BUSFAULTENA_A> for bool {
    ...
    fn from(variant: BUSFAULTENA_A) -> Self {
        match variant {
            BUSFAULTENA_A::BUSFAULTENA_0 => false,
            BUSFAULTENA_A::BUSFAULTENA_1 => true,
        }
    }
}
...
impl From<USGFAULTENA_A> for bool {
    ...
    fn from(variant: USGFAULTENA_A) -> Self {
        match variant {
            USGFAULTENA_A::USGFAULTENA_0 => false,
            USGFAULTENA_A::USGFAULTENA_1 => true,
        }
    }
}
