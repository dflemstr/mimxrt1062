...
impl From<FPEXCODIS_A> for bool {
    ...
    fn from(variant: FPEXCODIS_A) -> Self {
        match variant {
            FPEXCODIS_A::FPEXCODIS_0 => false,
            FPEXCODIS_A::FPEXCODIS_1 => true,
        }
    }
}
...
impl From<DISRAMODE_A> for bool {
    ...
    fn from(variant: DISRAMODE_A) -> Self {
        match variant {
            DISRAMODE_A::DISRAMODE_0 => false,
            DISRAMODE_A::DISRAMODE_1 => true,
        }
    }
}
...
impl From<DISITMATBFLUSH_A> for bool {
    ...
    fn from(variant: DISITMATBFLUSH_A) -> Self {
        match variant {
            DISITMATBFLUSH_A::DISITMATBFLUSH_1 => true,
        }
    }
}
...
impl From<DISBTACREAD_A> for bool {
    ...
    fn from(variant: DISBTACREAD_A) -> Self {
        match variant {
            DISBTACREAD_A::DISBTACREAD_0 => false,
            DISBTACREAD_A::DISBTACREAD_1 => true,
        }
    }
}
...
impl From<DISBTACALLOC_A> for bool {
    ...
    fn from(variant: DISBTACALLOC_A) -> Self {
        match variant {
            DISBTACALLOC_A::DISBTACALLOC_0 => false,
            DISBTACALLOC_A::DISBTACALLOC_1 => true,
        }
    }
}
...
impl From<DISCRITAXIRUR_A> for bool {
    ...
    fn from(variant: DISCRITAXIRUR_A) -> Self {
        match variant {
            DISCRITAXIRUR_A::DISCRITAXIRUR_0 => false,
            DISCRITAXIRUR_A::DISCRITAXIRUR_1 => true,
        }
    }
}
...
impl From<DISISSCH1_A> for u8 {
    ...
    fn from(variant: DISISSCH1_A) -> Self {
        match variant {
            DISISSCH1_A::DISISSCH1_0 => 0,
            DISISSCH1_A::DISISSCH1_1 => 1,
        }
    }
}
...
impl From<DISDYNADD_A> for bool {
    ...
    fn from(variant: DISDYNADD_A) -> Self {
        match variant {
            DISDYNADD_A::DISDYNADD_0 => false,
            DISDYNADD_A::DISDYNADD_1 => true,
        }
    }
}
...
impl From<DISCRITAXIRUW_A> for bool {
    ...
    fn from(variant: DISCRITAXIRUW_A) -> Self {
        match variant {
            DISCRITAXIRUW_A::DISCRITAXIRUW_0 => false,
            DISCRITAXIRUW_A::DISCRITAXIRUW_1 => true,
        }
    }
}
...
impl From<DISFPUISSOPT_A> for bool {
    ...
    fn from(variant: DISFPUISSOPT_A) -> Self {
        match variant {
            DISFPUISSOPT_A::DISFPUISSOPT_0 => false,
        }
    }
}
