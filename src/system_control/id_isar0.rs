...
impl From<BITCOUNT_INSTRS_A> for u8 {
    ...
    fn from(variant: BITCOUNT_INSTRS_A) -> Self {
        match variant {
            BITCOUNT_INSTRS_A::BITCOUNT_INSTRS_0 => 0,
            BITCOUNT_INSTRS_A::BITCOUNT_INSTRS_1 => 1,
        }
    }
}
...
impl From<BITFIELD_INSTRS_A> for u8 {
    ...
    fn from(variant: BITFIELD_INSTRS_A) -> Self {
        match variant {
            BITFIELD_INSTRS_A::BITFIELD_INSTRS_0 => 0,
            BITFIELD_INSTRS_A::BITFIELD_INSTRS_1 => 1,
        }
    }
}
...
impl From<CMPBRANCH_INSTRS_A> for u8 {
    ...
    fn from(variant: CMPBRANCH_INSTRS_A) -> Self {
        match variant {
            CMPBRANCH_INSTRS_A::CMPBRANCH_INSTRS_0 => 0,
            CMPBRANCH_INSTRS_A::CMPBRANCH_INSTRS_1 => 1,
        }
    }
}
...
impl From<COPROC_INSTRS_A> for u8 {
    ...
    fn from(variant: COPROC_INSTRS_A) -> Self {
        match variant {
            COPROC_INSTRS_A::COPROC_INSTRS_0 => 0,
            COPROC_INSTRS_A::COPROC_INSTRS_1 => 1,
            COPROC_INSTRS_A::COPROC_INSTRS_2 => 2,
            COPROC_INSTRS_A::COPROC_INSTRS_3 => 3,
            COPROC_INSTRS_A::COPROC_INSTRS_4 => 4,
        }
    }
}
...
impl From<DEBUG_INSTRS_A> for u8 {
    ...
    fn from(variant: DEBUG_INSTRS_A) -> Self {
        match variant {
            DEBUG_INSTRS_A::DEBUG_INSTRS_0 => 0,
            DEBUG_INSTRS_A::DEBUG_INSTRS_1 => 1,
        }
    }
}
...
impl From<DIVIDE_INSTRS_A> for u8 {
    ...
    fn from(variant: DIVIDE_INSTRS_A) -> Self {
        match variant {
            DIVIDE_INSTRS_A::DIVIDE_INSTRS_0 => 0,
            DIVIDE_INSTRS_A::DIVIDE_INSTRS_1 => 1,
        }
    }
}
