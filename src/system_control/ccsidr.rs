...
impl From<LINESIZE_A> for u8 {
    ...
    fn from(variant: LINESIZE_A) -> Self {
        match variant {
            LINESIZE_A::LINESIZE_0 => 0,
            LINESIZE_A::LINESIZE_1 => 1,
            LINESIZE_A::LINESIZE_2 => 2,
            LINESIZE_A::LINESIZE_3 => 3,
            LINESIZE_A::LINESIZE_4 => 4,
            LINESIZE_A::LINESIZE_5 => 5,
            LINESIZE_A::LINESIZE_6 => 6,
            LINESIZE_A::LINESIZE_7 => 7,
        }
    }
}
