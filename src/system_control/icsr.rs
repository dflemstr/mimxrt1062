...
impl From<RETTOBASE_A> for bool {
    ...
    fn from(variant: RETTOBASE_A) -> Self {
        match variant {
            RETTOBASE_A::RETTOBASE_0 => false,
            RETTOBASE_A::RETTOBASE_1 => true,
        }
    }
}
...
impl From<ISRPENDING_A> for bool {
    ...
    fn from(variant: ISRPENDING_A) -> Self {
        match variant {
            ISRPENDING_A::ISRPENDING_0 => false,
            ISRPENDING_A::ISRPENDING_1 => true,
        }
    }
}
...
impl From<PENDSTCLR_AW> for bool {
    ...
    fn from(variant: PENDSTCLR_AW) -> Self {
        match variant {
            PENDSTCLR_AW::PENDSTCLR_0 => false,
            PENDSTCLR_AW::PENDSTCLR_1 => true,
        }
    }
}
...
impl From<PENDSTSET_A> for bool {
    ...
    fn from(variant: PENDSTSET_A) -> Self {
        match variant {
            PENDSTSET_A::PENDSTSET_0 => false,
            PENDSTSET_A::PENDSTSET_1 => true,
        }
    }
}
...
impl From<PENDSVCLR_AW> for bool {
    ...
    fn from(variant: PENDSVCLR_AW) -> Self {
        match variant {
            PENDSVCLR_AW::PENDSVCLR_0 => false,
            PENDSVCLR_AW::PENDSVCLR_1 => true,
        }
    }
}
...
impl From<PENDSVSET_A> for bool {
    ...
    fn from(variant: PENDSVSET_A) -> Self {
        match variant {
            PENDSVSET_A::PENDSVSET_0 => false,
            PENDSVSET_A::PENDSVSET_1 => true,
        }
    }
}
...
impl From<NMIPENDSET_A> for bool {
    ...
    fn from(variant: NMIPENDSET_A) -> Self {
        match variant {
            NMIPENDSET_A::NMIPENDSET_0 => false,
            NMIPENDSET_A::NMIPENDSET_1 => true,
        }
    }
}
