...
impl From<VECTRESET_AW> for bool {
    ...
    fn from(variant: VECTRESET_AW) -> Self {
        match variant {
            VECTRESET_AW::VECTRESET_0 => false,
            VECTRESET_AW::VECTRESET_1 => true,
        }
    }
}
...
impl From<VECTCLRACTIVE_AW> for bool {
    ...
    fn from(variant: VECTCLRACTIVE_AW) -> Self {
        match variant {
            VECTCLRACTIVE_AW::VECTCLRACTIVE_0 => false,
            VECTCLRACTIVE_AW::VECTCLRACTIVE_1 => true,
        }
    }
}
...
impl From<SYSRESETREQ_AW> for bool {
    ...
    fn from(variant: SYSRESETREQ_AW) -> Self {
        match variant {
            SYSRESETREQ_AW::SYSRESETREQ_0 => false,
            SYSRESETREQ_AW::SYSRESETREQ_1 => true,
        }
    }
}
...
impl From<ENDIANNESS_A> for bool {
    ...
    fn from(variant: ENDIANNESS_A) -> Self {
        match variant {
            ENDIANNESS_A::ENDIANNESS_0 => false,
            ENDIANNESS_A::ENDIANNESS_1 => true,
        }
    }
}
