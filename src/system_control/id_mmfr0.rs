...
impl From<PMSASUPPORT_A> for u8 {
    ...
    fn from(variant: PMSASUPPORT_A) -> Self {
        match variant {
            PMSASUPPORT_A::PMSASUPPORT_0 => 0,
            PMSASUPPORT_A::PMSASUPPORT_1 => 1,
            PMSASUPPORT_A::PMSASUPPORT_2 => 2,
            PMSASUPPORT_A::PMSASUPPORT_3 => 3,
        }
    }
}
...
impl From<OUTERMOST_SHAREABILITY_A> for u8 {
    ...
    fn from(variant: OUTERMOST_SHAREABILITY_A) -> Self {
        match variant {
            OUTERMOST_SHAREABILITY_A::OUTERMOST_SHAREABILITY_0 => 0,
            OUTERMOST_SHAREABILITY_A::OUTERMOST_SHAREABILITY_1 => 1,
            OUTERMOST_SHAREABILITY_A::OUTERMOST_SHAREABILITY_2 => 2,
            OUTERMOST_SHAREABILITY_A::OUTERMOST_SHAREABILITY_3 => 3,
            OUTERMOST_SHAREABILITY_A::OUTERMOST_SHAREABILITY_4 => 4,
            OUTERMOST_SHAREABILITY_A::OUTERMOST_SHAREABILITY_5 => 5,
            OUTERMOST_SHAREABILITY_A::OUTERMOST_SHAREABILITY_6 => 6,
            OUTERMOST_SHAREABILITY_A::OUTERMOST_SHAREABILITY_7 => 7,
            OUTERMOST_SHAREABILITY_A::OUTERMOST_SHAREABILITY_8 => 8,
            OUTERMOST_SHAREABILITY_A::OUTERMOST_SHAREABILITY_9 => 9,
            OUTERMOST_SHAREABILITY_A::OUTERMOST_SHAREABILITY_10 => 10,
            OUTERMOST_SHAREABILITY_A::OUTERMOST_SHAREABILITY_11 => 11,
            OUTERMOST_SHAREABILITY_A::OUTERMOST_SHAREABILITY_12 => 12,
            OUTERMOST_SHAREABILITY_A::OUTERMOST_SHAREABILITY_13 => 13,
            OUTERMOST_SHAREABILITY_A::OUTERMOST_SHAREABILITY_14 => 14,
            OUTERMOST_SHAREABILITY_A::OUTERMOST_SHAREABILITY_15 => 15,
        }
    }
}
...
impl From<SHAREABILITY_LEVELS_A> for u8 {
    ...
    fn from(variant: SHAREABILITY_LEVELS_A) -> Self {
        match variant {
            SHAREABILITY_LEVELS_A::SHAREABILITY_LEVELS_0 => 0,
            SHAREABILITY_LEVELS_A::SHAREABILITY_LEVELS_1 => 1,
        }
    }
}
...
impl From<TCM_SUPPORT_A> for u8 {
    ...
    fn from(variant: TCM_SUPPORT_A) -> Self {
        match variant {
            TCM_SUPPORT_A::TCM_SUPPORT_0 => 0,
            TCM_SUPPORT_A::TCM_SUPPORT_1 => 1,
            TCM_SUPPORT_A::TCM_SUPPORT_2 => 2,
        }
    }
}
...
impl From<AUXILIARY_REGISTERS_A> for u8 {
    ...
    fn from(variant: AUXILIARY_REGISTERS_A) -> Self {
        match variant {
            AUXILIARY_REGISTERS_A::AUXILIARY_REGISTERS_0 => 0,
            AUXILIARY_REGISTERS_A::AUXILIARY_REGISTERS_1 => 1,
            AUXILIARY_REGISTERS_A::AUXILIARY_REGISTERS_2 => 2,
        }
    }
}
