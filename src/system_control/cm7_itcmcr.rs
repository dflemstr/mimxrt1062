#[doc = "Reader of register CM7_ITCMCR"]
pub type R = crate::R<u32, super::CM7_ITCMCR>;
#[doc = "Writer for register CM7_ITCMCR"]
pub type W = crate::W<u32, super::CM7_ITCMCR>;
#[doc = "Register CM7_ITCMCR `reset()`'s with value 0"]
impl crate::ResetValue for super::CM7_ITCMCR {
    type Type = u32;
    #[inline(always)]
...
impl From<RETEN_A> for bool {
    ...
    fn from(variant: RETEN_A) -> Self {
        match variant {
            RETEN_A::RETEN_0 => false,
            RETEN_A::RETEN_1 => true,
        }
    }
}
