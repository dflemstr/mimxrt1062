...
impl From<EXTEND_INSTRS_A> for u8 {
    ...
    fn from(variant: EXTEND_INSTRS_A) -> Self {
        match variant {
            EXTEND_INSTRS_A::EXTEND_INSTRS_0 => 0,
            EXTEND_INSTRS_A::EXTEND_INSTRS_1 => 1,
            EXTEND_INSTRS_A::EXTEND_INSTRS_2 => 2,
        }
    }
}
...
impl From<IFTHEN_INSTRS_A> for u8 {
    ...
    fn from(variant: IFTHEN_INSTRS_A) -> Self {
        match variant {
            IFTHEN_INSTRS_A::IFTHEN_INSTRS_0 => 0,
            IFTHEN_INSTRS_A::IFTHEN_INSTRS_1 => 1,
        }
    }
}
...
impl From<IMMEDIATE_INSTRS_A> for u8 {
    ...
    fn from(variant: IMMEDIATE_INSTRS_A) -> Self {
        match variant {
            IMMEDIATE_INSTRS_A::IMMEDIATE_INSTRS_0 => 0,
            IMMEDIATE_INSTRS_A::IMMEDIATE_INSTRS_1 => 1,
        }
    }
}
...
impl From<INTERWORK_INSTRS_A> for u8 {
    ...
    fn from(variant: INTERWORK_INSTRS_A) -> Self {
        match variant {
            INTERWORK_INSTRS_A::INTERWORK_INSTRS_0 => 0,
            INTERWORK_INSTRS_A::INTERWORK_INSTRS_1 => 1,
            INTERWORK_INSTRS_A::INTERWORK_INSTRS_2 => 2,
            INTERWORK_INSTRS_A::INTERWORK_INSTRS_3 => 3,
        }
    }
}
