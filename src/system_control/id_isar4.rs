...
impl From<UNPRIV_INSTRS_A> for u8 {
    ...
    fn from(variant: UNPRIV_INSTRS_A) -> Self {
        match variant {
            UNPRIV_INSTRS_A::UNPRIV_INSTRS_0 => 0,
            UNPRIV_INSTRS_A::UNPRIV_INSTRS_1 => 1,
            UNPRIV_INSTRS_A::UNPRIV_INSTRS_2 => 2,
        }
    }
}
...
impl From<WITHSHIFTS_INSTRS_A> for u8 {
    ...
    fn from(variant: WITHSHIFTS_INSTRS_A) -> Self {
        match variant {
            WITHSHIFTS_INSTRS_A::WITHSHIFTS_INSTRS_0 => 0,
            WITHSHIFTS_INSTRS_A::WITHSHIFTS_INSTRS_1 => 1,
            WITHSHIFTS_INSTRS_A::WITHSHIFTS_INSTRS_3 => 3,
            WITHSHIFTS_INSTRS_A::WITHSHIFTS_INSTRS_4 => 4,
        }
    }
}
...
impl From<WRITEBACK_INSTRS_A> for u8 {
    ...
    fn from(variant: WRITEBACK_INSTRS_A) -> Self {
        match variant {
            WRITEBACK_INSTRS_A::WRITEBACK_INSTRS_0 => 0,
            WRITEBACK_INSTRS_A::WRITEBACK_INSTRS_1 => 1,
        }
    }
}
...
impl From<BARRIER_INSTRS_A> for u8 {
    ...
    fn from(variant: BARRIER_INSTRS_A) -> Self {
        match variant {
            BARRIER_INSTRS_A::BARRIER_INSTRS_0 => 0,
            BARRIER_INSTRS_A::BARRIER_INSTRS_1 => 1,
        }
    }
}
...
impl From<PSR_M_INSTRS_A> for u8 {
    ...
    fn from(variant: PSR_M_INSTRS_A) -> Self {
        match variant {
            PSR_M_INSTRS_A::PSR_M_INSTRS_0 => 0,
            PSR_M_INSTRS_A::PSR_M_INSTRS_1 => 1,
        }
    }
}
