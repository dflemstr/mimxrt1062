...
impl From<UPDHLD_A> for bool {
    ...
    fn from(variant: UPDHLD_A) -> Self {
        match variant {
            UPDHLD_A::UPDHLD_0 => false,
            UPDHLD_A::UPDHLD_1 => true,
        }
    }
}
...
impl From<UPDPOS_A> for bool {
    ...
    fn from(variant: UPDPOS_A) -> Self {
        match variant {
            UPDPOS_A::UPDPOS_0 => false,
            UPDPOS_A::UPDPOS_1 => true,
        }
    }
}
...
impl From<RUIRQ_A> for bool {
    ...
    fn from(variant: RUIRQ_A) -> Self {
        match variant {
            RUIRQ_A::RUIRQ_0 => false,
            RUIRQ_A::RUIRQ_1 => true,
        }
    }
}
...
impl From<ROIRQ_A> for bool {
    ...
    fn from(variant: ROIRQ_A) -> Self {
        match variant {
            ROIRQ_A::ROIRQ_0 => false,
            ROIRQ_A::ROIRQ_1 => true,
        }
    }
}
...
impl From<REVMOD_A> for bool {
    ...
    fn from(variant: REVMOD_A) -> Self {
        match variant {
            REVMOD_A::REVMOD_0 => false,
            REVMOD_A::REVMOD_1 => true,
        }
    }
}
...
impl From<OUTCTL_A> for bool {
    ...
    fn from(variant: OUTCTL_A) -> Self {
        match variant {
            OUTCTL_A::OUTCTL_0 => false,
            OUTCTL_A::OUTCTL_1 => true,
        }
    }
}
...
impl From<SABIE_A> for bool {
    ...
    fn from(variant: SABIE_A) -> Self {
        match variant {
            SABIE_A::SABIE_0 => false,
            SABIE_A::SABIE_1 => true,
        }
    }
}
...
impl From<SABIRQ_A> for bool {
    ...
    fn from(variant: SABIRQ_A) -> Self {
        match variant {
            SABIRQ_A::SABIRQ_0 => false,
            SABIRQ_A::SABIRQ_1 => true,
        }
    }
}
