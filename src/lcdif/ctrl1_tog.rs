#[doc = "Reader of register CTRL1_TOG"]
pub type R = crate::R<u32, super::CTRL1_TOG>;
#[doc = "Writer for register CTRL1_TOG"]
pub type W = crate::W<u32, super::CTRL1_TOG>;
#[doc = "Register CTRL1_TOG `reset()`'s with value 0x000f_0000"]
impl crate::ResetValue for super::CTRL1_TOG {
    type Type = u32;
    #[inline(always)]
...
impl From<VSYNC_EDGE_IRQ_A> for bool {
    ...
    fn from(variant: VSYNC_EDGE_IRQ_A) -> Self {
        match variant {
            VSYNC_EDGE_IRQ_A::NO_REQUEST => false,
            VSYNC_EDGE_IRQ_A::REQUEST => true,
        }
    }
}
...
impl From<CUR_FRAME_DONE_IRQ_A> for bool {
    ...
    fn from(variant: CUR_FRAME_DONE_IRQ_A) -> Self {
        match variant {
            CUR_FRAME_DONE_IRQ_A::NO_REQUEST => false,
            CUR_FRAME_DONE_IRQ_A::REQUEST => true,
        }
    }
}
...
impl From<UNDERFLOW_IRQ_A> for bool {
    ...
    fn from(variant: UNDERFLOW_IRQ_A) -> Self {
        match variant {
            UNDERFLOW_IRQ_A::NO_REQUEST => false,
            UNDERFLOW_IRQ_A::REQUEST => true,
        }
    }
}
...
impl From<OVERFLOW_IRQ_A> for bool {
    ...
    fn from(variant: OVERFLOW_IRQ_A) -> Self {
        match variant {
            OVERFLOW_IRQ_A::NO_REQUEST => false,
            OVERFLOW_IRQ_A::REQUEST => true,
        }
    }
}
...
impl From<BM_ERROR_IRQ_A> for bool {
    ...
    fn from(variant: BM_ERROR_IRQ_A) -> Self {
        match variant {
            BM_ERROR_IRQ_A::NO_REQUEST => false,
            BM_ERROR_IRQ_A::REQUEST => true,
        }
    }
}
