...
impl From<DATA_FORMAT_24_BIT_A> for bool {
    ...
    fn from(variant: DATA_FORMAT_24_BIT_A) -> Self {
        match variant {
            DATA_FORMAT_24_BIT_A::ALL_24_BITS_VALID => false,
            DATA_FORMAT_24_BIT_A::DROP_UPPER_2_BITS_PER_BYTE => true,
        }
    }
}
...
impl From<DATA_FORMAT_18_BIT_A> for bool {
    ...
    fn from(variant: DATA_FORMAT_18_BIT_A) -> Self {
        match variant {
            DATA_FORMAT_18_BIT_A::LOWER_18_BITS_VALID => false,
            DATA_FORMAT_18_BIT_A::UPPER_18_BITS_VALID => true,
        }
    }
}
...
impl From<WORD_LENGTH_A> for u8 {
    ...
    fn from(variant: WORD_LENGTH_A) -> Self {
        match variant {
            WORD_LENGTH_A::_16_BIT => 0,
            WORD_LENGTH_A::_8_BIT => 1,
            WORD_LENGTH_A::_18_BIT => 2,
            WORD_LENGTH_A::_24_BIT => 3,
        }
    }
}
...
impl From<LCD_DATABUS_WIDTH_A> for u8 {
    ...
    fn from(variant: LCD_DATABUS_WIDTH_A) -> Self {
        match variant {
            LCD_DATABUS_WIDTH_A::_16_BIT => 0,
            LCD_DATABUS_WIDTH_A::_8_BIT => 1,
            LCD_DATABUS_WIDTH_A::_18_BIT => 2,
            LCD_DATABUS_WIDTH_A::_24_BIT => 3,
        }
    }
}
...
impl From<CSC_DATA_SWIZZLE_A> for u8 {
    ...
    fn from(variant: CSC_DATA_SWIZZLE_A) -> Self {
        match variant {
            CSC_DATA_SWIZZLE_A::NO_SWAP => 0,
            CSC_DATA_SWIZZLE_A::BIG_ENDIAN_SWAP => 1,
            CSC_DATA_SWIZZLE_A::HWD_SWAP => 2,
            CSC_DATA_SWIZZLE_A::HWD_BYTE_SWAP => 3,
        }
    }
}
...
impl From<INPUT_DATA_SWIZZLE_A> for u8 {
    ...
    fn from(variant: INPUT_DATA_SWIZZLE_A) -> Self {
        match variant {
            INPUT_DATA_SWIZZLE_A::NO_SWAP => 0,
            INPUT_DATA_SWIZZLE_A::BIG_ENDIAN_SWAP => 1,
            INPUT_DATA_SWIZZLE_A::HWD_SWAP => 2,
            INPUT_DATA_SWIZZLE_A::HWD_BYTE_SWAP => 3,
        }
    }
}
...
impl From<DATA_SHIFT_DIR_A> for bool {
    ...
    fn from(variant: DATA_SHIFT_DIR_A) -> Self {
        match variant {
            DATA_SHIFT_DIR_A::TXDATA_SHIFT_LEFT => false,
            DATA_SHIFT_DIR_A::TXDATA_SHIFT_RIGHT => true,
        }
    }
}
