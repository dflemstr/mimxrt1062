#[doc = "Reader of register PIGEON_11_2"]
pub type R = crate::R<u32, super::PIGEON_11_2>;
#[doc = "Writer for register PIGEON_11_2"]
pub type W = crate::W<u32, super::PIGEON_11_2>;
#[doc = "Register PIGEON_11_2 `reset()`'s with value 0"]
impl crate::ResetValue for super::PIGEON_11_2 {
    type Type = u32;
    #[inline(always)]
...
impl From<SIG_ANOTHER_A> for u8 {
    ...
    fn from(variant: SIG_ANOTHER_A) -> Self {
        match variant {
            SIG_ANOTHER_A::CLEAR_USING_MASK => 0,
        }
    }
}
