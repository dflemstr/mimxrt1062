#[doc = "Reader of register CTRL2_CLR"]
pub type R = crate::R<u32, super::CTRL2_CLR>;
#[doc = "Writer for register CTRL2_CLR"]
pub type W = crate::W<u32, super::CTRL2_CLR>;
#[doc = "Register CTRL2_CLR `reset()`'s with value 0x0020_0000"]
impl crate::ResetValue for super::CTRL2_CLR {
    type Type = u32;
    #[inline(always)]
...
impl From<EVEN_LINE_PATTERN_A> for u8 {
    ...
    fn from(variant: EVEN_LINE_PATTERN_A) -> Self {
        match variant {
            EVEN_LINE_PATTERN_A::RGB => 0,
            EVEN_LINE_PATTERN_A::RBG => 1,
            EVEN_LINE_PATTERN_A::GBR => 2,
            EVEN_LINE_PATTERN_A::GRB => 3,
            EVEN_LINE_PATTERN_A::BRG => 4,
            EVEN_LINE_PATTERN_A::BGR => 5,
        }
    }
}
...
impl From<ODD_LINE_PATTERN_A> for u8 {
    ...
    fn from(variant: ODD_LINE_PATTERN_A) -> Self {
        match variant {
            ODD_LINE_PATTERN_A::RGB => 0,
            ODD_LINE_PATTERN_A::RBG => 1,
            ODD_LINE_PATTERN_A::GBR => 2,
            ODD_LINE_PATTERN_A::GRB => 3,
            ODD_LINE_PATTERN_A::BRG => 4,
            ODD_LINE_PATTERN_A::BGR => 5,
        }
    }
}
...
impl From<OUTSTANDING_REQS_A> for u8 {
    ...
    fn from(variant: OUTSTANDING_REQS_A) -> Self {
        match variant {
            OUTSTANDING_REQS_A::REQ_1 => 0,
            OUTSTANDING_REQS_A::REQ_2 => 1,
            OUTSTANDING_REQS_A::REQ_4 => 2,
            OUTSTANDING_REQS_A::REQ_8 => 3,
            OUTSTANDING_REQS_A::REQ_16 => 4,
        }
    }
}
