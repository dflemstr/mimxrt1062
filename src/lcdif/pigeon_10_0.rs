#[doc = "Reader of register PIGEON_10_0"]
pub type R = crate::R<u32, super::PIGEON_10_0>;
#[doc = "Writer for register PIGEON_10_0"]
pub type W = crate::W<u32, super::PIGEON_10_0>;
#[doc = "Register PIGEON_10_0 `reset()`'s with value 0"]
impl crate::ResetValue for super::PIGEON_10_0 {
    type Type = u32;
    #[inline(always)]
...
impl From<POL_A> for bool {
    ...
    fn from(variant: POL_A) -> Self {
        match variant {
            POL_A::ACTIVE_HIGH => false,
            POL_A::ACTIVE_LOW => true,
        }
    }
}
...
impl From<MASK_CNT_SEL_A> for u8 {
    ...
    fn from(variant: MASK_CNT_SEL_A) -> Self {
        match variant {
            MASK_CNT_SEL_A::HSTATE_CNT => 0,
            MASK_CNT_SEL_A::HSTATE_CYCLE => 1,
            MASK_CNT_SEL_A::VSTATE_CNT => 2,
            MASK_CNT_SEL_A::VSTATE_CYCLE => 3,
            MASK_CNT_SEL_A::FRAME_CNT => 4,
            MASK_CNT_SEL_A::FRAME_CYCLE => 5,
            MASK_CNT_SEL_A::HCNT => 6,
            MASK_CNT_SEL_A::VCNT => 7,
        }
    }
}
