...
impl From<IPP_RESET_B_A> for bool {
    ...
    fn from(variant: IPP_RESET_B_A) -> Self {
        match variant {
            IPP_RESET_B_A::IPP_RESET_B_0 => false,
            IPP_RESET_B_A::IPP_RESET_B_1 => true,
        }
    }
}
...
impl From<LOCKUP_SYSRESETREQ_A> for bool {
    ...
    fn from(variant: LOCKUP_SYSRESETREQ_A) -> Self {
        match variant {
            LOCKUP_SYSRESETREQ_A::LOCKUP_SYSRESETREQ_0 => false,
            LOCKUP_SYSRESETREQ_A::LOCKUP_SYSRESETREQ_1 => true,
        }
    }
}
...
impl From<CSU_RESET_B_A> for bool {
    ...
    fn from(variant: CSU_RESET_B_A) -> Self {
        match variant {
            CSU_RESET_B_A::CSU_RESET_B_0 => false,
            CSU_RESET_B_A::CSU_RESET_B_1 => true,
        }
    }
}
...
impl From<IPP_USER_RESET_B_A> for bool {
    ...
    fn from(variant: IPP_USER_RESET_B_A) -> Self {
        match variant {
            IPP_USER_RESET_B_A::IPP_USER_RESET_B_0 => false,
            IPP_USER_RESET_B_A::IPP_USER_RESET_B_1 => true,
        }
    }
}
...
impl From<WDOG_RST_B_A> for bool {
    ...
    fn from(variant: WDOG_RST_B_A) -> Self {
        match variant {
            WDOG_RST_B_A::WDOG_RST_B_0 => false,
            WDOG_RST_B_A::WDOG_RST_B_1 => true,
        }
    }
}
...
impl From<JTAG_RST_B_A> for bool {
    ...
    fn from(variant: JTAG_RST_B_A) -> Self {
        match variant {
            JTAG_RST_B_A::JTAG_RST_B_0 => false,
            JTAG_RST_B_A::JTAG_RST_B_1 => true,
        }
    }
}
...
impl From<JTAG_SW_RST_A> for bool {
    ...
    fn from(variant: JTAG_SW_RST_A) -> Self {
        match variant {
            JTAG_SW_RST_A::JTAG_SW_RST_0 => false,
            JTAG_SW_RST_A::JTAG_SW_RST_1 => true,
        }
    }
}
...
impl From<WDOG3_RST_B_A> for bool {
    ...
    fn from(variant: WDOG3_RST_B_A) -> Self {
        match variant {
            WDOG3_RST_B_A::WDOG3_RST_B_0 => false,
            WDOG3_RST_B_A::WDOG3_RST_B_1 => true,
        }
    }
}
...
impl From<TEMPSENSE_RST_B_A> for bool {
    ...
    fn from(variant: TEMPSENSE_RST_B_A) -> Self {
        match variant {
            TEMPSENSE_RST_B_A::TEMPSENSE_RST_B_0 => false,
            TEMPSENSE_RST_B_A::TEMPSENSE_RST_B_1 => true,
        }
    }
}
