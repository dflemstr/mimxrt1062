...
impl From<MASK_WDOG_RST_A> for u8 {
    ...
    fn from(variant: MASK_WDOG_RST_A) -> Self {
        match variant {
            MASK_WDOG_RST_A::MASK_WDOG_RST_5 => 5,
            MASK_WDOG_RST_A::MASK_WDOG_RST_10 => 10,
        }
    }
}
...
impl From<CORE0_RST_A> for bool {
    ...
    fn from(variant: CORE0_RST_A) -> Self {
        match variant {
            CORE0_RST_A::CORE0_RST_0 => false,
            CORE0_RST_A::CORE0_RST_1 => true,
        }
    }
}
...
impl From<CORE0_DBG_RST_A> for bool {
    ...
    fn from(variant: CORE0_DBG_RST_A) -> Self {
        match variant {
            CORE0_DBG_RST_A::CORE0_DBG_RST_0 => false,
            CORE0_DBG_RST_A::CORE0_DBG_RST_1 => true,
        }
    }
}
...
impl From<DBG_RST_MSK_PG_A> for bool {
    ...
    fn from(variant: DBG_RST_MSK_PG_A) -> Self {
        match variant {
            DBG_RST_MSK_PG_A::DBG_RST_MSK_PG_0 => false,
            DBG_RST_MSK_PG_A::DBG_RST_MSK_PG_1 => true,
        }
    }
}
...
impl From<MASK_WDOG3_RST_A> for u8 {
    ...
    fn from(variant: MASK_WDOG3_RST_A) -> Self {
        match variant {
            MASK_WDOG3_RST_A::MASK_WDOG3_RST_5 => 5,
            MASK_WDOG3_RST_A::MASK_WDOG3_RST_10 => 10,
        }
    }
}
