...
impl From<BEE_ENABLE_A> for bool {
    ...
    fn from(variant: BEE_ENABLE_A) -> Self {
        match variant {
            BEE_ENABLE_A::BEE_ENABLE_0 => false,
            BEE_ENABLE_A::BEE_ENABLE_1 => true,
        }
    }
}
...
impl From<KEY_REGION_SEL_A> for bool {
    ...
    fn from(variant: KEY_REGION_SEL_A) -> Self {
        match variant {
            KEY_REGION_SEL_A::KEY_REGION_SEL_0 => false,
            KEY_REGION_SEL_A::KEY_REGION_SEL_1 => true,
        }
    }
}
...
impl From<LITTLE_ENDIAN_A> for bool {
    ...
    fn from(variant: LITTLE_ENDIAN_A) -> Self {
        match variant {
            LITTLE_ENDIAN_A::LITTLE_ENDIAN_0 => false,
            LITTLE_ENDIAN_A::LITTLE_ENDIAN_1 => true,
        }
    }
}
...
impl From<CTRL_AES_MODE_R0_A> for bool {
    ...
    fn from(variant: CTRL_AES_MODE_R0_A) -> Self {
        match variant {
            CTRL_AES_MODE_R0_A::CTRL_AES_MODE_R0_0 => false,
            CTRL_AES_MODE_R0_A::CTRL_AES_MODE_R0_1 => true,
        }
    }
}
...
impl From<CTRL_AES_MODE_R1_A> for bool {
    ...
    fn from(variant: CTRL_AES_MODE_R1_A) -> Self {
        match variant {
            CTRL_AES_MODE_R1_A::CTRL_AES_MODE_R1_0 => false,
            CTRL_AES_MODE_R1_A::CTRL_AES_MODE_R1_1 => true,
        }
    }
}
