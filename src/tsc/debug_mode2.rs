...
impl From<XPUL_PULL_DOWN_A> for bool {
    ...
    fn from(variant: XPUL_PULL_DOWN_A) -> Self {
        match variant {
            XPUL_PULL_DOWN_A::XPUL_PULL_DOWN_0 => false,
            XPUL_PULL_DOWN_A::XPUL_PULL_DOWN_1 => true,
        }
    }
}
...
impl From<XPUL_PULL_UP_A> for bool {
    ...
    fn from(variant: XPUL_PULL_UP_A) -> Self {
        match variant {
            XPUL_PULL_UP_A::XPUL_PULL_UP_0 => false,
            XPUL_PULL_UP_A::XPUL_PULL_UP_1 => true,
        }
    }
}
...
impl From<XPUL_200K_PULL_UP_A> for bool {
    ...
    fn from(variant: XPUL_200K_PULL_UP_A) -> Self {
        match variant {
            XPUL_200K_PULL_UP_A::XPUL_200K_PULL_UP_0 => false,
            XPUL_200K_PULL_UP_A::XPUL_200K_PULL_UP_1 => true,
        }
    }
}
...
impl From<XNUR_PULL_DOWN_A> for bool {
    ...
    fn from(variant: XNUR_PULL_DOWN_A) -> Self {
        match variant {
            XNUR_PULL_DOWN_A::XNUR_PULL_DOWN_0 => false,
            XNUR_PULL_DOWN_A::XNUR_PULL_DOWN_1 => true,
        }
    }
}
...
impl From<XNUR_PULL_UP_A> for bool {
    ...
    fn from(variant: XNUR_PULL_UP_A) -> Self {
        match variant {
            XNUR_PULL_UP_A::XNUR_PULL_UP_0 => false,
            XNUR_PULL_UP_A::XNUR_PULL_UP_1 => true,
        }
    }
}
...
impl From<XNUR_200K_PULL_UP_A> for bool {
    ...
    fn from(variant: XNUR_200K_PULL_UP_A) -> Self {
        match variant {
            XNUR_200K_PULL_UP_A::XNUR_200K_PULL_UP_0 => false,
            XNUR_200K_PULL_UP_A::XNUR_200K_PULL_UP_1 => true,
        }
    }
}
...
impl From<YPLL_PULL_DOWN_A> for bool {
    ...
    fn from(variant: YPLL_PULL_DOWN_A) -> Self {
        match variant {
            YPLL_PULL_DOWN_A::YPLL_PULL_DOWN_0 => false,
            YPLL_PULL_DOWN_A::YPLL_PULL_DOWN_1 => true,
        }
    }
}
...
impl From<YPLL_PULL_UP_A> for bool {
    ...
    fn from(variant: YPLL_PULL_UP_A) -> Self {
        match variant {
            YPLL_PULL_UP_A::YPLL_PULL_UP_0 => false,
            YPLL_PULL_UP_A::YPLL_PULL_UP_1 => true,
        }
    }
}
...
impl From<YPLL_200K_PULL_UP_A> for bool {
    ...
    fn from(variant: YPLL_200K_PULL_UP_A) -> Self {
        match variant {
            YPLL_200K_PULL_UP_A::YPLL_200K_PULL_UP_0 => false,
            YPLL_200K_PULL_UP_A::YPLL_200K_PULL_UP_1 => true,
        }
    }
}
...
impl From<YNLR_PULL_DOWN_A> for bool {
    ...
    fn from(variant: YNLR_PULL_DOWN_A) -> Self {
        match variant {
            YNLR_PULL_DOWN_A::YNLR_PULL_DOWN_0 => false,
            YNLR_PULL_DOWN_A::YNLR_PULL_DOWN_1 => true,
        }
    }
}
...
impl From<YNLR_PULL_UP_A> for bool {
    ...
    fn from(variant: YNLR_PULL_UP_A) -> Self {
        match variant {
            YNLR_PULL_UP_A::YNLR_PULL_UP_0 => false,
            YNLR_PULL_UP_A::YNLR_PULL_UP_1 => true,
        }
    }
}
...
impl From<YNLR_200K_PULL_UP_A> for bool {
    ...
    fn from(variant: YNLR_200K_PULL_UP_A) -> Self {
        match variant {
            YNLR_200K_PULL_UP_A::YNLR_200K_PULL_UP_0 => false,
            YNLR_200K_PULL_UP_A::YNLR_200K_PULL_UP_1 => true,
        }
    }
}
...
impl From<WIPER_PULL_DOWN_A> for bool {
    ...
    fn from(variant: WIPER_PULL_DOWN_A) -> Self {
        match variant {
            WIPER_PULL_DOWN_A::WIPER_PULL_DOWN_0 => false,
            WIPER_PULL_DOWN_A::WIPER_PULL_DOWN_1 => true,
        }
    }
}
...
impl From<WIPER_PULL_UP_A> for bool {
    ...
    fn from(variant: WIPER_PULL_UP_A) -> Self {
        match variant {
            WIPER_PULL_UP_A::WIPER_PULL_UP_0 => false,
            WIPER_PULL_UP_A::WIPER_PULL_UP_1 => true,
        }
    }
}
...
impl From<WIPER_200K_PULL_UP_A> for bool {
    ...
    fn from(variant: WIPER_200K_PULL_UP_A) -> Self {
        match variant {
            WIPER_200K_PULL_UP_A::WIPER_200K_PULL_UP_0 => false,
            WIPER_200K_PULL_UP_A::WIPER_200K_PULL_UP_1 => true,
        }
    }
}
...
impl From<DETECT_FOUR_WIRE_A> for bool {
    ...
    fn from(variant: DETECT_FOUR_WIRE_A) -> Self {
        match variant {
            DETECT_FOUR_WIRE_A::DETECT_FOUR_WIRE_0 => false,
            DETECT_FOUR_WIRE_A::DETECT_FOUR_WIRE_1 => true,
        }
    }
}
...
impl From<DETECT_FIVE_WIRE_A> for bool {
    ...
    fn from(variant: DETECT_FIVE_WIRE_A) -> Self {
        match variant {
            DETECT_FIVE_WIRE_A::DETECT_FIVE_WIRE_0 => false,
            DETECT_FIVE_WIRE_A::DETECT_FIVE_WIRE_1 => true,
        }
    }
}
...
impl From<STATE_MACHINE_A> for u8 {
    ...
    fn from(variant: STATE_MACHINE_A) -> Self {
        match variant {
            STATE_MACHINE_A::STATE_MACHINE_0 => 0,
            STATE_MACHINE_A::STATE_MACHINE_1 => 1,
            STATE_MACHINE_A::STATE_MACHINE_2 => 2,
            STATE_MACHINE_A::STATE_MACHINE_3 => 3,
            STATE_MACHINE_A::STATE_MACHINE_4 => 4,
            STATE_MACHINE_A::STATE_MACHINE_5 => 5,
            STATE_MACHINE_A::STATE_MACHINE_6 => 6,
        }
    }
}
...
impl From<INTERMEDIATE_A> for bool {
    ...
    fn from(variant: INTERMEDIATE_A) -> Self {
        match variant {
            INTERMEDIATE_A::INTERMEDIATE_0 => false,
            INTERMEDIATE_A::INTERMEDIATE_1 => true,
        }
    }
}
...
impl From<DETECT_ENABLE_FOUR_WIRE_A> for bool {
    ...
    fn from(variant: DETECT_ENABLE_FOUR_WIRE_A) -> Self {
        match variant {
            DETECT_ENABLE_FOUR_WIRE_A::DETECT_ENABLE_FOUR_WIRE_0 => false,
            DETECT_ENABLE_FOUR_WIRE_A::DETECT_ENABLE_FOUR_WIRE_1 => true,
        }
    }
}
...
impl From<DETECT_ENABLE_FIVE_WIRE_A> for bool {
    ...
    fn from(variant: DETECT_ENABLE_FIVE_WIRE_A) -> Self {
        match variant {
            DETECT_ENABLE_FIVE_WIRE_A::DETECT_ENABLE_FIVE_WIRE_0 => false,
            DETECT_ENABLE_FIVE_WIRE_A::DETECT_ENABLE_FIVE_WIRE_1 => true,
        }
    }
}
...
impl From<DE_GLITCH_A> for u8 {
    ...
    fn from(variant: DE_GLITCH_A) -> Self {
        match variant {
            DE_GLITCH_A::DE_GLITCH_0 => 0,
            DE_GLITCH_A::DE_GLITCH_1 => 1,
            DE_GLITCH_A::DE_GLITCH_2 => 2,
            DE_GLITCH_A::DE_GLITCH_3 => 3,
        }
    }
}
