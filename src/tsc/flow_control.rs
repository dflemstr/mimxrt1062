...
impl From<START_MEASURE_A> for bool {
    ...
    fn from(variant: START_MEASURE_A) -> Self {
        match variant {
            START_MEASURE_A::START_MEASURE_0 => false,
            START_MEASURE_A::START_MEASURE_1 => true,
        }
    }
}
...
impl From<DROP_MEASURE_A> for bool {
    ...
    fn from(variant: DROP_MEASURE_A) -> Self {
        match variant {
            DROP_MEASURE_A::DROP_MEASURE_0 => false,
            DROP_MEASURE_A::DROP_MEASURE_1 => true,
        }
    }
}
...
impl From<START_SENSE_A> for bool {
    ...
    fn from(variant: START_SENSE_A) -> Self {
        match variant {
            START_SENSE_A::START_SENSE_0 => false,
            START_SENSE_A::START_SENSE_1 => true,
        }
    }
}
...
impl From<DISABLE_A> for bool {
    ...
    fn from(variant: DISABLE_A) -> Self {
        match variant {
            DISABLE_A::DISABLE_0 => false,
            DISABLE_A::DISABLE_1 => true,
        }
    }
}
