...
impl From<DETECT_SIG_EN_A> for bool {
    ...
    fn from(variant: DETECT_SIG_EN_A) -> Self {
        match variant {
            DETECT_SIG_EN_A::DETECT_SIG_EN_0 => false,
            DETECT_SIG_EN_A::DETECT_SIG_EN_1 => true,
        }
    }
}
...
impl From<VALID_SIG_EN_A> for bool {
    ...
    fn from(variant: VALID_SIG_EN_A) -> Self {
        match variant {
            VALID_SIG_EN_A::VALID_SIG_EN_0 => false,
            VALID_SIG_EN_A::VALID_SIG_EN_1 => true,
        }
    }
}
...
impl From<IDLE_SW_SIG_EN_A> for bool {
    ...
    fn from(variant: IDLE_SW_SIG_EN_A) -> Self {
        match variant {
            IDLE_SW_SIG_EN_A::IDLE_SW_SIG_EN_0 => false,
            IDLE_SW_SIG_EN_A::IDLE_SW_SIG_EN_1 => true,
        }
    }
}
