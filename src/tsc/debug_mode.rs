...
impl From<TRIGGER_A> for bool {
    ...
    fn from(variant: TRIGGER_A) -> Self {
        match variant {
            TRIGGER_A::TRIGGER_0 => false,
            TRIGGER_A::TRIGGER_1 => true,
        }
    }
}
...
impl From<ADC_COCO_CLEAR_A> for bool {
    ...
    fn from(variant: ADC_COCO_CLEAR_A) -> Self {
        match variant {
            ADC_COCO_CLEAR_A::ADC_COCO_CLEAR_0 => false,
            ADC_COCO_CLEAR_A::ADC_COCO_CLEAR_1 => true,
        }
    }
}
...
impl From<ADC_COCO_CLEAR_DISABLE_A> for bool {
    ...
    fn from(variant: ADC_COCO_CLEAR_DISABLE_A) -> Self {
        match variant {
            ADC_COCO_CLEAR_DISABLE_A::ADC_COCO_CLEAR_DISABLE_0 => false,
            ADC_COCO_CLEAR_DISABLE_A::ADC_COCO_CLEAR_DISABLE_1 => true,
        }
    }
}
...
impl From<DEBUG_EN_A> for bool {
    ...
    fn from(variant: DEBUG_EN_A) -> Self {
        match variant {
            DEBUG_EN_A::DEBUG_EN_0 => false,
            DEBUG_EN_A::DEBUG_EN_1 => true,
        }
    }
}
