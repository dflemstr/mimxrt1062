...
impl From<MEASURE_INT_EN_A> for bool {
    ...
    fn from(variant: MEASURE_INT_EN_A) -> Self {
        match variant {
            MEASURE_INT_EN_A::MEASURE_INT_EN_0 => false,
            MEASURE_INT_EN_A::MEASURE_INT_EN_1 => true,
        }
    }
}
...
impl From<DETECT_INT_EN_A> for bool {
    ...
    fn from(variant: DETECT_INT_EN_A) -> Self {
        match variant {
            DETECT_INT_EN_A::DETECT_INT_EN_0 => false,
            DETECT_INT_EN_A::DETECT_INT_EN_1 => true,
        }
    }
}
...
impl From<IDLE_SW_INT_EN_A> for bool {
    ...
    fn from(variant: IDLE_SW_INT_EN_A) -> Self {
        match variant {
            IDLE_SW_INT_EN_A::IDLE_SW_INT_EN_0 => false,
            IDLE_SW_INT_EN_A::IDLE_SW_INT_EN_1 => true,
        }
    }
}
