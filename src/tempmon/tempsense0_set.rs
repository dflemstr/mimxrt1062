#[doc = "Reader of register TEMPSENSE0_SET"]
pub type R = crate::R<u32, super::TEMPSENSE0_SET>;
#[doc = "Writer for register TEMPSENSE0_SET"]
pub type W = crate::W<u32, super::TEMPSENSE0_SET>;
#[doc = "Register TEMPSENSE0_SET `reset()`'s with value 0x01"]
impl crate::ResetValue for super::TEMPSENSE0_SET {
    type Type = u32;
    #[inline(always)]
...
impl From<POWER_DOWN_A> for bool {
    ...
    fn from(variant: POWER_DOWN_A) -> Self {
        match variant {
            POWER_DOWN_A::POWER_UP => false,
            POWER_DOWN_A::POWER_DOWN => true,
        }
    }
}
...
impl From<MEASURE_TEMP_A> for bool {
    ...
    fn from(variant: MEASURE_TEMP_A) -> Self {
        match variant {
            MEASURE_TEMP_A::STOP => false,
            MEASURE_TEMP_A::START => true,
        }
    }
}
...
impl From<FINISHED_A> for bool {
    ...
    fn from(variant: FINISHED_A) -> Self {
        match variant {
            FINISHED_A::INVALID => false,
            FINISHED_A::VALID => true,
        }
    }
}
