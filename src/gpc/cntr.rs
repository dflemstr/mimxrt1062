...
impl From<MEGA_PDN_REQ_A> for bool {
    ...
    fn from(variant: MEGA_PDN_REQ_A) -> Self {
        match variant {
            MEGA_PDN_REQ_A::MEGA_PDN_REQ_0 => false,
            MEGA_PDN_REQ_A::MEGA_PDN_REQ_1 => true,
        }
    }
}
...
impl From<MEGA_PUP_REQ_A> for bool {
    ...
    fn from(variant: MEGA_PUP_REQ_A) -> Self {
        match variant {
            MEGA_PUP_REQ_A::MEGA_PUP_REQ_0 => false,
            MEGA_PUP_REQ_A::MEGA_PUP_REQ_1 => true,
        }
    }
}
...
impl From<PDRAM0_PGE_A> for bool {
    ...
    fn from(variant: PDRAM0_PGE_A) -> Self {
        match variant {
            PDRAM0_PGE_A::PDRAM0_PGE_0 => false,
            PDRAM0_PGE_A::PDRAM0_PGE_1 => true,
        }
    }
}
