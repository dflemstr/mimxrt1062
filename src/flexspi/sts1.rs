...
impl From<AHBCMDERRCODE_A> for u8 {
    ...
    fn from(variant: AHBCMDERRCODE_A) -> Self {
        match variant {
            AHBCMDERRCODE_A::AHBCMDERRCODE_0 => 0,
            AHBCMDERRCODE_A::AHBCMDERRCODE_2 => 2,
            AHBCMDERRCODE_A::AHBCMDERRCODE_3 => 3,
            AHBCMDERRCODE_A::AHBCMDERRCODE_4 => 4,
            AHBCMDERRCODE_A::AHBCMDERRCODE_5 => 5,
            AHBCMDERRCODE_A::AHBCMDERRCODE_14 => 14,
        }
    }
}
...
impl From<IPCMDERRCODE_A> for u8 {
    ...
    fn from(variant: IPCMDERRCODE_A) -> Self {
        match variant {
            IPCMDERRCODE_A::IPCMDERRCODE_0 => 0,
            IPCMDERRCODE_A::IPCMDERRCODE_2 => 2,
            IPCMDERRCODE_A::IPCMDERRCODE_3 => 3,
            IPCMDERRCODE_A::IPCMDERRCODE_4 => 4,
            IPCMDERRCODE_A::IPCMDERRCODE_5 => 5,
            IPCMDERRCODE_A::IPCMDERRCODE_6 => 6,
            IPCMDERRCODE_A::IPCMDERRCODE_14 => 14,
            IPCMDERRCODE_A::IPCMDERRCODE_15 => 15,
        }
    }
}
