...
impl From<AWRWAITUNIT_A> for u8 {
    ...
    fn from(variant: AWRWAITUNIT_A) -> Self {
        match variant {
            AWRWAITUNIT_A::AWRWAITUNIT_0 => 0,
            AWRWAITUNIT_A::AWRWAITUNIT_1 => 1,
            AWRWAITUNIT_A::AWRWAITUNIT_2 => 2,
            AWRWAITUNIT_A::AWRWAITUNIT_3 => 3,
            AWRWAITUNIT_A::AWRWAITUNIT_4 => 4,
            AWRWAITUNIT_A::AWRWAITUNIT_5 => 5,
            AWRWAITUNIT_A::AWRWAITUNIT_6 => 6,
            AWRWAITUNIT_A::AWRWAITUNIT_7 => 7,
        }
    }
}
