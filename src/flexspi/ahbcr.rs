...
impl From<APAREN_A> for bool {
    ...
    fn from(variant: APAREN_A) -> Self {
        match variant {
            APAREN_A::APAREN_0 => false,
            APAREN_A::APAREN_1 => true,
        }
    }
}
...
impl From<CACHABLEEN_A> for bool {
    ...
    fn from(variant: CACHABLEEN_A) -> Self {
        match variant {
            CACHABLEEN_A::CACHABLEEN_0 => false,
            CACHABLEEN_A::CACHABLEEN_1 => true,
        }
    }
}
...
impl From<BUFFERABLEEN_A> for bool {
    ...
    fn from(variant: BUFFERABLEEN_A) -> Self {
        match variant {
            BUFFERABLEEN_A::BUFFERABLEEN_0 => false,
            BUFFERABLEEN_A::BUFFERABLEEN_1 => true,
        }
    }
}
...
impl From<READADDROPT_A> for bool {
    ...
    fn from(variant: READADDROPT_A) -> Self {
        match variant {
            READADDROPT_A::READADDROPT_0 => false,
            READADDROPT_A::READADDROPT_1 => true,
        }
    }
}
