#[doc = "Reader of register DCHPRI2"]
pub type R = crate::R<u8, super::DCHPRI2>;
#[doc = "Writer for register DCHPRI2"]
pub type W = crate::W<u8, super::DCHPRI2>;
#[doc = "Register DCHPRI2 `reset()`'s with value 0x02"]
impl crate::ResetValue for super::DCHPRI2 {
    type Type = u8;
    #[inline(always)]
