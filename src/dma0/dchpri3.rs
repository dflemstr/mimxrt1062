#[doc = "Reader of register DCHPRI3"]
pub type R = crate::R<u8, super::DCHPRI3>;
#[doc = "Writer for register DCHPRI3"]
pub type W = crate::W<u8, super::DCHPRI3>;
#[doc = "Register DCHPRI3 `reset()`'s with value 0x03"]
impl crate::ResetValue for super::DCHPRI3 {
    type Type = u8;
    #[inline(always)]
