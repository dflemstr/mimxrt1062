#[doc = "Reader of register DCHPRI5"]
pub type R = crate::R<u8, super::DCHPRI5>;
#[doc = "Writer for register DCHPRI5"]
pub type W = crate::W<u8, super::DCHPRI5>;
#[doc = "Register DCHPRI5 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::DCHPRI5 {
    type Type = u8;
    #[inline(always)]
