#[doc = "Reader of register DCHPRI4"]
pub type R = crate::R<u8, super::DCHPRI4>;
#[doc = "Writer for register DCHPRI4"]
pub type W = crate::W<u8, super::DCHPRI4>;
#[doc = "Register DCHPRI4 `reset()`'s with value 0x04"]
impl crate::ResetValue for super::DCHPRI4 {
    type Type = u8;
    #[inline(always)]
