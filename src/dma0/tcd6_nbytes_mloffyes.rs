#[doc = "Reader of register TCD6_NBYTES_MLOFFYES"]
pub type R = crate::R<u32, super::TCD6_NBYTES_MLOFFYES>;
#[doc = "Writer for register TCD6_NBYTES_MLOFFYES"]
pub type W = crate::W<u32, super::TCD6_NBYTES_MLOFFYES>;
#[doc = "Register TCD6_NBYTES_MLOFFYES `reset()`'s with value 0"]
impl crate::ResetValue for super::TCD6_NBYTES_MLOFFYES {
    type Type = u32;
    #[inline(always)]
