#[doc = "Reader of register TCD1_CITER_ELINKNO"]
pub type R = crate::R<u16, super::TCD1_CITER_ELINKNO>;
#[doc = "Writer for register TCD1_CITER_ELINKNO"]
pub type W = crate::W<u16, super::TCD1_CITER_ELINKNO>;
#[doc = "Register TCD1_CITER_ELINKNO `reset()`'s with value 0"]
impl crate::ResetValue for super::TCD1_CITER_ELINKNO {
    type Type = u16;
    #[inline(always)]
