#[doc = "Reader of register DCHPRI0"]
pub type R = crate::R<u8, super::DCHPRI0>;
#[doc = "Writer for register DCHPRI0"]
pub type W = crate::W<u8, super::DCHPRI0>;
#[doc = "Register DCHPRI0 `reset()`'s with value 0"]
impl crate::ResetValue for super::DCHPRI0 {
    type Type = u8;
    #[inline(always)]
