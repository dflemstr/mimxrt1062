#[doc = "Reader of register DCHPRI15"]
pub type R = crate::R<u8, super::DCHPRI15>;
#[doc = "Writer for register DCHPRI15"]
pub type W = crate::W<u8, super::DCHPRI15>;
#[doc = "Register DCHPRI15 `reset()`'s with value 0x0f"]
impl crate::ResetValue for super::DCHPRI15 {
    type Type = u8;
    #[inline(always)]
