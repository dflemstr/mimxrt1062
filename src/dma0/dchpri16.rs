#[doc = "Reader of register DCHPRI16"]
pub type R = crate::R<u8, super::DCHPRI16>;
#[doc = "Writer for register DCHPRI16"]
pub type W = crate::W<u8, super::DCHPRI16>;
#[doc = "Register DCHPRI16 `reset()`'s with value 0x10"]
impl crate::ResetValue for super::DCHPRI16 {
    type Type = u8;
    #[inline(always)]
