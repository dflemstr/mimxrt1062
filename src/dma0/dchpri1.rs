#[doc = "Reader of register DCHPRI1"]
pub type R = crate::R<u8, super::DCHPRI1>;
#[doc = "Writer for register DCHPRI1"]
pub type W = crate::W<u8, super::DCHPRI1>;
#[doc = "Register DCHPRI1 `reset()`'s with value 0x01"]
impl crate::ResetValue for super::DCHPRI1 {
    type Type = u8;
    #[inline(always)]
