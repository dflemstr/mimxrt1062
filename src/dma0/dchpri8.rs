#[doc = "Reader of register DCHPRI8"]
pub type R = crate::R<u8, super::DCHPRI8>;
#[doc = "Writer for register DCHPRI8"]
pub type W = crate::W<u8, super::DCHPRI8>;
#[doc = "Register DCHPRI8 `reset()`'s with value 0x08"]
impl crate::ResetValue for super::DCHPRI8 {
    type Type = u8;
    #[inline(always)]
