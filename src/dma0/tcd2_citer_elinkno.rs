#[doc = "Reader of register TCD2_CITER_ELINKNO"]
pub type R = crate::R<u16, super::TCD2_CITER_ELINKNO>;
#[doc = "Writer for register TCD2_CITER_ELINKNO"]
pub type W = crate::W<u16, super::TCD2_CITER_ELINKNO>;
#[doc = "Register TCD2_CITER_ELINKNO `reset()`'s with value 0"]
impl crate::ResetValue for super::TCD2_CITER_ELINKNO {
    type Type = u16;
    #[inline(always)]
