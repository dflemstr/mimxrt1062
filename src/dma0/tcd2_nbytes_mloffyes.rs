#[doc = "Reader of register TCD2_NBYTES_MLOFFYES"]
pub type R = crate::R<u32, super::TCD2_NBYTES_MLOFFYES>;
#[doc = "Writer for register TCD2_NBYTES_MLOFFYES"]
pub type W = crate::W<u32, super::TCD2_NBYTES_MLOFFYES>;
#[doc = "Register TCD2_NBYTES_MLOFFYES `reset()`'s with value 0"]
impl crate::ResetValue for super::TCD2_NBYTES_MLOFFYES {
    type Type = u32;
    #[inline(always)]
