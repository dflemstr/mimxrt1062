...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum RXEDGIE_A {
    #[doc = "0: Hardware interrupts from STAT\\[RXEDGIF\\] are disabled."]
    RXEDGIE_0,
    #[doc = "1: Hardware interrupt is requested when STAT\\[RXEDGIF\\] flag is 1."]
    RXEDGIE_1,
}
impl From<RXEDGIE_A> for bool {
    ...
    fn from(variant: RXEDGIE_A) -> Self {
        match variant {
            RXEDGIE_A::RXEDGIE_0 => false,
            RXEDGIE_A::RXEDGIE_1 => true,
        }
    }
}
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum LBKDIE_A {
    #[doc = "0: Hardware interrupts from STAT\\[LBKDIF\\] flag are disabled (use polling)."]
    LBKDIE_0,
    #[doc = "1: Hardware interrupt requested when STAT\\[LBKDIF\\] flag is 1."]
    LBKDIE_1,
}
impl From<LBKDIE_A> for bool {
    ...
    fn from(variant: LBKDIE_A) -> Self {
        match variant {
            LBKDIE_A::LBKDIE_0 => false,
            LBKDIE_A::LBKDIE_1 => true,
        }
    }
}
...
impl From<RESYNCDIS_A> for bool {
    ...
    fn from(variant: RESYNCDIS_A) -> Self {
        match variant {
            RESYNCDIS_A::RESYNCDIS_0 => false,
            RESYNCDIS_A::RESYNCDIS_1 => true,
        }
    }
}
...
impl From<BOTHEDGE_A> for bool {
    ...
    fn from(variant: BOTHEDGE_A) -> Self {
        match variant {
            BOTHEDGE_A::BOTHEDGE_0 => false,
            BOTHEDGE_A::BOTHEDGE_1 => true,
        }
    }
}
...
impl From<RIDMAE_A> for bool {
    ...
    fn from(variant: RIDMAE_A) -> Self {
        match variant {
            RIDMAE_A::RIDMAE_0 => false,
            RIDMAE_A::RIDMAE_1 => true,
        }
    }
}
...
impl From<RDMAE_A> for bool {
    ...
    fn from(variant: RDMAE_A) -> Self {
        match variant {
            RDMAE_A::RDMAE_0 => false,
            RDMAE_A::RDMAE_1 => true,
        }
    }
}
...
impl From<TDMAE_A> for bool {
    ...
    fn from(variant: TDMAE_A) -> Self {
        match variant {
            TDMAE_A::TDMAE_0 => false,
            TDMAE_A::TDMAE_1 => true,
        }
    }
}
...
impl From<MAEN2_A> for bool {
    ...
    fn from(variant: MAEN2_A) -> Self {
        match variant {
            MAEN2_A::MAEN2_0 => false,
            MAEN2_A::MAEN2_1 => true,
        }
    }
}
...
impl From<MAEN1_A> for bool {
    ...
    fn from(variant: MAEN1_A) -> Self {
        match variant {
            MAEN1_A::MAEN1_0 => false,
            MAEN1_A::MAEN1_1 => true,
        }
    }
}
