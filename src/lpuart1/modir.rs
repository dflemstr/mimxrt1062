...
impl From<TXCTSE_A> for bool {
    ...
    fn from(variant: TXCTSE_A) -> Self {
        match variant {
            TXCTSE_A::TXCTSE_0 => false,
            TXCTSE_A::TXCTSE_1 => true,
        }
    }
}
...
impl From<TXRTSE_A> for bool {
    ...
    fn from(variant: TXRTSE_A) -> Self {
        match variant {
            TXRTSE_A::TXRTSE_0 => false,
            TXRTSE_A::TXRTSE_1 => true,
        }
    }
}
...
impl From<TXRTSPOL_A> for bool {
    ...
    fn from(variant: TXRTSPOL_A) -> Self {
        match variant {
            TXRTSPOL_A::TXRTSPOL_0 => false,
            TXRTSPOL_A::TXRTSPOL_1 => true,
        }
    }
}
...
impl From<RXRTSE_A> for bool {
    ...
    fn from(variant: RXRTSE_A) -> Self {
        match variant {
            RXRTSE_A::RXRTSE_0 => false,
            RXRTSE_A::RXRTSE_1 => true,
        }
    }
}
...
impl From<TXCTSC_A> for bool {
    ...
    fn from(variant: TXCTSC_A) -> Self {
        match variant {
            TXCTSC_A::TXCTSC_0 => false,
            TXCTSC_A::TXCTSC_1 => true,
        }
    }
}
...
impl From<TXCTSSRC_A> for bool {
    ...
    fn from(variant: TXCTSSRC_A) -> Self {
        match variant {
            TXCTSSRC_A::TXCTSSRC_0 => false,
            TXCTSSRC_A::TXCTSSRC_1 => true,
        }
    }
}
