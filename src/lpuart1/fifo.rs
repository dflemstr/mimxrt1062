...
impl From<RXFIFOSIZE_A> for u8 {
    ...
    fn from(variant: RXFIFOSIZE_A) -> Self {
        match variant {
            RXFIFOSIZE_A::RXFIFOSIZE_0 => 0,
            RXFIFOSIZE_A::RXFIFOSIZE_1 => 1,
            RXFIFOSIZE_A::RXFIFOSIZE_2 => 2,
            RXFIFOSIZE_A::RXFIFOSIZE_3 => 3,
            RXFIFOSIZE_A::RXFIFOSIZE_4 => 4,
            RXFIFOSIZE_A::RXFIFOSIZE_5 => 5,
            RXFIFOSIZE_A::RXFIFOSIZE_6 => 6,
            RXFIFOSIZE_A::RXFIFOSIZE_7 => 7,
        }
    }
}
...
impl From<TXFIFOSIZE_A> for u8 {
    ...
    fn from(variant: TXFIFOSIZE_A) -> Self {
        match variant {
            TXFIFOSIZE_A::TXFIFOSIZE_0 => 0,
            TXFIFOSIZE_A::TXFIFOSIZE_1 => 1,
            TXFIFOSIZE_A::TXFIFOSIZE_2 => 2,
            TXFIFOSIZE_A::TXFIFOSIZE_3 => 3,
            TXFIFOSIZE_A::TXFIFOSIZE_4 => 4,
            TXFIFOSIZE_A::TXFIFOSIZE_5 => 5,
            TXFIFOSIZE_A::TXFIFOSIZE_6 => 6,
            TXFIFOSIZE_A::TXFIFOSIZE_7 => 7,
        }
    }
}
...
impl From<RXUFE_A> for bool {
    ...
    fn from(variant: RXUFE_A) -> Self {
        match variant {
            RXUFE_A::RXUFE_0 => false,
            RXUFE_A::RXUFE_1 => true,
        }
    }
}
...
impl From<TXOFE_A> for bool {
    ...
    fn from(variant: TXOFE_A) -> Self {
        match variant {
            TXOFE_A::TXOFE_0 => false,
            TXOFE_A::TXOFE_1 => true,
        }
    }
}
...
impl From<RXFLUSH_A> for bool {
    ...
    fn from(variant: RXFLUSH_A) -> Self {
        match variant {
            RXFLUSH_A::RXFLUSH_0 => false,
            RXFLUSH_A::RXFLUSH_1 => true,
        }
    }
}
...
impl From<TXFLUSH_A> for bool {
    ...
    fn from(variant: TXFLUSH_A) -> Self {
        match variant {
            TXFLUSH_A::TXFLUSH_0 => false,
            TXFLUSH_A::TXFLUSH_1 => true,
        }
    }
}
...
impl From<RXEMPT_A> for bool {
    ...
    fn from(variant: RXEMPT_A) -> Self {
        match variant {
            RXEMPT_A::RXEMPT_0 => false,
            RXEMPT_A::RXEMPT_1 => true,
        }
    }
}
...
impl From<TXEMPT_A> for bool {
    ...
    fn from(variant: TXEMPT_A) -> Self {
        match variant {
            TXEMPT_A::TXEMPT_0 => false,
            TXEMPT_A::TXEMPT_1 => true,
        }
    }
}
