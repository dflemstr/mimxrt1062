...
impl From<LOOPS_A> for bool {
    ...
    fn from(variant: LOOPS_A) -> Self {
        match variant {
            LOOPS_A::LOOPS_0 => false,
            LOOPS_A::LOOPS_1 => true,
        }
    }
}
...
impl From<IDLECFG_A> for u8 {
    ...
    fn from(variant: IDLECFG_A) -> Self {
        match variant {
            IDLECFG_A::IDLECFG_0 => 0,
            IDLECFG_A::IDLECFG_1 => 1,
            IDLECFG_A::IDLECFG_2 => 2,
            IDLECFG_A::IDLECFG_3 => 3,
            IDLECFG_A::IDLECFG_4 => 4,
            IDLECFG_A::IDLECFG_5 => 5,
            IDLECFG_A::IDLECFG_6 => 6,
            IDLECFG_A::IDLECFG_7 => 7,
        }
    }
}
...
impl From<MA2IE_A> for bool {
    ...
    fn from(variant: MA2IE_A) -> Self {
        match variant {
            MA2IE_A::MA2IE_0 => false,
            MA2IE_A::MA2IE_1 => true,
        }
    }
}
...
impl From<MA1IE_A> for bool {
    ...
    fn from(variant: MA1IE_A) -> Self {
        match variant {
            MA1IE_A::MA1IE_0 => false,
            MA1IE_A::MA1IE_1 => true,
        }
    }
}
...
impl From<TXINV_A> for bool {
    ...
    fn from(variant: TXINV_A) -> Self {
        match variant {
            TXINV_A::TXINV_0 => false,
            TXINV_A::TXINV_1 => true,
        }
    }
}
...
impl From<TXDIR_A> for bool {
    ...
    fn from(variant: TXDIR_A) -> Self {
        match variant {
            TXDIR_A::TXDIR_0 => false,
            TXDIR_A::TXDIR_1 => true,
        }
    }
}
