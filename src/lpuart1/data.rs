...
impl From<IDLINE_A> for bool {
    ...
    fn from(variant: IDLINE_A) -> Self {
        match variant {
            IDLINE_A::IDLINE_0 => false,
            IDLINE_A::IDLINE_1 => true,
        }
    }
}
...
impl From<FRETSC_A> for bool {
    ...
    fn from(variant: FRETSC_A) -> Self {
        match variant {
            FRETSC_A::FRETSC_0 => false,
            FRETSC_A::FRETSC_1 => true,
        }
    }
}
...
impl From<PARITYE_A> for bool {
    ...
    fn from(variant: PARITYE_A) -> Self {
        match variant {
            PARITYE_A::PARITYE_0 => false,
            PARITYE_A::PARITYE_1 => true,
        }
    }
}
...
impl From<NOISY_A> for bool {
    ...
    fn from(variant: NOISY_A) -> Self {
        match variant {
            NOISY_A::NOISY_0 => false,
            NOISY_A::NOISY_1 => true,
        }
    }
}
