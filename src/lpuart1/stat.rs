...
impl From<LBKDE_A> for bool {
    ...
    fn from(variant: LBKDE_A) -> Self {
        match variant {
            LBKDE_A::LBKDE_0 => false,
            LBKDE_A::LBKDE_1 => true,
        }
    }
}
...
impl From<BRK13_A> for bool {
    ...
    fn from(variant: BRK13_A) -> Self {
        match variant {
            BRK13_A::BRK13_0 => false,
            BRK13_A::BRK13_1 => true,
        }
    }
}
...
impl From<RWUID_A> for bool {
    ...
    fn from(variant: RWUID_A) -> Self {
        match variant {
            RWUID_A::RWUID_0 => false,
            RWUID_A::RWUID_1 => true,
        }
    }
}
...
impl From<RXINV_A> for bool {
    ...
    fn from(variant: RXINV_A) -> Self {
        match variant {
            RXINV_A::RXINV_0 => false,
            RXINV_A::RXINV_1 => true,
        }
    }
}
...
pub enum MSBF_A {
    ...
    MSBF_0,
    #[doc = "1: MSB (bit9, bit8, bit7 or bit6) is the first bit that is transmitted following the start bit depending on the setting of CTRL\\[M\\], CTRL\\[PE\\] and BAUD\\[M10\\]. Further, the first bit received after the start bit is identified as bit9, bit8, bit7 or bit6 depending on the setting of CTRL\\[M\\] and CTRL\\[PE\\]."]
    MSBF_1,
}
...
impl From<RXEDGIF_A> for bool {
    ...
    fn from(variant: RXEDGIF_A) -> Self {
        match variant {
            RXEDGIF_A::RXEDGIF_0 => false,
            RXEDGIF_A::RXEDGIF_1 => true,
        }
    }
}
...
impl From<LBKDIF_A> for bool {
    ...
    fn from(variant: LBKDIF_A) -> Self {
        match variant {
            LBKDIF_A::LBKDIF_0 => false,
            LBKDIF_A::LBKDIF_1 => true,
        }
    }
}
