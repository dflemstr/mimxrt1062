#[doc = "Reader of register SW_PAD_CTL_PAD_GPIO_SPI_B0_11"]
pub type R = crate::R<u32, super::SW_PAD_CTL_PAD_GPIO_SPI_B0_11>;
#[doc = "Writer for register SW_PAD_CTL_PAD_GPIO_SPI_B0_11"]
pub type W = crate::W<u32, super::SW_PAD_CTL_PAD_GPIO_SPI_B0_11>;
#[doc = "Register SW_PAD_CTL_PAD_GPIO_SPI_B0_11 `reset()`'s with value 0x10b0"]
impl crate::ResetValue for super::SW_PAD_CTL_PAD_GPIO_SPI_B0_11 {
    type Type = u32;
    #[inline(always)]
...
pub enum DSE_A {
    ...
    DSE_1_R0_150_OHM___3_3V__260_OHM_1_8V_,
    #[doc = "2: R0/2"]
    DSE_2_R0_2,
    #[doc = "3: R0/3"]
    DSE_3_R0_3,
...
impl From<DSE_A> for u8 {
    ...
    fn from(variant: DSE_A) -> Self {
        match variant {
            ...
            DSE_A::DSE_1_R0_150_OHM___3_3V__260_OHM_1_8V_ => 1,
            DSE_A::DSE_2_R0_2 => 2,
            DSE_A::DSE_3_R0_3 => 3,
            DSE_A::DSE_4_R0_4 => 4,
            DSE_A::DSE_5_R0_5 => 5,
...
impl DSE_R {
    ...
    pub fn variant(&self) -> DSE_A {
        match self.bits {
            ...
            1 => DSE_A::DSE_1_R0_150_OHM___3_3V__260_OHM_1_8V_,
            2 => DSE_A::DSE_2_R0_2,
            3 => DSE_A::DSE_3_R0_3,
            4 => DSE_A::DSE_4_R0_4,
            5 => DSE_A::DSE_5_R0_5,
    ...
    #[doc = "Checks if the value of the field is `DSE_1_R0_150_OHM___3_3V__260_OHM_1_8V_`"]
    #[inline(always)]
    pub fn is_dse_1_r0_150_ohm___3_3v__260_ohm_1_8v_(&self) -> bool {
        *self == DSE_A::DSE_1_R0_150_OHM___3_3V__260_OHM_1_8V_
    }
...
impl<'a> DSE_W<'a> {
    ...
    #[inline(always)]
    pub fn dse_1_r0_150_ohm___3_3v__260_ohm_1_8v_(self) -> &'a mut W {
        self.variant(DSE_A::DSE_1_R0_150_OHM___3_3V__260_OHM_1_8V_)
    }
    #[doc = "R0/2"]
    #[inline(always)]
