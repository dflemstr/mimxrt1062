...
impl From<EXE_TUNE_A> for bool {
    ...
    fn from(variant: EXE_TUNE_A) -> Self {
        match variant {
            EXE_TUNE_A::EXE_TUNE_0 => false,
            EXE_TUNE_A::EXE_TUNE_1 => true,
        }
    }
}
...
impl From<SMP_CLK_SEL_A> for bool {
    ...
    fn from(variant: SMP_CLK_SEL_A) -> Self {
        match variant {
            SMP_CLK_SEL_A::SMP_CLK_SEL_0 => false,
            SMP_CLK_SEL_A::SMP_CLK_SEL_1 => true,
        }
    }
}
...
impl From<AUTO_TUNE_EN_A> for bool {
    ...
    fn from(variant: AUTO_TUNE_EN_A) -> Self {
        match variant {
            AUTO_TUNE_EN_A::AUTO_TUNE_EN_0 => false,
            AUTO_TUNE_EN_A::AUTO_TUNE_EN_1 => true,
        }
    }
}
...
impl From<FBCLK_SEL_A> for bool {
    ...
    fn from(variant: FBCLK_SEL_A) -> Self {
        match variant {
            FBCLK_SEL_A::FBCLK_SEL_0 => false,
            FBCLK_SEL_A::FBCLK_SEL_1 => true,
        }
    }
}
