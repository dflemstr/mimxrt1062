...
impl From<SABGREQ_A> for bool {
    ...
    fn from(variant: SABGREQ_A) -> Self {
        match variant {
            SABGREQ_A::SABGREQ_0 => false,
            SABGREQ_A::SABGREQ_1 => true,
        }
    }
}
...
impl From<RWCTL_A> for bool {
    ...
    fn from(variant: RWCTL_A) -> Self {
        match variant {
            RWCTL_A::RWCTL_0 => false,
            RWCTL_A::RWCTL_1 => true,
        }
    }
}
...
impl From<WECINT_A> for bool {
    ...
    fn from(variant: WECINT_A) -> Self {
        match variant {
            WECINT_A::WECINT_0 => false,
            WECINT_A::WECINT_1 => true,
        }
    }
}
...
impl From<WECINS_A> for bool {
    ...
    fn from(variant: WECINS_A) -> Self {
        match variant {
            WECINS_A::WECINS_0 => false,
            WECINS_A::WECINS_1 => true,
        }
    }
}
...
impl From<WECRM_A> for bool {
    ...
    fn from(variant: WECRM_A) -> Self {
        match variant {
            WECRM_A::WECRM_0 => false,
            WECRM_A::WECRM_1 => true,
        }
    }
}
...
impl From<BURST_LEN_EN_A> for u8 {
    ...
    fn from(variant: BURST_LEN_EN_A) -> Self {
        match variant {
            BURST_LEN_EN_A::BURST_LEN_EN_1 => 1,
        }
    }
}
...
impl From<NON_EXACT_BLK_RD_A> for bool {
    ...
    fn from(variant: NON_EXACT_BLK_RD_A) -> Self {
        match variant {
            NON_EXACT_BLK_RD_A::NON_EXACT_BLK_RD_0 => false,
            NON_EXACT_BLK_RD_A::NON_EXACT_BLK_RD_1 => true,
        }
    }
}
