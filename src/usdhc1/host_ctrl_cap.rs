...
impl From<USE_TUNING_SDR50_A> for bool {
    ...
    fn from(variant: USE_TUNING_SDR50_A) -> Self {
        match variant {
            USE_TUNING_SDR50_A::USE_TUNING_SDR50_0 => false,
            USE_TUNING_SDR50_A::USE_TUNING_SDR50_1 => true,
        }
    }
}
...
impl From<RETUNING_MODE_A> for u8 {
    ...
    fn from(variant: RETUNING_MODE_A) -> Self {
        match variant {
            RETUNING_MODE_A::RETUNING_MODE_0 => 0,
            RETUNING_MODE_A::RETUNING_MODE_1 => 1,
            RETUNING_MODE_A::RETUNING_MODE_2 => 2,
        }
    }
}
