...
impl From<DTOCV_ACK_A> for u8 {
    ...
    fn from(variant: DTOCV_ACK_A) -> Self {
        match variant {
            DTOCV_ACK_A::DTOCV_ACK_0 => 0,
            DTOCV_ACK_A::DTOCV_ACK_1 => 1,
            DTOCV_ACK_A::DTOCV_ACK_2 => 2,
            DTOCV_ACK_A::DTOCV_ACK_3 => 3,
            DTOCV_ACK_A::DTOCV_ACK_4 => 4,
            DTOCV_ACK_A::DTOCV_ACK_5 => 5,
            DTOCV_ACK_A::DTOCV_ACK_6 => 6,
            DTOCV_ACK_A::DTOCV_ACK_7 => 7,
            DTOCV_ACK_A::DTOCV_ACK_14 => 14,
            DTOCV_ACK_A::DTOCV_ACK_15 => 15,
        }
    }
}
...
impl From<BOOT_ACK_A> for bool {
    ...
    fn from(variant: BOOT_ACK_A) -> Self {
        match variant {
            BOOT_ACK_A::BOOT_ACK_0 => false,
            BOOT_ACK_A::BOOT_ACK_1 => true,
        }
    }
}
...
impl From<BOOT_MODE_A> for bool {
    ...
    fn from(variant: BOOT_MODE_A) -> Self {
        match variant {
            BOOT_MODE_A::BOOT_MODE_0 => false,
            BOOT_MODE_A::BOOT_MODE_1 => true,
        }
    }
}
...
impl From<BOOT_EN_A> for bool {
    ...
    fn from(variant: BOOT_EN_A) -> Self {
        match variant {
            BOOT_EN_A::BOOT_EN_0 => false,
            BOOT_EN_A::BOOT_EN_1 => true,
        }
    }
}
...
impl From<DISABLE_TIME_OUT_A> for bool {
    ...
    fn from(variant: DISABLE_TIME_OUT_A) -> Self {
        match variant {
            DISABLE_TIME_OUT_A::DISABLE_TIME_OUT_0 => false,
            DISABLE_TIME_OUT_A::DISABLE_TIME_OUT_1 => true,
        }
    }
}
