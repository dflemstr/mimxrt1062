...
impl From<CCIEN_A> for bool {
    ...
    fn from(variant: CCIEN_A) -> Self {
        match variant {
            CCIEN_A::CCIEN_0 => false,
            CCIEN_A::CCIEN_1 => true,
        }
    }
}
...
impl From<TCIEN_A> for bool {
    ...
    fn from(variant: TCIEN_A) -> Self {
        match variant {
            TCIEN_A::TCIEN_0 => false,
            TCIEN_A::TCIEN_1 => true,
        }
    }
}
...
impl From<BGEIEN_A> for bool {
    ...
    fn from(variant: BGEIEN_A) -> Self {
        match variant {
            BGEIEN_A::BGEIEN_0 => false,
            BGEIEN_A::BGEIEN_1 => true,
        }
    }
}
...
impl From<DINTIEN_A> for bool {
    ...
    fn from(variant: DINTIEN_A) -> Self {
        match variant {
            DINTIEN_A::DINTIEN_0 => false,
            DINTIEN_A::DINTIEN_1 => true,
        }
    }
}
...
impl From<BWRIEN_A> for bool {
    ...
    fn from(variant: BWRIEN_A) -> Self {
        match variant {
            BWRIEN_A::BWRIEN_0 => false,
            BWRIEN_A::BWRIEN_1 => true,
        }
    }
}
...
impl From<BRRIEN_A> for bool {
    ...
    fn from(variant: BRRIEN_A) -> Self {
        match variant {
            BRRIEN_A::BRRIEN_0 => false,
            BRRIEN_A::BRRIEN_1 => true,
        }
    }
}
...
impl From<CINSIEN_A> for bool {
    ...
    fn from(variant: CINSIEN_A) -> Self {
        match variant {
            CINSIEN_A::CINSIEN_0 => false,
            CINSIEN_A::CINSIEN_1 => true,
        }
    }
}
...
impl From<CRMIEN_A> for bool {
    ...
    fn from(variant: CRMIEN_A) -> Self {
        match variant {
            CRMIEN_A::CRMIEN_0 => false,
            CRMIEN_A::CRMIEN_1 => true,
        }
    }
}
...
impl From<CINTIEN_A> for bool {
    ...
    fn from(variant: CINTIEN_A) -> Self {
        match variant {
            CINTIEN_A::CINTIEN_0 => false,
            CINTIEN_A::CINTIEN_1 => true,
        }
    }
}
...
impl From<RTEIEN_A> for bool {
    ...
    fn from(variant: RTEIEN_A) -> Self {
        match variant {
            RTEIEN_A::RTEIEN_0 => false,
            RTEIEN_A::RTEIEN_1 => true,
        }
    }
}
...
impl From<TPIEN_A> for bool {
    ...
    fn from(variant: TPIEN_A) -> Self {
        match variant {
            TPIEN_A::TPIEN_0 => false,
            TPIEN_A::TPIEN_1 => true,
        }
    }
}
...
impl From<CTOEIEN_A> for bool {
    ...
    fn from(variant: CTOEIEN_A) -> Self {
        match variant {
            CTOEIEN_A::CTOEIEN_0 => false,
            CTOEIEN_A::CTOEIEN_1 => true,
        }
    }
}
...
impl From<CCEIEN_A> for bool {
    ...
    fn from(variant: CCEIEN_A) -> Self {
        match variant {
            CCEIEN_A::CCEIEN_0 => false,
            CCEIEN_A::CCEIEN_1 => true,
        }
    }
}
...
impl From<CEBEIEN_A> for bool {
    ...
    fn from(variant: CEBEIEN_A) -> Self {
        match variant {
            CEBEIEN_A::CEBEIEN_0 => false,
            CEBEIEN_A::CEBEIEN_1 => true,
        }
    }
}
...
impl From<CIEIEN_A> for bool {
    ...
    fn from(variant: CIEIEN_A) -> Self {
        match variant {
            CIEIEN_A::CIEIEN_0 => false,
            CIEIEN_A::CIEIEN_1 => true,
        }
    }
}
...
impl From<DTOEIEN_A> for bool {
    ...
    fn from(variant: DTOEIEN_A) -> Self {
        match variant {
            DTOEIEN_A::DTOEIEN_0 => false,
            DTOEIEN_A::DTOEIEN_1 => true,
        }
    }
}
...
impl From<DCEIEN_A> for bool {
    ...
    fn from(variant: DCEIEN_A) -> Self {
        match variant {
            DCEIEN_A::DCEIEN_0 => false,
            DCEIEN_A::DCEIEN_1 => true,
        }
    }
}
...
impl From<DEBEIEN_A> for bool {
    ...
    fn from(variant: DEBEIEN_A) -> Self {
        match variant {
            DEBEIEN_A::DEBEIEN_0 => false,
            DEBEIEN_A::DEBEIEN_1 => true,
        }
    }
}
...
impl From<AC12EIEN_A> for bool {
    ...
    fn from(variant: AC12EIEN_A) -> Self {
        match variant {
            AC12EIEN_A::AC12EIEN_0 => false,
            AC12EIEN_A::AC12EIEN_1 => true,
        }
    }
}
...
impl From<TNEIEN_A> for bool {
    ...
    fn from(variant: TNEIEN_A) -> Self {
        match variant {
            TNEIEN_A::TNEIEN_0 => false,
            TNEIEN_A::TNEIEN_1 => true,
        }
    }
}
...
impl From<DMAEIEN_A> for bool {
    ...
    fn from(variant: DMAEIEN_A) -> Self {
        match variant {
            DMAEIEN_A::DMAEIEN_0 => false,
            DMAEIEN_A::DMAEIEN_1 => true,
        }
    }
}
