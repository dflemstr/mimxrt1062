...
impl From<VSELECT_A> for bool {
    ...
    fn from(variant: VSELECT_A) -> Self {
        match variant {
            VSELECT_A::VSELECT_0 => false,
            VSELECT_A::VSELECT_1 => true,
        }
    }
}
...
impl From<CONFLICT_CHK_EN_A> for bool {
    ...
    fn from(variant: CONFLICT_CHK_EN_A) -> Self {
        match variant {
            CONFLICT_CHK_EN_A::CONFLICT_CHK_EN_0 => false,
            CONFLICT_CHK_EN_A::CONFLICT_CHK_EN_1 => true,
        }
    }
}
...
impl From<AC12_WR_CHKBUSY_EN_A> for bool {
    ...
    fn from(variant: AC12_WR_CHKBUSY_EN_A) -> Self {
        match variant {
            AC12_WR_CHKBUSY_EN_A::AC12_WR_CHKBUSY_EN_0 => false,
            AC12_WR_CHKBUSY_EN_A::AC12_WR_CHKBUSY_EN_1 => true,
        }
    }
}
...
impl From<FRC_SDCLK_ON_A> for bool {
    ...
    fn from(variant: FRC_SDCLK_ON_A) -> Self {
        match variant {
            FRC_SDCLK_ON_A::FRC_SDCLK_ON_0 => false,
            FRC_SDCLK_ON_A::FRC_SDCLK_ON_1 => true,
        }
    }
}
...
impl From<CRC_CHK_DIS_A> for bool {
    ...
    fn from(variant: CRC_CHK_DIS_A) -> Self {
        match variant {
            CRC_CHK_DIS_A::CRC_CHK_DIS_0 => false,
            CRC_CHK_DIS_A::CRC_CHK_DIS_1 => true,
        }
    }
}
...
impl From<CMD_BYTE_EN_A> for bool {
    ...
    fn from(variant: CMD_BYTE_EN_A) -> Self {
        match variant {
            CMD_BYTE_EN_A::CMD_BYTE_EN_0 => false,
            CMD_BYTE_EN_A::CMD_BYTE_EN_1 => true,
        }
    }
}
