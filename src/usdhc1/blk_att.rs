...
impl From<BLKSIZE_A> for u16 {
    ...
    fn from(variant: BLKSIZE_A) -> Self {
        match variant {
            BLKSIZE_A::BLKSIZE_0 => 0,
            BLKSIZE_A::BLKSIZE_1 => 1,
            BLKSIZE_A::BLKSIZE_2 => 2,
            BLKSIZE_A::BLKSIZE_3 => 3,
            BLKSIZE_A::BLKSIZE_4 => 4,
            BLKSIZE_A::BLKSIZE_511 => 511,
            BLKSIZE_A::BLKSIZE_512 => 512,
            BLKSIZE_A::BLKSIZE_2048 => 2048,
            BLKSIZE_A::BLKSIZE_4096 => 4096,
        }
    }
}
