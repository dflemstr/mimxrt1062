...
impl From<CCSEN_A> for bool {
    ...
    fn from(variant: CCSEN_A) -> Self {
        match variant {
            CCSEN_A::CCSEN_0 => false,
            CCSEN_A::CCSEN_1 => true,
        }
    }
}
...
impl From<TCSEN_A> for bool {
    ...
    fn from(variant: TCSEN_A) -> Self {
        match variant {
            TCSEN_A::TCSEN_0 => false,
            TCSEN_A::TCSEN_1 => true,
        }
    }
}
...
impl From<BGESEN_A> for bool {
    ...
    fn from(variant: BGESEN_A) -> Self {
        match variant {
            BGESEN_A::BGESEN_0 => false,
            BGESEN_A::BGESEN_1 => true,
        }
    }
}
...
impl From<DINTSEN_A> for bool {
    ...
    fn from(variant: DINTSEN_A) -> Self {
        match variant {
            DINTSEN_A::DINTSEN_0 => false,
            DINTSEN_A::DINTSEN_1 => true,
        }
    }
}
...
impl From<BWRSEN_A> for bool {
    ...
    fn from(variant: BWRSEN_A) -> Self {
        match variant {
            BWRSEN_A::BWRSEN_0 => false,
            BWRSEN_A::BWRSEN_1 => true,
        }
    }
}
...
impl From<BRRSEN_A> for bool {
    ...
    fn from(variant: BRRSEN_A) -> Self {
        match variant {
            BRRSEN_A::BRRSEN_0 => false,
            BRRSEN_A::BRRSEN_1 => true,
        }
    }
}
...
impl From<CINSSEN_A> for bool {
    ...
    fn from(variant: CINSSEN_A) -> Self {
        match variant {
            CINSSEN_A::CINSSEN_0 => false,
            CINSSEN_A::CINSSEN_1 => true,
        }
    }
}
...
impl From<CRMSEN_A> for bool {
    ...
    fn from(variant: CRMSEN_A) -> Self {
        match variant {
            CRMSEN_A::CRMSEN_0 => false,
            CRMSEN_A::CRMSEN_1 => true,
        }
    }
}
...
impl From<CINTSEN_A> for bool {
    ...
    fn from(variant: CINTSEN_A) -> Self {
        match variant {
            CINTSEN_A::CINTSEN_0 => false,
            CINTSEN_A::CINTSEN_1 => true,
        }
    }
}
...
impl From<RTESEN_A> for bool {
    ...
    fn from(variant: RTESEN_A) -> Self {
        match variant {
            RTESEN_A::RTESEN_0 => false,
            RTESEN_A::RTESEN_1 => true,
        }
    }
}
...
impl From<TPSEN_A> for bool {
    ...
    fn from(variant: TPSEN_A) -> Self {
        match variant {
            TPSEN_A::TPSEN_0 => false,
            TPSEN_A::TPSEN_1 => true,
        }
    }
}
...
impl From<CTOESEN_A> for bool {
    ...
    fn from(variant: CTOESEN_A) -> Self {
        match variant {
            CTOESEN_A::CTOESEN_0 => false,
            CTOESEN_A::CTOESEN_1 => true,
        }
    }
}
...
impl From<CCESEN_A> for bool {
    ...
    fn from(variant: CCESEN_A) -> Self {
        match variant {
            CCESEN_A::CCESEN_0 => false,
            CCESEN_A::CCESEN_1 => true,
        }
    }
}
...
impl From<CEBESEN_A> for bool {
    ...
    fn from(variant: CEBESEN_A) -> Self {
        match variant {
            CEBESEN_A::CEBESEN_0 => false,
            CEBESEN_A::CEBESEN_1 => true,
        }
    }
}
...
impl From<CIESEN_A> for bool {
    ...
    fn from(variant: CIESEN_A) -> Self {
        match variant {
            CIESEN_A::CIESEN_0 => false,
            CIESEN_A::CIESEN_1 => true,
        }
    }
}
...
impl From<DTOESEN_A> for bool {
    ...
    fn from(variant: DTOESEN_A) -> Self {
        match variant {
            DTOESEN_A::DTOESEN_0 => false,
            DTOESEN_A::DTOESEN_1 => true,
        }
    }
}
...
impl From<DCESEN_A> for bool {
    ...
    fn from(variant: DCESEN_A) -> Self {
        match variant {
            DCESEN_A::DCESEN_0 => false,
            DCESEN_A::DCESEN_1 => true,
        }
    }
}
...
impl From<DEBESEN_A> for bool {
    ...
    fn from(variant: DEBESEN_A) -> Self {
        match variant {
            DEBESEN_A::DEBESEN_0 => false,
            DEBESEN_A::DEBESEN_1 => true,
        }
    }
}
...
impl From<AC12ESEN_A> for bool {
    ...
    fn from(variant: AC12ESEN_A) -> Self {
        match variant {
            AC12ESEN_A::AC12ESEN_0 => false,
            AC12ESEN_A::AC12ESEN_1 => true,
        }
    }
}
...
impl From<TNESEN_A> for bool {
    ...
    fn from(variant: TNESEN_A) -> Self {
        match variant {
            TNESEN_A::TNESEN_0 => false,
            TNESEN_A::TNESEN_1 => true,
        }
    }
}
...
impl From<DMAESEN_A> for bool {
    ...
    fn from(variant: DMAESEN_A) -> Self {
        match variant {
            DMAESEN_A::DMAESEN_0 => false,
            DMAESEN_A::DMAESEN_1 => true,
        }
    }
}
