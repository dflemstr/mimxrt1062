#[doc = "Reader of register LPGPR[%s]"]
pub type R = crate::R<u32, super::LPGPR>;
#[doc = "Writer for register LPGPR[%s]"]
pub type W = crate::W<u32, super::LPGPR>;
#[doc = "Register LPGPR[%s] `reset()`'s with value 0"]
impl crate::ResetValue for super::LPGPR {
    type Type = u32;
    #[inline(always)]
