...
impl From<SSM_STATE_A> for u8 {
    ...
    fn from(variant: SSM_STATE_A) -> Self {
        match variant {
            SSM_STATE_A::SSM_STATE_0 => 0,
            SSM_STATE_A::SSM_STATE_1 => 1,
            SSM_STATE_A::SSM_STATE_3 => 3,
            SSM_STATE_A::SSM_STATE_8 => 8,
            SSM_STATE_A::SSM_STATE_9 => 9,
            SSM_STATE_A::SSM_STATE_11 => 11,
            SSM_STATE_A::SSM_STATE_13 => 13,
            SSM_STATE_A::SSM_STATE_15 => 15,
        }
    }
}
...
pub enum SECURITY_CONFIG_A {
    #[doc = "0: FAB configuration"]
    FAB_CONFIG_1,
    #[doc = "1: OPEN configuration"]
    OPEN_CONFIG_1,
    #[doc = "2: OPEN configuration"]
    OPEN_CONFIG_2,
    #[doc = "3: OPEN configuration"]
    OPEN_CONFIG_3,
    #[doc = "4: FIELD RETURN configuration"]
    FIELD_RETURN_CONFIG,
    #[doc = "8: FAB configuration"]
    FAB_CONFIG_2,
    #[doc = "9: CLOSED configuration"]
    CLOSED_CONFIG_1,
    #[doc = "10: CLOSED configuration"]
    CLOSED_CONFIG_2,
    #[doc = "11: CLOSED configuration"]
    CLOSED_CONFIG_3,
}
impl From<SECURITY_CONFIG_A> for u8 {
    ...
    fn from(variant: SECURITY_CONFIG_A) -> Self {
        match variant {
            SECURITY_CONFIG_A::FAB_CONFIG_1 => 0,
            SECURITY_CONFIG_A::OPEN_CONFIG_1 => 1,
            SECURITY_CONFIG_A::OPEN_CONFIG_2 => 2,
            SECURITY_CONFIG_A::OPEN_CONFIG_3 => 3,
            SECURITY_CONFIG_A::FIELD_RETURN_CONFIG => 4,
            SECURITY_CONFIG_A::FAB_CONFIG_2 => 8,
            SECURITY_CONFIG_A::CLOSED_CONFIG_1 => 9,
            SECURITY_CONFIG_A::CLOSED_CONFIG_2 => 10,
            SECURITY_CONFIG_A::CLOSED_CONFIG_3 => 11,
        }
    }
}
...
impl From<OTPMK_ZERO_A> for bool {
    ...
    fn from(variant: OTPMK_ZERO_A) -> Self {
        match variant {
            OTPMK_ZERO_A::OTPMK_ZERO_0 => false,
            OTPMK_ZERO_A::OTPMK_ZERO_1 => true,
        }
    }
}
...
impl From<ZMK_ZERO_A> for bool {
    ...
    fn from(variant: ZMK_ZERO_A) -> Self {
        match variant {
            ZMK_ZERO_A::ZMK_ZERO_0 => false,
            ZMK_ZERO_A::ZMK_ZERO_1 => true,
        }
    }
}
