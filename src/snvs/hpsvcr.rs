...
impl From<SV0_CFG_A> for bool {
    ...
    fn from(variant: SV0_CFG_A) -> Self {
        match variant {
            SV0_CFG_A::SV0_CFG_0 => false,
            SV0_CFG_A::SV0_CFG_1 => true,
        }
    }
}
...
impl From<SV1_CFG_A> for bool {
    ...
    fn from(variant: SV1_CFG_A) -> Self {
        match variant {
            SV1_CFG_A::SV1_CFG_0 => false,
            SV1_CFG_A::SV1_CFG_1 => true,
        }
    }
}
...
impl From<SV2_CFG_A> for bool {
    ...
    fn from(variant: SV2_CFG_A) -> Self {
        match variant {
            SV2_CFG_A::SV2_CFG_0 => false,
            SV2_CFG_A::SV2_CFG_1 => true,
        }
    }
}
...
impl From<SV3_CFG_A> for bool {
    ...
    fn from(variant: SV3_CFG_A) -> Self {
        match variant {
            SV3_CFG_A::SV3_CFG_0 => false,
            SV3_CFG_A::SV3_CFG_1 => true,
        }
    }
}
...
impl From<SV4_CFG_A> for bool {
    ...
    fn from(variant: SV4_CFG_A) -> Self {
        match variant {
            SV4_CFG_A::SV4_CFG_0 => false,
            SV4_CFG_A::SV4_CFG_1 => true,
        }
    }
}
...
impl From<SV5_CFG_A> for u8 {
    ...
    fn from(variant: SV5_CFG_A) -> Self {
        match variant {
            SV5_CFG_A::SV5_CFG_0 => 0,
            SV5_CFG_A::SV5_CFG_1 => 1,
            SV5_CFG_A::SV5_CFG_2 => 2,
        }
    }
}
...
impl From<LPSV_CFG_A> for u8 {
    ...
    fn from(variant: LPSV_CFG_A) -> Self {
        match variant {
            LPSV_CFG_A::LPSV_CFG_0 => 0,
            LPSV_CFG_A::LPSV_CFG_1 => 1,
            LPSV_CFG_A::LPSV_CFG_2 => 2,
        }
    }
}
