...
impl From<ZMK_WSL_A> for bool {
    ...
    fn from(variant: ZMK_WSL_A) -> Self {
        match variant {
            ZMK_WSL_A::ZMK_WSL_0 => false,
            ZMK_WSL_A::ZMK_WSL_1 => true,
        }
    }
}
...
impl From<ZMK_RSL_A> for bool {
    ...
    fn from(variant: ZMK_RSL_A) -> Self {
        match variant {
            ZMK_RSL_A::ZMK_RSL_0 => false,
            ZMK_RSL_A::ZMK_RSL_1 => true,
        }
    }
}
...
impl From<SRTC_SL_A> for bool {
    ...
    fn from(variant: SRTC_SL_A) -> Self {
        match variant {
            SRTC_SL_A::SRTC_SL_0 => false,
            SRTC_SL_A::SRTC_SL_1 => true,
        }
    }
}
...
impl From<LPCALB_SL_A> for bool {
    ...
    fn from(variant: LPCALB_SL_A) -> Self {
        match variant {
            LPCALB_SL_A::LPCALB_SL_0 => false,
            LPCALB_SL_A::LPCALB_SL_1 => true,
        }
    }
}
...
impl From<MC_SL_A> for bool {
    ...
    fn from(variant: MC_SL_A) -> Self {
        match variant {
            MC_SL_A::MC_SL_0 => false,
            MC_SL_A::MC_SL_1 => true,
        }
    }
}
...
impl From<GPR_SL_A> for bool {
    ...
    fn from(variant: GPR_SL_A) -> Self {
        match variant {
            GPR_SL_A::GPR_SL_0 => false,
            GPR_SL_A::GPR_SL_1 => true,
        }
    }
}
...
impl From<LPSVCR_SL_A> for bool {
    ...
    fn from(variant: LPSVCR_SL_A) -> Self {
        match variant {
            LPSVCR_SL_A::LPSVCR_SL_0 => false,
            LPSVCR_SL_A::LPSVCR_SL_1 => true,
        }
    }
}
...
impl From<LPTDCR_SL_A> for bool {
    ...
    fn from(variant: LPTDCR_SL_A) -> Self {
        match variant {
            LPTDCR_SL_A::LPTDCR_SL_0 => false,
            LPTDCR_SL_A::LPTDCR_SL_1 => true,
        }
    }
}
...
impl From<MKS_SL_A> for bool {
    ...
    fn from(variant: MKS_SL_A) -> Self {
        match variant {
            MKS_SL_A::MKS_SL_0 => false,
            MKS_SL_A::MKS_SL_1 => true,
        }
    }
}
...
impl From<HPSVCR_L_A> for bool {
    ...
    fn from(variant: HPSVCR_L_A) -> Self {
        match variant {
            HPSVCR_L_A::HPSVCR_L_0 => false,
            HPSVCR_L_A::HPSVCR_L_1 => true,
        }
    }
}
...
impl From<HPSICR_L_A> for bool {
    ...
    fn from(variant: HPSICR_L_A) -> Self {
        match variant {
            HPSICR_L_A::HPSICR_L_0 => false,
            HPSICR_L_A::HPSICR_L_1 => true,
        }
    }
}
...
impl From<HAC_L_A> for bool {
    ...
    fn from(variant: HAC_L_A) -> Self {
        match variant {
            HAC_L_A::HAC_L_0 => false,
            HAC_L_A::HAC_L_1 => true,
        }
    }
}
