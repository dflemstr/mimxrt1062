...
impl From<SSM_ST_DIS_A> for bool {
    ...
    fn from(variant: SSM_ST_DIS_A) -> Self {
        match variant {
            SSM_ST_DIS_A::SSM_ST_DIS_0 => false,
            SSM_ST_DIS_A::SSM_ST_DIS_1 => true,
        }
    }
}
...
impl From<SSM_SFNS_DIS_A> for bool {
    ...
    fn from(variant: SSM_SFNS_DIS_A) -> Self {
        match variant {
            SSM_SFNS_DIS_A::SSM_SFNS_DIS_0 => false,
            SSM_SFNS_DIS_A::SSM_SFNS_DIS_1 => true,
        }
    }
}
...
impl From<LP_SWR_AW> for bool {
    ...
    fn from(variant: LP_SWR_AW) -> Self {
        match variant {
            LP_SWR_AW::LP_SWR_0 => false,
            LP_SWR_AW::LP_SWR_1 => true,
        }
    }
}
...
impl From<LP_SWR_DIS_A> for bool {
    ...
    fn from(variant: LP_SWR_DIS_A) -> Self {
        match variant {
            LP_SWR_DIS_A::LP_SWR_DIS_0 => false,
            LP_SWR_DIS_A::LP_SWR_DIS_1 => true,
        }
    }
}
...
impl From<PROG_ZMK_AW> for bool {
    ...
    fn from(variant: PROG_ZMK_AW) -> Self {
        match variant {
            PROG_ZMK_AW::PROG_ZMK_0 => false,
            PROG_ZMK_AW::PROG_ZMK_1 => true,
        }
    }
}
...
impl From<MKS_EN_A> for bool {
    ...
    fn from(variant: MKS_EN_A) -> Self {
        match variant {
            MKS_EN_A::MKS_EN_0 => false,
            MKS_EN_A::MKS_EN_1 => true,
        }
    }
}
...
impl From<HAC_EN_A> for bool {
    ...
    fn from(variant: HAC_EN_A) -> Self {
        match variant {
            HAC_EN_A::HAC_EN_0 => false,
            HAC_EN_A::HAC_EN_1 => true,
        }
    }
}
...
impl From<HAC_LOAD_AW> for bool {
    ...
    fn from(variant: HAC_LOAD_AW) -> Self {
        match variant {
            HAC_LOAD_AW::HAC_LOAD_0 => false,
            HAC_LOAD_AW::HAC_LOAD_1 => true,
        }
    }
}
...
impl From<HAC_CLEAR_AW> for bool {
    ...
    fn from(variant: HAC_CLEAR_AW) -> Self {
        match variant {
            HAC_CLEAR_AW::HAC_CLEAR_0 => false,
            HAC_CLEAR_AW::HAC_CLEAR_1 => true,
        }
    }
}
