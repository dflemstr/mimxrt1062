...
impl From<RTC_EN_A> for bool {
    ...
    fn from(variant: RTC_EN_A) -> Self {
        match variant {
            RTC_EN_A::RTC_EN_0 => false,
            RTC_EN_A::RTC_EN_1 => true,
        }
    }
}
...
impl From<HPTA_EN_A> for bool {
    ...
    fn from(variant: HPTA_EN_A) -> Self {
        match variant {
            HPTA_EN_A::HPTA_EN_0 => false,
            HPTA_EN_A::HPTA_EN_1 => true,
        }
    }
}
...
impl From<DIS_PI_A> for bool {
    ...
    fn from(variant: DIS_PI_A) -> Self {
        match variant {
            DIS_PI_A::DIS_PI_0 => false,
            DIS_PI_A::DIS_PI_1 => true,
        }
    }
}
...
impl From<PI_EN_A> for bool {
    ...
    fn from(variant: PI_EN_A) -> Self {
        match variant {
            PI_EN_A::PI_EN_0 => false,
            PI_EN_A::PI_EN_1 => true,
        }
    }
}
...
impl From<PI_FREQ_A> for u8 {
    ...
    fn from(variant: PI_FREQ_A) -> Self {
        match variant {
            PI_FREQ_A::PI_FREQ_0 => 0,
            PI_FREQ_A::PI_FREQ_1 => 1,
            PI_FREQ_A::PI_FREQ_2 => 2,
            PI_FREQ_A::PI_FREQ_3 => 3,
            PI_FREQ_A::PI_FREQ_4 => 4,
            PI_FREQ_A::PI_FREQ_5 => 5,
            PI_FREQ_A::PI_FREQ_6 => 6,
            PI_FREQ_A::PI_FREQ_7 => 7,
            PI_FREQ_A::PI_FREQ_8 => 8,
            PI_FREQ_A::PI_FREQ_9 => 9,
            PI_FREQ_A::PI_FREQ_10 => 10,
            PI_FREQ_A::PI_FREQ_11 => 11,
            PI_FREQ_A::PI_FREQ_12 => 12,
            PI_FREQ_A::PI_FREQ_13 => 13,
            PI_FREQ_A::PI_FREQ_14 => 14,
            PI_FREQ_A::PI_FREQ_15 => 15,
        }
    }
}
...
impl From<HPCALB_EN_A> for bool {
    ...
    fn from(variant: HPCALB_EN_A) -> Self {
        match variant {
            HPCALB_EN_A::HPCALB_EN_0 => false,
            HPCALB_EN_A::HPCALB_EN_1 => true,
        }
    }
}
...
impl From<HPCALB_VAL_A> for u8 {
    ...
    fn from(variant: HPCALB_VAL_A) -> Self {
        match variant {
            HPCALB_VAL_A::HPCALB_VAL_0 => 0,
            HPCALB_VAL_A::HPCALB_VAL_1 => 1,
            HPCALB_VAL_A::HPCALB_VAL_2 => 2,
            HPCALB_VAL_A::HPCALB_VAL_15 => 15,
            HPCALB_VAL_A::HPCALB_VAL_16 => 16,
            HPCALB_VAL_A::HPCALB_VAL_17 => 17,
            HPCALB_VAL_A::HPCALB_VAL_30 => 30,
            HPCALB_VAL_A::HPCALB_VAL_31 => 31,
        }
    }
}
...
impl From<HP_TS_A> for bool {
    ...
    fn from(variant: HP_TS_A) -> Self {
        match variant {
            HP_TS_A::HP_TS_0 => false,
            HP_TS_A::HP_TS_1 => true,
        }
    }
}
