...
impl From<SV0_EN_A> for bool {
    ...
    fn from(variant: SV0_EN_A) -> Self {
        match variant {
            SV0_EN_A::SV0_EN_0 => false,
            SV0_EN_A::SV0_EN_1 => true,
        }
    }
}
...
impl From<SV1_EN_A> for bool {
    ...
    fn from(variant: SV1_EN_A) -> Self {
        match variant {
            SV1_EN_A::SV1_EN_0 => false,
            SV1_EN_A::SV1_EN_1 => true,
        }
    }
}
...
impl From<SV2_EN_A> for bool {
    ...
    fn from(variant: SV2_EN_A) -> Self {
        match variant {
            SV2_EN_A::SV2_EN_0 => false,
            SV2_EN_A::SV2_EN_1 => true,
        }
    }
}
...
impl From<SV3_EN_A> for bool {
    ...
    fn from(variant: SV3_EN_A) -> Self {
        match variant {
            SV3_EN_A::SV3_EN_0 => false,
            SV3_EN_A::SV3_EN_1 => true,
        }
    }
}
...
impl From<SV4_EN_A> for bool {
    ...
    fn from(variant: SV4_EN_A) -> Self {
        match variant {
            SV4_EN_A::SV4_EN_0 => false,
            SV4_EN_A::SV4_EN_1 => true,
        }
    }
}
...
impl From<SV5_EN_A> for bool {
    ...
    fn from(variant: SV5_EN_A) -> Self {
        match variant {
            SV5_EN_A::SV5_EN_0 => false,
            SV5_EN_A::SV5_EN_1 => true,
        }
    }
}
...
impl From<LPSVI_EN_A> for bool {
    ...
    fn from(variant: LPSVI_EN_A) -> Self {
        match variant {
            LPSVI_EN_A::LPSVI_EN_0 => false,
            LPSVI_EN_A::LPSVI_EN_1 => true,
        }
    }
}
