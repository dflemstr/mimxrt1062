...
impl From<SRTC_ENV_A> for bool {
    ...
    fn from(variant: SRTC_ENV_A) -> Self {
        match variant {
            SRTC_ENV_A::SRTC_ENV_0 => false,
            SRTC_ENV_A::SRTC_ENV_1 => true,
        }
    }
}
...
impl From<LPTA_EN_A> for bool {
    ...
    fn from(variant: LPTA_EN_A) -> Self {
        match variant {
            LPTA_EN_A::LPTA_EN_0 => false,
            LPTA_EN_A::LPTA_EN_1 => true,
        }
    }
}
...
impl From<MC_ENV_A> for bool {
    ...
    fn from(variant: MC_ENV_A) -> Self {
        match variant {
            MC_ENV_A::MC_ENV_0 => false,
            MC_ENV_A::MC_ENV_1 => true,
        }
    }
}
...
impl From<SRTC_INV_EN_A> for bool {
    ...
    fn from(variant: SRTC_INV_EN_A) -> Self {
        match variant {
            SRTC_INV_EN_A::SRTC_INV_EN_0 => false,
            SRTC_INV_EN_A::SRTC_INV_EN_1 => true,
        }
    }
}
...
impl From<DP_EN_A> for bool {
    ...
    fn from(variant: DP_EN_A) -> Self {
        match variant {
            DP_EN_A::DP_EN_0 => false,
            DP_EN_A::DP_EN_1 => true,
        }
    }
}
...
impl From<LPCALB_EN_A> for bool {
    ...
    fn from(variant: LPCALB_EN_A) -> Self {
        match variant {
            LPCALB_EN_A::LPCALB_EN_0 => false,
            LPCALB_EN_A::LPCALB_EN_1 => true,
        }
    }
}
...
impl From<LPCALB_VAL_A> for u8 {
    ...
    fn from(variant: LPCALB_VAL_A) -> Self {
        match variant {
            LPCALB_VAL_A::LPCALB_VAL_0 => 0,
            LPCALB_VAL_A::LPCALB_VAL_1 => 1,
            LPCALB_VAL_A::LPCALB_VAL_2 => 2,
            LPCALB_VAL_A::LPCALB_VAL_15 => 15,
            LPCALB_VAL_A::LPCALB_VAL_16 => 16,
            LPCALB_VAL_A::LPCALB_VAL_17 => 17,
            LPCALB_VAL_A::LPCALB_VAL_30 => 30,
            LPCALB_VAL_A::LPCALB_VAL_31 => 31,
        }
    }
}
