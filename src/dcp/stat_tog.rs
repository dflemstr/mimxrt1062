#[doc = "Reader of register STAT_TOG"]
pub type R = crate::R<u32, super::STAT_TOG>;
#[doc = "Writer for register STAT_TOG"]
pub type W = crate::W<u32, super::STAT_TOG>;
#[doc = "Register STAT_TOG `reset()`'s with value 0x1000_0000"]
impl crate::ResetValue for super::STAT_TOG {
    type Type = u32;
    #[inline(always)]
...
impl From<READY_CHANNELS_A> for u8 {
    ...
    fn from(variant: READY_CHANNELS_A) -> Self {
        match variant {
            READY_CHANNELS_A::CH0 => 1,
            READY_CHANNELS_A::CH1 => 2,
            READY_CHANNELS_A::CH2 => 4,
            READY_CHANNELS_A::CH3 => 8,
        }
    }
}
