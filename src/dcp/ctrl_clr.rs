...
#[doc = "Register CTRL_CLR `reset()`'s with value 0xf080_0000"]
...
impl From<CHANNEL_INTERRUPT_ENABLE_A> for u8 {
    ...
    fn from(variant: CHANNEL_INTERRUPT_ENABLE_A) -> Self {
        match variant {
            CHANNEL_INTERRUPT_ENABLE_A::CH0 => 1,
            CHANNEL_INTERRUPT_ENABLE_A::CH1 => 2,
            CHANNEL_INTERRUPT_ENABLE_A::CH2 => 4,
            CHANNEL_INTERRUPT_ENABLE_A::CH3 => 8,
        }
    }
}
...
impl From<PRESENT_SHA_A> for bool {
    ...
    fn from(variant: PRESENT_SHA_A) -> Self {
        match variant {
            PRESENT_SHA_A::ABSENT => false,
            PRESENT_SHA_A::PRESENT => true,
        }
    }
}
...
impl From<PRESENT_CRYPTO_A> for bool {
    ...
    fn from(variant: PRESENT_CRYPTO_A) -> Self {
        match variant {
            PRESENT_CRYPTO_A::ABSENT => false,
            PRESENT_CRYPTO_A::PRESENT => true,
        }
    }
}
