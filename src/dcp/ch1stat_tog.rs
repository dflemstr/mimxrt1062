#[doc = "Reader of register CH1STAT_TOG"]
pub type R = crate::R<u32, super::CH1STAT_TOG>;
#[doc = "Writer for register CH1STAT_TOG"]
pub type W = crate::W<u32, super::CH1STAT_TOG>;
#[doc = "Register CH1STAT_TOG `reset()`'s with value 0"]
impl crate::ResetValue for super::CH1STAT_TOG {
    type Type = u32;
    #[inline(always)]
...
pub enum ERROR_CODE_A {
    ...
    NO_CHAIN,
    #[doc = "3: Error is signalled because an error was reported when reading/writing the context buffer."]
    CONTEXT_ERROR,
    #[doc = "4: Error is signalled because an error was reported when reading/writing the payload."]
    PAYLOAD_ERROR,
...
impl From<ERROR_CODE_A> for u8 {
    ...
    fn from(variant: ERROR_CODE_A) -> Self {
        match variant {
            ERROR_CODE_A::NEXT_CHAIN_IS_0 => 1,
            ERROR_CODE_A::NO_CHAIN => 2,
            ERROR_CODE_A::CONTEXT_ERROR => 3,
            ERROR_CODE_A::PAYLOAD_ERROR => 4,
            ERROR_CODE_A::INVALID_MODE => 5,
        }
    }
}
