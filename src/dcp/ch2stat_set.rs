#[doc = "Reader of register CH2STAT_SET"]
pub type R = crate::R<u32, super::CH2STAT_SET>;
#[doc = "Writer for register CH2STAT_SET"]
pub type W = crate::W<u32, super::CH2STAT_SET>;
#[doc = "Register CH2STAT_SET `reset()`'s with value 0"]
impl crate::ResetValue for super::CH2STAT_SET {
    type Type = u32;
    #[inline(always)]
...
pub enum ERROR_CODE_A {
    ...
    PAYLOAD_ERROR,
    #[doc = "5: Error is signalled because the control packet specifies an invalid mode select (for instance, blit + hash)."]
    INVALID_MODE,
}
