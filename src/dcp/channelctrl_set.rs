#[doc = "Reader of register CHANNELCTRL_SET"]
pub type R = crate::R<u32, super::CHANNELCTRL_SET>;
#[doc = "Writer for register CHANNELCTRL_SET"]
pub type W = crate::W<u32, super::CHANNELCTRL_SET>;
#[doc = "Register CHANNELCTRL_SET `reset()`'s with value 0"]
impl crate::ResetValue for super::CHANNELCTRL_SET {
    type Type = u32;
    #[inline(always)]
...
impl From<ENABLE_CHANNEL_A> for u8 {
    ...
    fn from(variant: ENABLE_CHANNEL_A) -> Self {
        match variant {
            ENABLE_CHANNEL_A::CH0 => 1,
            ENABLE_CHANNEL_A::CH1 => 2,
            ENABLE_CHANNEL_A::CH2 => 4,
            ENABLE_CHANNEL_A::CH3 => 8,
        }
    }
}
...
impl From<HIGH_PRIORITY_CHANNEL_A> for u8 {
    ...
    fn from(variant: HIGH_PRIORITY_CHANNEL_A) -> Self {
        match variant {
            HIGH_PRIORITY_CHANNEL_A::CH0 => 1,
            HIGH_PRIORITY_CHANNEL_A::CH1 => 2,
            HIGH_PRIORITY_CHANNEL_A::CH2 => 4,
            HIGH_PRIORITY_CHANNEL_A::CH3 => 8,
        }
    }
}
