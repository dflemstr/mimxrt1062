...
impl From<MIB_CLEAR_A> for bool {
    ...
    fn from(variant: MIB_CLEAR_A) -> Self {
        match variant {
            MIB_CLEAR_A::MIB_CLEAR_0 => false,
            MIB_CLEAR_A::MIB_CLEAR_1 => true,
        }
    }
}
...
impl From<MIB_IDLE_A> for bool {
    ...
    fn from(variant: MIB_IDLE_A) -> Self {
        match variant {
            MIB_IDLE_A::MIB_IDLE_0 => false,
            MIB_IDLE_A::MIB_IDLE_1 => true,
        }
    }
}
...
impl From<MIB_DIS_A> for bool {
    ...
    fn from(variant: MIB_DIS_A) -> Self {
        match variant {
            MIB_DIS_A::MIB_DIS_0 => false,
            MIB_DIS_A::MIB_DIS_1 => true,
        }
    }
}
