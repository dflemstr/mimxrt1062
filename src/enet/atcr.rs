...
impl From<OFFEN_A> for bool {
    ...
    fn from(variant: OFFEN_A) -> Self {
        match variant {
            OFFEN_A::OFFEN_0 => false,
            OFFEN_A::OFFEN_1 => true,
        }
    }
}
...
impl From<OFFRST_A> for bool {
    ...
    fn from(variant: OFFRST_A) -> Self {
        match variant {
            OFFRST_A::OFFRST_0 => false,
            OFFRST_A::OFFRST_1 => true,
        }
    }
}
...
impl From<PEREN_A> for bool {
    ...
    fn from(variant: PEREN_A) -> Self {
        match variant {
            PEREN_A::PEREN_0 => false,
            PEREN_A::PEREN_1 => true,
        }
    }
}
...
impl From<PINPER_A> for bool {
    ...
    fn from(variant: PINPER_A) -> Self {
        match variant {
            PINPER_A::PINPER_0 => false,
            PINPER_A::PINPER_1 => true,
        }
    }
}
...
impl From<CAPTURE_A> for bool {
    ...
    fn from(variant: CAPTURE_A) -> Self {
        match variant {
            CAPTURE_A::CAPTURE_0 => false,
            CAPTURE_A::CAPTURE_1 => true,
        }
    }
}
...
impl From<SLAVE_A> for bool {
    ...
    fn from(variant: SLAVE_A) -> Self {
        match variant {
            SLAVE_A::SLAVE_0 => false,
            SLAVE_A::SLAVE_1 => true,
        }
    }
}
