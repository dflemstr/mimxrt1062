...
impl From<PADREM_A> for bool {
    ...
    fn from(variant: PADREM_A) -> Self {
        match variant {
            PADREM_A::PADREM_0 => false,
            PADREM_A::PADREM_1 => true,
        }
    }
}
...
impl From<IPDIS_A> for bool {
    ...
    fn from(variant: IPDIS_A) -> Self {
        match variant {
            IPDIS_A::IPDIS_0 => false,
            IPDIS_A::IPDIS_1 => true,
        }
    }
}
...
impl From<PRODIS_A> for bool {
    ...
    fn from(variant: PRODIS_A) -> Self {
        match variant {
            PRODIS_A::PRODIS_0 => false,
            PRODIS_A::PRODIS_1 => true,
        }
    }
}
...
impl From<LINEDIS_A> for bool {
    ...
    fn from(variant: LINEDIS_A) -> Self {
        match variant {
            LINEDIS_A::LINEDIS_0 => false,
            LINEDIS_A::LINEDIS_1 => true,
        }
    }
}
...
impl From<SHIFT16_A> for bool {
    ...
    fn from(variant: SHIFT16_A) -> Self {
        match variant {
            SHIFT16_A::SHIFT16_0 => false,
            SHIFT16_A::SHIFT16_1 => true,
        }
    }
}
