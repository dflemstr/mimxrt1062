...
impl From<RMII_MODE_A> for bool {
    ...
    fn from(variant: RMII_MODE_A) -> Self {
        match variant {
            RMII_MODE_A::RMII_MODE_0 => false,
            RMII_MODE_A::RMII_MODE_1 => true,
        }
    }
}
...
impl From<RMII_10T_A> for bool {
    ...
    fn from(variant: RMII_10T_A) -> Self {
        match variant {
            RMII_10T_A::RMII_10T_0 => false,
            RMII_10T_A::RMII_10T_1 => true,
        }
    }
}
...
impl From<PADEN_A> for bool {
    ...
    fn from(variant: PADEN_A) -> Self {
        match variant {
            PADEN_A::PADEN_0 => false,
            PADEN_A::PADEN_1 => true,
        }
    }
}
...
impl From<PAUFWD_A> for bool {
    ...
    fn from(variant: PAUFWD_A) -> Self {
        match variant {
            PAUFWD_A::PAUFWD_0 => false,
            PAUFWD_A::PAUFWD_1 => true,
        }
    }
}
...
impl From<CRCFWD_A> for bool {
    ...
    fn from(variant: CRCFWD_A) -> Self {
        match variant {
            CRCFWD_A::CRCFWD_0 => false,
            CRCFWD_A::CRCFWD_1 => true,
        }
    }
}
...
pub enum NLC_A {
    ...
    NLC_0,
    #[doc = "1: The core checks the frame's payload length with the frame length/type field. Errors are indicated in the EIR\\[PLR\\] field."]
    NLC_1,
}
