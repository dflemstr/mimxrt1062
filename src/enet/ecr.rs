...
impl From<ETHEREN_A> for bool {
    ...
    fn from(variant: ETHEREN_A) -> Self {
        match variant {
            ETHEREN_A::ETHEREN_0 => false,
            ETHEREN_A::ETHEREN_1 => true,
        }
    }
}
...
impl From<MAGICEN_A> for bool {
    ...
    fn from(variant: MAGICEN_A) -> Self {
        match variant {
            MAGICEN_A::MAGICEN_0 => false,
            MAGICEN_A::MAGICEN_1 => true,
        }
    }
}
...
impl From<SLEEP_A> for bool {
    ...
    fn from(variant: SLEEP_A) -> Self {
        match variant {
            SLEEP_A::SLEEP_0 => false,
            SLEEP_A::SLEEP_1 => true,
        }
    }
}
...
impl From<EN1588_A> for bool {
    ...
    fn from(variant: EN1588_A) -> Self {
        match variant {
            EN1588_A::EN1588_0 => false,
            EN1588_A::EN1588_1 => true,
        }
    }
}
...
impl From<DBSWP_A> for bool {
    ...
    fn from(variant: DBSWP_A) -> Self {
        match variant {
            DBSWP_A::DBSWP_0 => false,
            DBSWP_A::DBSWP_1 => true,
        }
    }
}
