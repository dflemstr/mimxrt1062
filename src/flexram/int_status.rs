...
impl From<ITCM_ERR_STATUS_A> for bool {
    ...
    fn from(variant: ITCM_ERR_STATUS_A) -> Self {
        match variant {
            ITCM_ERR_STATUS_A::ITCM_ERR_STATUS_0 => false,
            ITCM_ERR_STATUS_A::ITCM_ERR_STATUS_1 => true,
        }
    }
}
...
impl From<DTCM_ERR_STATUS_A> for bool {
    ...
    fn from(variant: DTCM_ERR_STATUS_A) -> Self {
        match variant {
            DTCM_ERR_STATUS_A::DTCM_ERR_STATUS_0 => false,
            DTCM_ERR_STATUS_A::DTCM_ERR_STATUS_1 => true,
        }
    }
}
...
impl From<OCRAM_ERR_STATUS_A> for bool {
    ...
    fn from(variant: OCRAM_ERR_STATUS_A) -> Self {
        match variant {
            OCRAM_ERR_STATUS_A::OCRAM_ERR_STATUS_0 => false,
            OCRAM_ERR_STATUS_A::OCRAM_ERR_STATUS_1 => true,
        }
    }
}
