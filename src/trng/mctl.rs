...
impl From<SAMP_MODE_A> for u8 {
    ...
    fn from(variant: SAMP_MODE_A) -> Self {
        match variant {
            SAMP_MODE_A::SAMP_MODE_0 => 0,
            SAMP_MODE_A::SAMP_MODE_1 => 1,
            SAMP_MODE_A::SAMP_MODE_2 => 2,
            SAMP_MODE_A::SAMP_MODE_3 => 3,
        }
    }
}
...
impl From<OSC_DIV_A> for u8 {
    ...
    fn from(variant: OSC_DIV_A) -> Self {
        match variant {
            OSC_DIV_A::OSC_DIV_0 => 0,
            OSC_DIV_A::OSC_DIV_1 => 1,
            OSC_DIV_A::OSC_DIV_2 => 2,
            OSC_DIV_A::OSC_DIV_3 => 3,
        }
    }
}
