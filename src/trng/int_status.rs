...
impl From<HW_ERR_A> for bool {
    ...
    fn from(variant: HW_ERR_A) -> Self {
        match variant {
            HW_ERR_A::HW_ERR_0 => false,
            HW_ERR_A::HW_ERR_1 => true,
        }
    }
}
...
impl From<ENT_VAL_A> for bool {
    ...
    fn from(variant: ENT_VAL_A) -> Self {
        match variant {
            ENT_VAL_A::ENT_VAL_0 => false,
            ENT_VAL_A::ENT_VAL_1 => true,
        }
    }
}
...
impl From<FRQ_CT_FAIL_A> for bool {
    ...
    fn from(variant: FRQ_CT_FAIL_A) -> Self {
        match variant {
            FRQ_CT_FAIL_A::FRQ_CT_FAIL_0 => false,
            FRQ_CT_FAIL_A::FRQ_CT_FAIL_1 => true,
        }
    }
}
