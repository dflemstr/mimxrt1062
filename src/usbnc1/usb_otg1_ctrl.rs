...
impl From<OVER_CUR_DIS_A> for bool {
    ...
    fn from(variant: OVER_CUR_DIS_A) -> Self {
        match variant {
            OVER_CUR_DIS_A::OVER_CUR_DIS_0 => false,
            OVER_CUR_DIS_A::OVER_CUR_DIS_1 => true,
        }
    }
}
...
impl From<OVER_CUR_POL_A> for bool {
    ...
    fn from(variant: OVER_CUR_POL_A) -> Self {
        match variant {
            OVER_CUR_POL_A::OVER_CUR_POL_0 => false,
            OVER_CUR_POL_A::OVER_CUR_POL_1 => true,
        }
    }
}
...
impl From<PWR_POL_A> for bool {
    ...
    fn from(variant: PWR_POL_A) -> Self {
        match variant {
            PWR_POL_A::PWR_POL_0 => false,
            PWR_POL_A::PWR_POL_1 => true,
        }
    }
}
...
impl From<WKUP_SW_EN_A> for bool {
    ...
    fn from(variant: WKUP_SW_EN_A) -> Self {
        match variant {
            WKUP_SW_EN_A::WKUP_SW_EN_0 => false,
            WKUP_SW_EN_A::WKUP_SW_EN_1 => true,
        }
    }
}
...
impl From<WKUP_SW_A> for bool {
    ...
    fn from(variant: WKUP_SW_A) -> Self {
        match variant {
            WKUP_SW_A::WKUP_SW_0 => false,
            WKUP_SW_A::WKUP_SW_1 => true,
        }
    }
}
...
impl From<WKUP_ID_EN_A> for bool {
    ...
    fn from(variant: WKUP_ID_EN_A) -> Self {
        match variant {
            WKUP_ID_EN_A::WKUP_ID_EN_0 => false,
            WKUP_ID_EN_A::WKUP_ID_EN_1 => true,
        }
    }
}
...
impl From<WKUP_VBUS_EN_A> for bool {
    ...
    fn from(variant: WKUP_VBUS_EN_A) -> Self {
        match variant {
            WKUP_VBUS_EN_A::WKUP_VBUS_EN_0 => false,
            WKUP_VBUS_EN_A::WKUP_VBUS_EN_1 => true,
        }
    }
}
...
impl From<WKUP_DPDM_EN_A> for bool {
    ...
    fn from(variant: WKUP_DPDM_EN_A) -> Self {
        match variant {
            WKUP_DPDM_EN_A::WKUP_DPDM_EN_0 => false,
            WKUP_DPDM_EN_A::WKUP_DPDM_EN_1 => true,
        }
    }
}
