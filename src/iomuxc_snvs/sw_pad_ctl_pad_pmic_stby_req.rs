#[doc = "Reader of register SW_PAD_CTL_PAD_PMIC_STBY_REQ"]
pub type R = crate::R<u32, super::SW_PAD_CTL_PAD_PMIC_STBY_REQ>;
#[doc = "Writer for register SW_PAD_CTL_PAD_PMIC_STBY_REQ"]
pub type W = crate::W<u32, super::SW_PAD_CTL_PAD_PMIC_STBY_REQ>;
#[doc = "Register SW_PAD_CTL_PAD_PMIC_STBY_REQ `reset()`'s with value 0xa0a0"]
impl crate::ResetValue for super::SW_PAD_CTL_PAD_PMIC_STBY_REQ {
    type Type = u32;
    #[inline(always)]
...
pub enum DSE_A {
    ...
    #[doc = "1: R0(260 Ohm @ 3.3V, 150 Ohm@1.8V, 240 Ohm for DDR)"]
...
impl From<DSE_A> for u8 {
    ...
    fn from(variant: DSE_A) -> Self {
        match variant {
            ...
            DSE_A::DSE_1_R0_260_OHM___3_3V__150_OHM_1_8V__240_OHM_FOR_DDR_ => 1,
            DSE_A::DSE_2_R0_2 => 2,
            DSE_A::DSE_3_R0_3 => 3,
            DSE_A::DSE_4_R0_4 => 4,
            DSE_A::DSE_5_R0_5 => 5,
...
impl DSE_R {
    ...
    pub fn variant(&self) -> DSE_A {
        match self.bits {
            ...
            1 => DSE_A::DSE_1_R0_260_OHM___3_3V__150_OHM_1_8V__240_OHM_FOR_DDR_,
            2 => DSE_A::DSE_2_R0_2,
            3 => DSE_A::DSE_3_R0_3,
            4 => DSE_A::DSE_4_R0_4,
            5 => DSE_A::DSE_5_R0_5,
    ...
    pub fn is_dse_1_r0_260_ohm___3_3v__150_ohm_1_8v__240_ohm_for_ddr_(&self) -> bool {
        *self == DSE_A::DSE_1_R0_260_OHM___3_3V__150_OHM_1_8V__240_OHM_FOR_DDR_
    }
...
impl<'a> DSE_W<'a> {
    ...
    pub fn dse_1_r0_260_ohm___3_3v__150_ohm_1_8v__240_ohm_for_ddr_(self) -> &'a mut W {
        self.variant(DSE_A::DSE_1_R0_260_OHM___3_3V__150_OHM_1_8V__240_OHM_FOR_DDR_)
    }
    #[doc = "R0/2"]
    #[inline(always)]
