#[doc = "Reader of register SW_MUX_CTL_PAD_WAKEUP"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_WAKEUP>;
#[doc = "Writer for register SW_MUX_CTL_PAD_WAKEUP"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_WAKEUP>;
#[doc = "Register SW_MUX_CTL_PAD_WAKEUP `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_WAKEUP {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO5_IO00 of instance: gpio5"]
    ALT5,
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad WAKEUP"]
    ENABLED,
}
