#[doc = "Reader of register SW_MUX_CTL_PAD_PMIC_STBY_REQ"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_PMIC_STBY_REQ>;
#[doc = "Writer for register SW_MUX_CTL_PAD_PMIC_STBY_REQ"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_PMIC_STBY_REQ>;
#[doc = "Register SW_MUX_CTL_PAD_PMIC_STBY_REQ `reset()`'s with value 0"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_PMIC_STBY_REQ {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: CCM_PMIC_VSTBY_REQ of instance: ccm"]
    ALT0,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO5_IO02 of instance: gpio5"]
    ALT5,
}
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad PMIC_STBY_REQ"]
    ENABLED,
}
