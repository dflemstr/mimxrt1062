#[doc = "Reader of register SDER"]
pub type R = crate::R<u32, super::SDER>;
#[doc = "Writer for register SDER"]
pub type W = crate::W<u32, super::SDER>;
#[doc = "Register SDER `reset()`'s with value 0"]
impl crate::ResetValue for super::SDER {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `AVDE`"]
pub type AVDE_R = crate::R<bool, AVDE_A>;
impl AVDE_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
#[doc = "Write proxy for field `AVDE`"]
pub struct AVDE_W<'a> {
    w: &'a mut W,
}
impl<'a> AVDE_W<'a> {
