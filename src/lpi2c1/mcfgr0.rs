#[doc = "Reader of register MCFGR0"]
pub type R = crate::R<u32, super::MCFGR0>;
#[doc = "Writer for register MCFGR0"]
pub type W = crate::W<u32, super::MCFGR0>;
#[doc = "Register MCFGR0 `reset()`'s with value 0"]
impl crate::ResetValue for super::MCFGR0 {
    type Type = u32;
    #[inline(always)]
...
impl From<HRPOL_A> for bool {
    ...
    fn from(variant: HRPOL_A) -> Self {
        match variant {
            HRPOL_A::HRPOL_0 => false,
            HRPOL_A::HRPOL_1 => true,
        }
    }
}
...
impl From<HRSEL_A> for bool {
    ...
    fn from(variant: HRSEL_A) -> Self {
        match variant {
            HRSEL_A::HRSEL_0 => false,
            HRSEL_A::HRSEL_1 => true,
        }
    }
}
...
impl From<CIRFIFO_A> for bool {
    ...
    fn from(variant: CIRFIFO_A) -> Self {
        match variant {
            CIRFIFO_A::CIRFIFO_0 => false,
            CIRFIFO_A::CIRFIFO_1 => true,
        }
    }
}
