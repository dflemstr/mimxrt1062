#[doc = "Reader of register BR8"]
pub type R = crate::R<u32, super::BR8>;
#[doc = "Writer for register BR8"]
pub type W = crate::W<u32, super::BR8>;
#[doc = "Register BR8 `reset()`'s with value 0x26"]
impl crate::ResetValue for super::BR8 {
    type Type = u32;
    #[inline(always)]
