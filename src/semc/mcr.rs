...
impl From<DQSMD_A> for bool {
    ...
    fn from(variant: DQSMD_A) -> Self {
        match variant {
            DQSMD_A::DQSMD_0 => false,
            DQSMD_A::DQSMD_1 => true,
        }
    }
}
...
impl From<WPOL0_A> for bool {
    ...
    fn from(variant: WPOL0_A) -> Self {
        match variant {
            WPOL0_A::WPOL0_0 => false,
            WPOL0_A::WPOL0_1 => true,
        }
    }
}
...
impl From<WPOL1_A> for bool {
    ...
    fn from(variant: WPOL1_A) -> Self {
        match variant {
            WPOL1_A::WPOL1_0 => false,
            WPOL1_A::WPOL1_1 => true,
        }
    }
}
...
impl From<DQSSEL_A> for bool {
    ...
    fn from(variant: DQSSEL_A) -> Self {
        match variant {
            DQSSEL_A::DQSSEL_0 => false,
            DQSSEL_A::DQSSEL_1 => true,
        }
    }
}
...
impl From<DLLSEL_A> for bool {
    ...
    fn from(variant: DLLSEL_A) -> Self {
        match variant {
            DLLSEL_A::DLLSEL_0 => false,
            DLLSEL_A::DLLSEL_1 => true,
        }
    }
}
