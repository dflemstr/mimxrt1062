#[doc = "Reader of register NORCR0"]
pub type R = crate::R<u32, super::NORCR0>;
#[doc = "Writer for register NORCR0"]
pub type W = crate::W<u32, super::NORCR0>;
#[doc = "Register NORCR0 `reset()`'s with value 0"]
impl crate::ResetValue for super::NORCR0 {
    type Type = u32;
    #[inline(always)]
...
impl From<SYNCEN_A> for bool {
    ...
    fn from(variant: SYNCEN_A) -> Self {
        match variant {
            SYNCEN_A::SYNCEN_0 => false,
            SYNCEN_A::SYNCEN_1 => true,
        }
    }
}
...
impl R {
    ...
    #[doc = "Bit 1 - Select NOR controller mode."]
    #[inline(always)]
