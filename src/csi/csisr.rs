...
impl From<ECC_INT_A> for bool {
    ...
    fn from(variant: ECC_INT_A) -> Self {
        match variant {
            ECC_INT_A::ECC_INT_0 => false,
            ECC_INT_A::ECC_INT_1 => true,
        }
    }
}
...
impl From<HRESP_ERR_INT_A> for bool {
    ...
    fn from(variant: HRESP_ERR_INT_A) -> Self {
        match variant {
            HRESP_ERR_INT_A::HRESP_ERR_INT_0 => false,
            HRESP_ERR_INT_A::HRESP_ERR_INT_1 => true,
        }
    }
}
...
impl From<COF_INT_A> for bool {
    ...
    fn from(variant: COF_INT_A) -> Self {
        match variant {
            COF_INT_A::COF_INT_0 => false,
            COF_INT_A::COF_INT_1 => true,
        }
    }
}
...
impl From<F1_INT_A> for bool {
    ...
    fn from(variant: F1_INT_A) -> Self {
        match variant {
            F1_INT_A::F1_INT_0 => false,
            F1_INT_A::F1_INT_1 => true,
        }
    }
}
...
impl From<F2_INT_A> for bool {
    ...
    fn from(variant: F2_INT_A) -> Self {
        match variant {
            F2_INT_A::F2_INT_0 => false,
            F2_INT_A::F2_INT_1 => true,
        }
    }
}
...
impl From<SOF_INT_A> for bool {
    ...
    fn from(variant: SOF_INT_A) -> Self {
        match variant {
            SOF_INT_A::SOF_INT_0 => false,
            SOF_INT_A::SOF_INT_1 => true,
        }
    }
}
...
impl From<EOF_INT_A> for bool {
    ...
    fn from(variant: EOF_INT_A) -> Self {
        match variant {
            EOF_INT_A::EOF_INT_0 => false,
            EOF_INT_A::EOF_INT_1 => true,
        }
    }
}
...
impl From<RXFF_INT_A> for bool {
    ...
    fn from(variant: RXFF_INT_A) -> Self {
        match variant {
            RXFF_INT_A::RXFF_INT_0 => false,
            RXFF_INT_A::RXFF_INT_1 => true,
        }
    }
}
...
impl From<DMA_TSF_DONE_FB1_A> for bool {
    ...
    fn from(variant: DMA_TSF_DONE_FB1_A) -> Self {
        match variant {
            DMA_TSF_DONE_FB1_A::DMA_TSF_DONE_FB1_0 => false,
            DMA_TSF_DONE_FB1_A::DMA_TSF_DONE_FB1_1 => true,
        }
    }
}
...
impl From<DMA_TSF_DONE_FB2_A> for bool {
    ...
    fn from(variant: DMA_TSF_DONE_FB2_A) -> Self {
        match variant {
            DMA_TSF_DONE_FB2_A::DMA_TSF_DONE_FB2_0 => false,
            DMA_TSF_DONE_FB2_A::DMA_TSF_DONE_FB2_1 => true,
        }
    }
}
...
impl From<STATFF_INT_A> for bool {
    ...
    fn from(variant: STATFF_INT_A) -> Self {
        match variant {
            STATFF_INT_A::STATFF_INT_0 => false,
            STATFF_INT_A::STATFF_INT_1 => true,
        }
    }
}
...
impl From<DMA_TSF_DONE_SFF_A> for bool {
    ...
    fn from(variant: DMA_TSF_DONE_SFF_A) -> Self {
        match variant {
            DMA_TSF_DONE_SFF_A::DMA_TSF_DONE_SFF_0 => false,
            DMA_TSF_DONE_SFF_A::DMA_TSF_DONE_SFF_1 => true,
        }
    }
}
...
impl From<RF_OR_INT_A> for bool {
    ...
    fn from(variant: RF_OR_INT_A) -> Self {
        match variant {
            RF_OR_INT_A::RF_OR_INT_0 => false,
            RF_OR_INT_A::RF_OR_INT_1 => true,
        }
    }
}
...
impl From<SF_OR_INT_A> for bool {
    ...
    fn from(variant: SF_OR_INT_A) -> Self {
        match variant {
            SF_OR_INT_A::SF_OR_INT_0 => false,
            SF_OR_INT_A::SF_OR_INT_1 => true,
        }
    }
}
