...
impl From<PIXEL_BIT_A> for bool {
    ...
    fn from(variant: PIXEL_BIT_A) -> Self {
        match variant {
            PIXEL_BIT_A::PIXEL_BIT_0 => false,
            PIXEL_BIT_A::PIXEL_BIT_1 => true,
        }
    }
}
...
impl From<REDGE_A> for bool {
    ...
    fn from(variant: REDGE_A) -> Self {
        match variant {
            REDGE_A::REDGE_0 => false,
            REDGE_A::REDGE_1 => true,
        }
    }
}
...
impl From<INV_PCLK_A> for bool {
    ...
    fn from(variant: INV_PCLK_A) -> Self {
        match variant {
            INV_PCLK_A::INV_PCLK_0 => false,
            INV_PCLK_A::INV_PCLK_1 => true,
        }
    }
}
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum INV_DATA_A {
    #[doc = "0: CSI_D\\[7:0\\] data lines are directly applied to internal circuitry"]
    INV_DATA_0,
    #[doc = "1: CSI_D\\[7:0\\] data lines are inverted before applied to internal circuitry"]
    INV_DATA_1,
}
impl From<INV_DATA_A> for bool {
    ...
    fn from(variant: INV_DATA_A) -> Self {
        match variant {
            INV_DATA_A::INV_DATA_0 => false,
            INV_DATA_A::INV_DATA_1 => true,
        }
    }
}
...
impl From<GCLK_MODE_A> for bool {
    ...
    fn from(variant: GCLK_MODE_A) -> Self {
        match variant {
            GCLK_MODE_A::GCLK_MODE_0 => false,
            GCLK_MODE_A::GCLK_MODE_1 => true,
        }
    }
}
...
impl From<PACK_DIR_A> for bool {
    ...
    fn from(variant: PACK_DIR_A) -> Self {
        match variant {
            PACK_DIR_A::PACK_DIR_0 => false,
            PACK_DIR_A::PACK_DIR_1 => true,
        }
    }
}
...
impl From<CCIR_EN_A> for bool {
    ...
    fn from(variant: CCIR_EN_A) -> Self {
        match variant {
            CCIR_EN_A::CCIR_EN_0 => false,
            CCIR_EN_A::CCIR_EN_1 => true,
        }
    }
}
...
impl From<HSYNC_POL_A> for bool {
    ...
    fn from(variant: HSYNC_POL_A) -> Self {
        match variant {
            HSYNC_POL_A::HSYNC_POL_0 => false,
            HSYNC_POL_A::HSYNC_POL_1 => true,
        }
    }
}
...
impl From<SOF_INTEN_A> for bool {
    ...
    fn from(variant: SOF_INTEN_A) -> Self {
        match variant {
            SOF_INTEN_A::SOF_INTEN_0 => false,
            SOF_INTEN_A::SOF_INTEN_1 => true,
        }
    }
}
...
impl From<SOF_POL_A> for bool {
    ...
    fn from(variant: SOF_POL_A) -> Self {
        match variant {
            SOF_POL_A::SOF_POL_0 => false,
            SOF_POL_A::SOF_POL_1 => true,
        }
    }
}
...
impl From<RXFF_INTEN_A> for bool {
    ...
    fn from(variant: RXFF_INTEN_A) -> Self {
        match variant {
            RXFF_INTEN_A::RXFF_INTEN_0 => false,
            RXFF_INTEN_A::RXFF_INTEN_1 => true,
        }
    }
}
...
impl From<FB1_DMA_DONE_INTEN_A> for bool {
    ...
    fn from(variant: FB1_DMA_DONE_INTEN_A) -> Self {
        match variant {
            FB1_DMA_DONE_INTEN_A::FB1_DMA_DONE_INTEN_0 => false,
            FB1_DMA_DONE_INTEN_A::FB1_DMA_DONE_INTEN_1 => true,
        }
    }
}
...
impl From<FB2_DMA_DONE_INTEN_A> for bool {
    ...
    fn from(variant: FB2_DMA_DONE_INTEN_A) -> Self {
        match variant {
            FB2_DMA_DONE_INTEN_A::FB2_DMA_DONE_INTEN_0 => false,
            FB2_DMA_DONE_INTEN_A::FB2_DMA_DONE_INTEN_1 => true,
        }
    }
}
...
impl From<STATFF_INTEN_A> for bool {
    ...
    fn from(variant: STATFF_INTEN_A) -> Self {
        match variant {
            STATFF_INTEN_A::STATFF_INTEN_0 => false,
            STATFF_INTEN_A::STATFF_INTEN_1 => true,
        }
    }
}
...
impl From<SFF_DMA_DONE_INTEN_A> for bool {
    ...
    fn from(variant: SFF_DMA_DONE_INTEN_A) -> Self {
        match variant {
            SFF_DMA_DONE_INTEN_A::SFF_DMA_DONE_INTEN_0 => false,
            SFF_DMA_DONE_INTEN_A::SFF_DMA_DONE_INTEN_1 => true,
        }
    }
}
...
impl From<RF_OR_INTEN_A> for bool {
    ...
    fn from(variant: RF_OR_INTEN_A) -> Self {
        match variant {
            RF_OR_INTEN_A::RF_OR_INTEN_0 => false,
            RF_OR_INTEN_A::RF_OR_INTEN_1 => true,
        }
    }
}
...
impl From<SF_OR_INTEN_A> for bool {
    ...
    fn from(variant: SF_OR_INTEN_A) -> Self {
        match variant {
            SF_OR_INTEN_A::SF_OR_INTEN_0 => false,
            SF_OR_INTEN_A::SF_OR_INTEN_1 => true,
        }
    }
}
...
impl From<COF_INT_EN_A> for bool {
    ...
    fn from(variant: COF_INT_EN_A) -> Self {
        match variant {
            COF_INT_EN_A::COF_INT_EN_0 => false,
            COF_INT_EN_A::COF_INT_EN_1 => true,
        }
    }
}
...
impl From<CCIR_MODE_A> for bool {
    ...
    fn from(variant: CCIR_MODE_A) -> Self {
        match variant {
            CCIR_MODE_A::CCIR_MODE_0 => false,
            CCIR_MODE_A::CCIR_MODE_1 => true,
        }
    }
}
...
impl From<PRP_IF_EN_A> for bool {
    ...
    fn from(variant: PRP_IF_EN_A) -> Self {
        match variant {
            PRP_IF_EN_A::PRP_IF_EN_0 => false,
            PRP_IF_EN_A::PRP_IF_EN_1 => true,
        }
    }
}
...
impl From<EOF_INT_EN_A> for bool {
    ...
    fn from(variant: EOF_INT_EN_A) -> Self {
        match variant {
            EOF_INT_EN_A::EOF_INT_EN_0 => false,
            EOF_INT_EN_A::EOF_INT_EN_1 => true,
        }
    }
}
...
impl From<EXT_VSYNC_A> for bool {
    ...
    fn from(variant: EXT_VSYNC_A) -> Self {
        match variant {
            EXT_VSYNC_A::EXT_VSYNC_0 => false,
            EXT_VSYNC_A::EXT_VSYNC_1 => true,
        }
    }
}
...
impl From<SWAP16_EN_A> for bool {
    ...
    fn from(variant: SWAP16_EN_A) -> Self {
        match variant {
            SWAP16_EN_A::SWAP16_EN_0 => false,
            SWAP16_EN_A::SWAP16_EN_1 => true,
        }
    }
}
