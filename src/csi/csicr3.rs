...
impl From<ECC_AUTO_EN_A> for bool {
    ...
    fn from(variant: ECC_AUTO_EN_A) -> Self {
        match variant {
            ECC_AUTO_EN_A::ECC_AUTO_EN_0 => false,
            ECC_AUTO_EN_A::ECC_AUTO_EN_1 => true,
        }
    }
}
...
impl From<ECC_INT_EN_A> for bool {
    ...
    fn from(variant: ECC_INT_EN_A) -> Self {
        match variant {
            ECC_INT_EN_A::ECC_INT_EN_0 => false,
            ECC_INT_EN_A::ECC_INT_EN_1 => true,
        }
    }
}
...
impl From<ZERO_PACK_EN_A> for bool {
    ...
    fn from(variant: ZERO_PACK_EN_A) -> Self {
        match variant {
            ZERO_PACK_EN_A::ZERO_PACK_EN_0 => false,
            ZERO_PACK_EN_A::ZERO_PACK_EN_1 => true,
        }
    }
}
...
impl From<TWO_8BIT_SENSOR_A> for bool {
    ...
    fn from(variant: TWO_8BIT_SENSOR_A) -> Self {
        match variant {
            TWO_8BIT_SENSOR_A::TWO_8BIT_SENSOR_0 => false,
            TWO_8BIT_SENSOR_A::TWO_8BIT_SENSOR_1 => true,
        }
    }
}
...
impl From<RXFF_LEVEL_A> for u8 {
    ...
    fn from(variant: RXFF_LEVEL_A) -> Self {
        match variant {
            RXFF_LEVEL_A::RXFF_LEVEL_0 => 0,
            RXFF_LEVEL_A::RXFF_LEVEL_1 => 1,
            RXFF_LEVEL_A::RXFF_LEVEL_2 => 2,
            RXFF_LEVEL_A::RXFF_LEVEL_3 => 3,
            RXFF_LEVEL_A::RXFF_LEVEL_4 => 4,
            RXFF_LEVEL_A::RXFF_LEVEL_5 => 5,
            RXFF_LEVEL_A::RXFF_LEVEL_6 => 6,
            RXFF_LEVEL_A::RXFF_LEVEL_7 => 7,
        }
    }
}
...
impl From<HRESP_ERR_EN_A> for bool {
    ...
    fn from(variant: HRESP_ERR_EN_A) -> Self {
        match variant {
            HRESP_ERR_EN_A::HRESP_ERR_EN_0 => false,
            HRESP_ERR_EN_A::HRESP_ERR_EN_1 => true,
        }
    }
}
...
impl From<STATFF_LEVEL_A> for u8 {
    ...
    fn from(variant: STATFF_LEVEL_A) -> Self {
        match variant {
            STATFF_LEVEL_A::STATFF_LEVEL_0 => 0,
            STATFF_LEVEL_A::STATFF_LEVEL_1 => 1,
            STATFF_LEVEL_A::STATFF_LEVEL_2 => 2,
            STATFF_LEVEL_A::STATFF_LEVEL_3 => 3,
            STATFF_LEVEL_A::STATFF_LEVEL_4 => 4,
            STATFF_LEVEL_A::STATFF_LEVEL_5 => 5,
            STATFF_LEVEL_A::STATFF_LEVEL_6 => 6,
            STATFF_LEVEL_A::STATFF_LEVEL_7 => 7,
        }
    }
}
...
impl From<DMA_REQ_EN_SFF_A> for bool {
    ...
    fn from(variant: DMA_REQ_EN_SFF_A) -> Self {
        match variant {
            DMA_REQ_EN_SFF_A::DMA_REQ_EN_SFF_0 => false,
            DMA_REQ_EN_SFF_A::DMA_REQ_EN_SFF_1 => true,
        }
    }
}
...
impl From<DMA_REQ_EN_RFF_A> for bool {
    ...
    fn from(variant: DMA_REQ_EN_RFF_A) -> Self {
        match variant {
            DMA_REQ_EN_RFF_A::DMA_REQ_EN_RFF_0 => false,
            DMA_REQ_EN_RFF_A::DMA_REQ_EN_RFF_1 => true,
        }
    }
}
...
impl From<DMA_REFLASH_SFF_A> for bool {
    ...
    fn from(variant: DMA_REFLASH_SFF_A) -> Self {
        match variant {
            DMA_REFLASH_SFF_A::DMA_REFLASH_SFF_0 => false,
            DMA_REFLASH_SFF_A::DMA_REFLASH_SFF_1 => true,
        }
    }
}
...
impl From<DMA_REFLASH_RFF_A> for bool {
    ...
    fn from(variant: DMA_REFLASH_RFF_A) -> Self {
        match variant {
            DMA_REFLASH_RFF_A::DMA_REFLASH_RFF_0 => false,
            DMA_REFLASH_RFF_A::DMA_REFLASH_RFF_1 => true,
        }
    }
}
...
impl From<FRMCNT_RST_A> for bool {
    ...
    fn from(variant: FRMCNT_RST_A) -> Self {
        match variant {
            FRMCNT_RST_A::FRMCNT_RST_0 => false,
            FRMCNT_RST_A::FRMCNT_RST_1 => true,
        }
    }
}
