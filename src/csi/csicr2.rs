...
impl From<DMA_BURST_TYPE_SFF_A> for u8 {
    ...
    fn from(variant: DMA_BURST_TYPE_SFF_A) -> Self {
        match variant {
            DMA_BURST_TYPE_SFF_A::DMA_BURST_TYPE_SFF_0 => 0,
            DMA_BURST_TYPE_SFF_A::DMA_BURST_TYPE_SFF_1 => 1,
            DMA_BURST_TYPE_SFF_A::DMA_BURST_TYPE_SFF_3 => 3,
        }
    }
}
...
impl From<DMA_BURST_TYPE_RFF_A> for u8 {
    ...
    fn from(variant: DMA_BURST_TYPE_RFF_A) -> Self {
        match variant {
            DMA_BURST_TYPE_RFF_A::DMA_BURST_TYPE_RFF_0 => 0,
            DMA_BURST_TYPE_RFF_A::DMA_BURST_TYPE_RFF_1 => 1,
            DMA_BURST_TYPE_RFF_A::DMA_BURST_TYPE_RFF_3 => 3,
        }
    }
}
