#[doc = "Reader of register USB2_CHRG_DETECT_SET"]
pub type R = crate::R<u32, super::USB2_CHRG_DETECT_SET>;
#[doc = "Writer for register USB2_CHRG_DETECT_SET"]
pub type W = crate::W<u32, super::USB2_CHRG_DETECT_SET>;
#[doc = "Register USB2_CHRG_DETECT_SET `reset()`'s with value 0"]
impl crate::ResetValue for super::USB2_CHRG_DETECT_SET {
    type Type = u32;
    #[inline(always)]
...
impl From<CHK_CONTACT_A> for bool {
    ...
    fn from(variant: CHK_CONTACT_A) -> Self {
        match variant {
            CHK_CONTACT_A::NO_CHECK => false,
            CHK_CONTACT_A::CHECK => true,
        }
    }
}
...
impl From<CHK_CHRG_B_A> for bool {
    ...
    fn from(variant: CHK_CHRG_B_A) -> Self {
        match variant {
            CHK_CHRG_B_A::CHECK => false,
            CHK_CHRG_B_A::NO_CHECK => true,
        }
    }
}
