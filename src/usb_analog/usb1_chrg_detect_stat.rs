#[doc = "Reader of register USB1_CHRG_DETECT_STAT"]
pub type R = crate::R<u32, super::USB1_CHRG_DETECT_STAT>;
...
impl From<PLUG_CONTACT_A> for bool {
    ...
    fn from(variant: PLUG_CONTACT_A) -> Self {
        match variant {
            PLUG_CONTACT_A::NO_CONTACT => false,
            PLUG_CONTACT_A::GOOD_CONTACT => true,
        }
    }
}
...
impl From<CHRG_DETECTED_A> for bool {
    ...
    fn from(variant: CHRG_DETECTED_A) -> Self {
        match variant {
            CHRG_DETECTED_A::CHARGER_NOT_PRESENT => false,
            CHRG_DETECTED_A::CHARGER_PRESENT => true,
        }
    }
}
