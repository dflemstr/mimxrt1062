#[doc = "Reader of register USB2_VBUS_DETECT_TOG"]
pub type R = crate::R<u32, super::USB2_VBUS_DETECT_TOG>;
#[doc = "Writer for register USB2_VBUS_DETECT_TOG"]
pub type W = crate::W<u32, super::USB2_VBUS_DETECT_TOG>;
#[doc = "Register USB2_VBUS_DETECT_TOG `reset()`'s with value 0x0010_0004"]
impl crate::ResetValue for super::USB2_VBUS_DETECT_TOG {
    type Type = u32;
    #[inline(always)]
...
impl From<VBUSVALID_THRESH_A> for u8 {
    ...
    fn from(variant: VBUSVALID_THRESH_A) -> Self {
        match variant {
            VBUSVALID_THRESH_A::_4V0 => 0,
            VBUSVALID_THRESH_A::_4V1 => 1,
            VBUSVALID_THRESH_A::_4V2 => 2,
            VBUSVALID_THRESH_A::_4V3 => 3,
            VBUSVALID_THRESH_A::_4V4 => 4,
            VBUSVALID_THRESH_A::_4V5 => 5,
            VBUSVALID_THRESH_A::_4V6 => 6,
            VBUSVALID_THRESH_A::_4V7 => 7,
        }
    }
}
