...
impl From<FRINDEX_A> for u16 {
    ...
    fn from(variant: FRINDEX_A) -> Self {
        match variant {
            FRINDEX_A::FRINDEX_0 => 0,
            FRINDEX_A::FRINDEX_1 => 1,
            FRINDEX_A::FRINDEX_2 => 2,
            FRINDEX_A::FRINDEX_3 => 3,
            FRINDEX_A::FRINDEX_4 => 4,
            FRINDEX_A::FRINDEX_5 => 5,
            FRINDEX_A::FRINDEX_6 => 6,
            FRINDEX_A::FRINDEX_7 => 7,
        }
    }
}
