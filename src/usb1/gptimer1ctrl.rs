#[doc = "Reader of register GPTIMER1CTRL"]
pub type R = crate::R<u32, super::GPTIMER1CTRL>;
#[doc = "Writer for register GPTIMER1CTRL"]
pub type W = crate::W<u32, super::GPTIMER1CTRL>;
#[doc = "Register GPTIMER1CTRL `reset()`'s with value 0"]
impl crate::ResetValue for super::GPTIMER1CTRL {
    type Type = u32;
    #[inline(always)]
...
impl From<GPTMODE_A> for bool {
    ...
    fn from(variant: GPTMODE_A) -> Self {
        match variant {
            GPTMODE_A::GPTMODE_0 => false,
            GPTMODE_A::GPTMODE_1 => true,
        }
    }
}
...
impl From<GPTRST_A> for bool {
    ...
    fn from(variant: GPTRST_A) -> Self {
        match variant {
            GPTRST_A::GPTRST_0 => false,
            GPTRST_A::GPTRST_1 => true,
        }
    }
}
...
impl From<GPTRUN_A> for bool {
    ...
    fn from(variant: GPTRUN_A) -> Self {
        match variant {
            GPTRUN_A::GPTRUN_0 => false,
            GPTRUN_A::GPTRUN_1 => true,
        }
    }
}
