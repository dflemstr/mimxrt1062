...
impl From<LPRIOEN_A> for bool {
    ...
    fn from(variant: LPRIOEN_A) -> Self {
        match variant {
            LPRIOEN_A::LPRIOEN_0 => false,
            LPRIOEN_A::LPRIOEN_1 => true,
        }
    }
}
...
impl From<SRXDIS_A> for bool {
    ...
    fn from(variant: SRXDIS_A) -> Self {
        match variant {
            SRXDIS_A::SRXDIS_0 => false,
            SRXDIS_A::SRXDIS_1 => true,
        }
    }
}
...
impl From<WAKSRC_A> for bool {
    ...
    fn from(variant: WAKSRC_A) -> Self {
        match variant {
            WAKSRC_A::WAKSRC_0 => false,
            WAKSRC_A::WAKSRC_1 => true,
        }
    }
}
...
impl From<LPMACK_A> for bool {
    ...
    fn from(variant: LPMACK_A) -> Self {
        match variant {
            LPMACK_A::LPMACK_0 => false,
            LPMACK_A::LPMACK_1 => true,
        }
    }
}
...
impl From<WRNEN_A> for bool {
    ...
    fn from(variant: WRNEN_A) -> Self {
        match variant {
            WRNEN_A::WRNEN_0 => false,
            WRNEN_A::WRNEN_1 => true,
        }
    }
}
...
impl From<SLFWAK_A> for bool {
    ...
    fn from(variant: SLFWAK_A) -> Self {
        match variant {
            SLFWAK_A::SLFWAK_0 => false,
            SLFWAK_A::SLFWAK_1 => true,
        }
    }
}
...
impl From<FRZACK_A> for bool {
    ...
    fn from(variant: FRZACK_A) -> Self {
        match variant {
            FRZACK_A::FRZACK_0 => false,
            FRZACK_A::FRZACK_1 => true,
        }
    }
}
...
impl From<SOFTRST_A> for bool {
    ...
    fn from(variant: SOFTRST_A) -> Self {
        match variant {
            SOFTRST_A::SOFTRST_0 => false,
            SOFTRST_A::SOFTRST_1 => true,
        }
    }
}
...
impl From<WAKMSK_A> for bool {
    ...
    fn from(variant: WAKMSK_A) -> Self {
        match variant {
            WAKMSK_A::WAKMSK_0 => false,
            WAKMSK_A::WAKMSK_1 => true,
        }
    }
}
...
impl From<NOTRDY_A> for bool {
    ...
    fn from(variant: NOTRDY_A) -> Self {
        match variant {
            NOTRDY_A::NOTRDY_0 => false,
            NOTRDY_A::NOTRDY_1 => true,
        }
    }
}
