...
impl From<HPC_DMA_A> for bool {
    ...
    fn from(variant: HPC_DMA_A) -> Self {
        match variant {
            HPC_DMA_A::HPC_DMA_0 => false,
            HPC_DMA_A::HPC_DMA_1 => true,
        }
    }
}
...
impl From<HPC_LCDIF_A> for bool {
    ...
    fn from(variant: HPC_LCDIF_A) -> Self {
        match variant {
            HPC_LCDIF_A::HPC_LCDIF_0 => false,
            HPC_LCDIF_A::HPC_LCDIF_1 => true,
        }
    }
}
...
impl From<HPC_CSI_A> for bool {
    ...
    fn from(variant: HPC_CSI_A) -> Self {
        match variant {
            HPC_CSI_A::HPC_CSI_0 => false,
            HPC_CSI_A::HPC_CSI_1 => true,
        }
    }
}
...
impl From<HPC_PXP_A> for bool {
    ...
    fn from(variant: HPC_PXP_A) -> Self {
        match variant {
            HPC_PXP_A::HPC_PXP_0 => false,
            HPC_PXP_A::HPC_PXP_1 => true,
        }
    }
}
...
impl From<HPC_DCP_A> for bool {
    ...
    fn from(variant: HPC_DCP_A) -> Self {
        match variant {
            HPC_DCP_A::HPC_DCP_0 => false,
            HPC_DCP_A::HPC_DCP_1 => true,
        }
    }
}
...
impl From<HPC_ENET_A> for bool {
    ...
    fn from(variant: HPC_ENET_A) -> Self {
        match variant {
            HPC_ENET_A::HPC_ENET_0 => false,
            HPC_ENET_A::HPC_ENET_1 => true,
        }
    }
}
...
impl From<HPC_USDHC1_A> for bool {
    ...
    fn from(variant: HPC_USDHC1_A) -> Self {
        match variant {
            HPC_USDHC1_A::HPC_USDHC1_0 => false,
            HPC_USDHC1_A::HPC_USDHC1_1 => true,
        }
    }
}
...
impl From<HPC_USDHC2_A> for bool {
    ...
    fn from(variant: HPC_USDHC2_A) -> Self {
        match variant {
            HPC_USDHC2_A::HPC_USDHC2_0 => false,
            HPC_USDHC2_A::HPC_USDHC2_1 => true,
        }
    }
}
...
impl From<HPC_TPSMP_A> for bool {
    ...
    fn from(variant: HPC_TPSMP_A) -> Self {
        match variant {
            HPC_TPSMP_A::HPC_TPSMP_0 => false,
            HPC_TPSMP_A::HPC_TPSMP_1 => true,
        }
    }
}
...
impl From<HPC_USB_A> for bool {
    ...
    fn from(variant: HPC_USB_A) -> Self {
        match variant {
            HPC_USB_A::HPC_USB_0 => false,
            HPC_USB_A::HPC_USB_1 => true,
        }
    }
}
