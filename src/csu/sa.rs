...
impl From<NSA_DMA_A> for bool {
    ...
    fn from(variant: NSA_DMA_A) -> Self {
        match variant {
            NSA_DMA_A::NSA_DMA_0 => false,
            NSA_DMA_A::NSA_DMA_1 => true,
        }
    }
}
...
impl From<NSA_LCDIF_A> for bool {
    ...
    fn from(variant: NSA_LCDIF_A) -> Self {
        match variant {
            NSA_LCDIF_A::NSA_LCDIF_0 => false,
            NSA_LCDIF_A::NSA_LCDIF_1 => true,
        }
    }
}
...
impl From<NSA_CSI_A> for bool {
    ...
    fn from(variant: NSA_CSI_A) -> Self {
        match variant {
            NSA_CSI_A::NSA_CSI_0 => false,
            NSA_CSI_A::NSA_CSI_1 => true,
        }
    }
}
...
impl From<NSA_PXP_A> for bool {
    ...
    fn from(variant: NSA_PXP_A) -> Self {
        match variant {
            NSA_PXP_A::NSA_PXP_0 => false,
            NSA_PXP_A::NSA_PXP_1 => true,
        }
    }
}
...
impl From<NSA_DCP_A> for bool {
    ...
    fn from(variant: NSA_DCP_A) -> Self {
        match variant {
            NSA_DCP_A::NSA_DCP_0 => false,
            NSA_DCP_A::NSA_DCP_1 => true,
        }
    }
}
...
impl From<NSA_ENET_A> for bool {
    ...
    fn from(variant: NSA_ENET_A) -> Self {
        match variant {
            NSA_ENET_A::NSA_ENET_0 => false,
            NSA_ENET_A::NSA_ENET_1 => true,
        }
    }
}
...
impl From<NSA_USDHC1_A> for bool {
    ...
    fn from(variant: NSA_USDHC1_A) -> Self {
        match variant {
            NSA_USDHC1_A::NSA_USDHC1_0 => false,
            NSA_USDHC1_A::NSA_USDHC1_1 => true,
        }
    }
}
...
impl From<NSA_USDHC2_A> for bool {
    ...
    fn from(variant: NSA_USDHC2_A) -> Self {
        match variant {
            NSA_USDHC2_A::NSA_USDHC2_0 => false,
            NSA_USDHC2_A::NSA_USDHC2_1 => true,
        }
    }
}
...
impl From<NSA_TPSMP_A> for bool {
    ...
    fn from(variant: NSA_TPSMP_A) -> Self {
        match variant {
            NSA_TPSMP_A::NSA_TPSMP_0 => false,
            NSA_TPSMP_A::NSA_TPSMP_1 => true,
        }
    }
}
...
impl From<NSA_USB_A> for bool {
    ...
    fn from(variant: NSA_USB_A) -> Self {
        match variant {
            NSA_USB_A::NSA_USB_0 => false,
            NSA_USB_A::NSA_USB_1 => true,
        }
    }
}
