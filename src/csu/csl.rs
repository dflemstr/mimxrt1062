...
impl From<SUR_S2_A> for bool {
    ...
    fn from(variant: SUR_S2_A) -> Self {
        match variant {
            SUR_S2_A::SUR_S2_0 => false,
            SUR_S2_A::SUR_S2_1 => true,
        }
    }
}
...
impl From<SSR_S2_A> for bool {
    ...
    fn from(variant: SSR_S2_A) -> Self {
        match variant {
            SSR_S2_A::SSR_S2_0 => false,
            SSR_S2_A::SSR_S2_1 => true,
        }
    }
}
...
impl From<NUR_S2_A> for bool {
    ...
    fn from(variant: NUR_S2_A) -> Self {
        match variant {
            NUR_S2_A::NUR_S2_0 => false,
            NUR_S2_A::NUR_S2_1 => true,
        }
    }
}
...
impl From<NSR_S2_A> for bool {
    ...
    fn from(variant: NSR_S2_A) -> Self {
        match variant {
            NSR_S2_A::NSR_S2_0 => false,
            NSR_S2_A::NSR_S2_1 => true,
        }
    }
}
...
impl From<SUW_S2_A> for bool {
    ...
    fn from(variant: SUW_S2_A) -> Self {
        match variant {
            SUW_S2_A::SUW_S2_0 => false,
            SUW_S2_A::SUW_S2_1 => true,
        }
    }
}
...
impl From<SSW_S2_A> for bool {
    ...
    fn from(variant: SSW_S2_A) -> Self {
        match variant {
            SSW_S2_A::SSW_S2_0 => false,
            SSW_S2_A::SSW_S2_1 => true,
        }
    }
}
...
impl From<NUW_S2_A> for bool {
    ...
    fn from(variant: NUW_S2_A) -> Self {
        match variant {
            NUW_S2_A::NUW_S2_0 => false,
            NUW_S2_A::NUW_S2_1 => true,
        }
    }
}
...
impl From<NSW_S2_A> for bool {
    ...
    fn from(variant: NSW_S2_A) -> Self {
        match variant {
            NSW_S2_A::NSW_S2_0 => false,
            NSW_S2_A::NSW_S2_1 => true,
        }
    }
}
...
impl From<LOCK_S2_A> for bool {
    ...
    fn from(variant: LOCK_S2_A) -> Self {
        match variant {
            LOCK_S2_A::LOCK_S2_0 => false,
            LOCK_S2_A::LOCK_S2_1 => true,
        }
    }
}
...
impl From<SUR_S1_A> for bool {
    ...
    fn from(variant: SUR_S1_A) -> Self {
        match variant {
            SUR_S1_A::SUR_S1_0 => false,
            SUR_S1_A::SUR_S1_1 => true,
        }
    }
}
...
impl From<SSR_S1_A> for bool {
    ...
    fn from(variant: SSR_S1_A) -> Self {
        match variant {
            SSR_S1_A::SSR_S1_0 => false,
            SSR_S1_A::SSR_S1_1 => true,
        }
    }
}
...
impl From<NUR_S1_A> for bool {
    ...
    fn from(variant: NUR_S1_A) -> Self {
        match variant {
            NUR_S1_A::NUR_S1_0 => false,
            NUR_S1_A::NUR_S1_1 => true,
        }
    }
}
...
impl From<NSR_S1_A> for bool {
    ...
    fn from(variant: NSR_S1_A) -> Self {
        match variant {
            NSR_S1_A::NSR_S1_0 => false,
            NSR_S1_A::NSR_S1_1 => true,
        }
    }
}
...
impl From<SUW_S1_A> for bool {
    ...
    fn from(variant: SUW_S1_A) -> Self {
        match variant {
            SUW_S1_A::SUW_S1_0 => false,
            SUW_S1_A::SUW_S1_1 => true,
        }
    }
}
...
impl From<SSW_S1_A> for bool {
    ...
    fn from(variant: SSW_S1_A) -> Self {
        match variant {
            SSW_S1_A::SSW_S1_0 => false,
            SSW_S1_A::SSW_S1_1 => true,
        }
    }
}
...
impl From<NUW_S1_A> for bool {
    ...
    fn from(variant: NUW_S1_A) -> Self {
        match variant {
            NUW_S1_A::NUW_S1_0 => false,
            NUW_S1_A::NUW_S1_1 => true,
        }
    }
}
...
impl From<NSW_S1_A> for bool {
    ...
    fn from(variant: NSW_S1_A) -> Self {
        match variant {
            NSW_S1_A::NSW_S1_0 => false,
            NSW_S1_A::NSW_S1_1 => true,
        }
    }
}
...
impl From<LOCK_S1_A> for bool {
    ...
    fn from(variant: LOCK_S1_A) -> Self {
        match variant {
            LOCK_S1_A::LOCK_S1_0 => false,
            LOCK_S1_A::LOCK_S1_1 => true,
        }
    }
}
