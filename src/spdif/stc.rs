...
impl From<TXCLK_DF_A> for u8 {
    ...
    fn from(variant: TXCLK_DF_A) -> Self {
        match variant {
            TXCLK_DF_A::TXCLK_DF_0 => 0,
            TXCLK_DF_A::TXCLK_DF_1 => 1,
            TXCLK_DF_A::TXCLK_DF_127 => 127,
        }
    }
}
...
impl From<TX_ALL_CLK_EN_A> for bool {
    ...
    fn from(variant: TX_ALL_CLK_EN_A) -> Self {
        match variant {
            TX_ALL_CLK_EN_A::TX_ALL_CLK_EN_0 => false,
            TX_ALL_CLK_EN_A::TX_ALL_CLK_EN_1 => true,
        }
    }
}
...
impl From<TXCLK_SOURCE_A> for u8 {
    ...
    fn from(variant: TXCLK_SOURCE_A) -> Self {
        match variant {
            TXCLK_SOURCE_A::TXCLK_SOURCE_0 => 0,
            TXCLK_SOURCE_A::TXCLK_SOURCE_1 => 1,
            TXCLK_SOURCE_A::TXCLK_SOURCE_2 => 2,
            TXCLK_SOURCE_A::TXCLK_SOURCE_3 => 3,
            TXCLK_SOURCE_A::TXCLK_SOURCE_4 => 4,
            TXCLK_SOURCE_A::TXCLK_SOURCE_5 => 5,
            TXCLK_SOURCE_A::TXCLK_SOURCE_6 => 6,
        }
    }
}
...
impl From<SYSCLK_DF_A> for u16 {
    ...
    fn from(variant: SYSCLK_DF_A) -> Self {
        match variant {
            SYSCLK_DF_A::SYSCLK_DF_0 => 0,
            SYSCLK_DF_A::SYSCLK_DF_1 => 1,
            SYSCLK_DF_A::SYSCLK_DF_511 => 511,
        }
    }
}
