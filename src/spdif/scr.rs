...
impl From<USRC_SEL_A> for u8 {
    ...
    fn from(variant: USRC_SEL_A) -> Self {
        match variant {
            USRC_SEL_A::USRC_SEL_0 => 0,
            USRC_SEL_A::USRC_SEL_1 => 1,
            USRC_SEL_A::USRC_SEL_3 => 3,
        }
    }
}
...
impl From<VALCTRL_A> for bool {
    ...
    fn from(variant: VALCTRL_A) -> Self {
        match variant {
            VALCTRL_A::VALCTRL_0 => false,
            VALCTRL_A::VALCTRL_1 => true,
        }
    }
}
...
impl From<TXFIFO_CTRL_A> for u8 {
    ...
    fn from(variant: TXFIFO_CTRL_A) -> Self {
        match variant {
            TXFIFO_CTRL_A::TXFIFO_CTRL_0 => 0,
            TXFIFO_CTRL_A::TXFIFO_CTRL_1 => 1,
            TXFIFO_CTRL_A::TXFIFO_CTRL_2 => 2,
        }
    }
}
...
impl From<TXFIFOEMPTY_SEL_A> for u8 {
    ...
    fn from(variant: TXFIFOEMPTY_SEL_A) -> Self {
        match variant {
            TXFIFOEMPTY_SEL_A::TXFIFOEMPTY_SEL_0 => 0,
            TXFIFOEMPTY_SEL_A::TXFIFOEMPTY_SEL_1 => 1,
            TXFIFOEMPTY_SEL_A::TXFIFOEMPTY_SEL_2 => 2,
            TXFIFOEMPTY_SEL_A::TXFIFOEMPTY_SEL_3 => 3,
        }
    }
}
...
impl From<TXAUTOSYNC_A> for bool {
    ...
    fn from(variant: TXAUTOSYNC_A) -> Self {
        match variant {
            TXAUTOSYNC_A::TXAUTOSYNC_0 => false,
            TXAUTOSYNC_A::TXAUTOSYNC_1 => true,
        }
    }
}
...
impl From<RXAUTOSYNC_A> for bool {
    ...
    fn from(variant: RXAUTOSYNC_A) -> Self {
        match variant {
            RXAUTOSYNC_A::RXAUTOSYNC_0 => false,
            RXAUTOSYNC_A::RXAUTOSYNC_1 => true,
        }
    }
}
...
impl From<RXFIFOFULL_SEL_A> for u8 {
    ...
    fn from(variant: RXFIFOFULL_SEL_A) -> Self {
        match variant {
            RXFIFOFULL_SEL_A::RXFIFOFULL_SEL_0 => 0,
            RXFIFOFULL_SEL_A::RXFIFOFULL_SEL_1 => 1,
            RXFIFOFULL_SEL_A::RXFIFOFULL_SEL_2 => 2,
            RXFIFOFULL_SEL_A::RXFIFOFULL_SEL_3 => 3,
        }
    }
}
...
impl From<RXFIFO_RST_A> for bool {
    ...
    fn from(variant: RXFIFO_RST_A) -> Self {
        match variant {
            RXFIFO_RST_A::RXFIFO_RST_0 => false,
            RXFIFO_RST_A::RXFIFO_RST_1 => true,
        }
    }
}
...
impl From<RXFIFO_OFF_ON_A> for bool {
    ...
    fn from(variant: RXFIFO_OFF_ON_A) -> Self {
        match variant {
            RXFIFO_OFF_ON_A::RXFIFO_OFF_ON_0 => false,
            RXFIFO_OFF_ON_A::RXFIFO_OFF_ON_1 => true,
        }
    }
}
...
impl From<RXFIFO_CTRL_A> for bool {
    ...
    fn from(variant: RXFIFO_CTRL_A) -> Self {
        match variant {
            RXFIFO_CTRL_A::RXFIFO_CTRL_0 => false,
            RXFIFO_CTRL_A::RXFIFO_CTRL_1 => true,
        }
    }
}
