...
impl From<GAINSEL_A> for u8 {
    ...
    fn from(variant: GAINSEL_A) -> Self {
        match variant {
            GAINSEL_A::GAINSEL_0 => 0,
            GAINSEL_A::GAINSEL_1 => 1,
            GAINSEL_A::GAINSEL_2 => 2,
            GAINSEL_A::GAINSEL_3 => 3,
            GAINSEL_A::GAINSEL_4 => 4,
            GAINSEL_A::GAINSEL_5 => 5,
            GAINSEL_A::GAINSEL_6 => 6,
        }
    }
}
...
impl From<CLKSRC_SEL_A> for u8 {
    ...
    fn from(variant: CLKSRC_SEL_A) -> Self {
        match variant {
            CLKSRC_SEL_A::CLKSRC_SEL_0 => 0,
            CLKSRC_SEL_A::CLKSRC_SEL_1 => 1,
            CLKSRC_SEL_A::CLKSRC_SEL_3 => 3,
            CLKSRC_SEL_A::CLKSRC_SEL_5 => 5,
            CLKSRC_SEL_A::CLKSRC_SEL_6 => 6,
            CLKSRC_SEL_A::CLKSRC_SEL_8 => 8,
        }
    }
}
