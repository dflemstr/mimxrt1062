...
impl From<OUTMODE_A> for u8 {
    ...
    fn from(variant: OUTMODE_A) -> Self {
        match variant {
            OUTMODE_A::OUTMODE_0 => 0,
            OUTMODE_A::OUTMODE_1 => 1,
            OUTMODE_A::OUTMODE_2 => 2,
            OUTMODE_A::OUTMODE_3 => 3,
            OUTMODE_A::OUTMODE_4 => 4,
            OUTMODE_A::OUTMODE_5 => 5,
            OUTMODE_A::OUTMODE_6 => 6,
            OUTMODE_A::OUTMODE_7 => 7,
        }
    }
}
...
impl From<COINIT_A> for bool {
    ...
    fn from(variant: COINIT_A) -> Self {
        match variant {
            COINIT_A::COINIT_0 => false,
            COINIT_A::COINIT_1 => true,
        }
    }
}
...
impl From<LENGTH_A> for bool {
    ...
    fn from(variant: LENGTH_A) -> Self {
        match variant {
            LENGTH_A::LENGTH_0 => false,
            LENGTH_A::LENGTH_1 => true,
        }
    }
}
...
pub enum CM_A {
    #[doc = "0: No operation"]
    CM_0,
    #[doc = "1: Count rising edges of primary sourceRising edges are counted only when SCTRL\\[IPS\\] = 0. Falling edges are counted when SCTRL\\[IPS\\] = 1. If the primary count source is IP bus clock divide by 1, only rising edges are counted regardless of the value of SCTRL\\[IPS\\]."]
    CM_1,
    ...
    CM_4,
    #[doc = "5: Count rising edges of primary source; secondary source specifies directionRising edges are counted only when SCTRL\\[IPS\\] = 0. Falling edges are counted when SCTRL\\[IPS\\] = 1."]
    CM_5,
