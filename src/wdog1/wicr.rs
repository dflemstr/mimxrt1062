...
pub enum WICT_A {
    #[doc = "0: WICT\\[7:0\\] = Time duration between interrupt and time-out is 0 seconds."]
    WICT_0,
    #[doc = "1: WICT\\[7:0\\] = Time duration between interrupt and time-out is 0.5 seconds."]
    WICT_1,
    #[doc = "4: WICT\\[7:0\\] = Time duration between interrupt and time-out is 2 seconds (Default)."]
    WICT_4,
    #[doc = "255: WICT\\[7:0\\] = Time duration between interrupt and time-out is 127.5 seconds."]
    WICT_255,
}
