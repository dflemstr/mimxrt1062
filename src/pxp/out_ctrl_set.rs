#[doc = "Reader of register OUT_CTRL_SET"]
pub type R = crate::R<u32, super::OUT_CTRL_SET>;
#[doc = "Writer for register OUT_CTRL_SET"]
pub type W = crate::W<u32, super::OUT_CTRL_SET>;
#[doc = "Register OUT_CTRL_SET `reset()`'s with value 0"]
impl crate::ResetValue for super::OUT_CTRL_SET {
    type Type = u32;
    #[inline(always)]
