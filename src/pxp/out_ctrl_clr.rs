#[doc = "Reader of register OUT_CTRL_CLR"]
pub type R = crate::R<u32, super::OUT_CTRL_CLR>;
#[doc = "Writer for register OUT_CTRL_CLR"]
pub type W = crate::W<u32, super::OUT_CTRL_CLR>;
#[doc = "Register OUT_CTRL_CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::OUT_CTRL_CLR {
    type Type = u32;
    #[inline(always)]
...
impl From<FORMAT_A> for u8 {
    ...
    fn from(variant: FORMAT_A) -> Self {
        match variant {
            ...
            FORMAT_A::RGB444 => 13,
            FORMAT_A::RGB565 => 14,
            FORMAT_A::YUV1P444 => 16,
            FORMAT_A::UYVY1P422 => 18,
            FORMAT_A::VYUY1P422 => 19,
            FORMAT_A::Y8 => 20,
            FORMAT_A::Y4 => 21,
            FORMAT_A::YUV2P422 => 24,
            FORMAT_A::YUV2P420 => 25,
            FORMAT_A::YVU2P422 => 26,
            FORMAT_A::YVU2P420 => 27,
        }
    }
}
...
impl From<INTERLACED_OUTPUT_A> for u8 {
    ...
    fn from(variant: INTERLACED_OUTPUT_A) -> Self {
        match variant {
            INTERLACED_OUTPUT_A::PROGRESSIVE => 0,
            INTERLACED_OUTPUT_A::FIELD0 => 1,
            INTERLACED_OUTPUT_A::FIELD1 => 2,
            INTERLACED_OUTPUT_A::INTERLACED => 3,
        }
    }
}
