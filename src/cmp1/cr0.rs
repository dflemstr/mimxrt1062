...
impl From<FILTER_CNT_A> for u8 {
    ...
    fn from(variant: FILTER_CNT_A) -> Self {
        match variant {
            FILTER_CNT_A::FILTER_CNT_0 => 0,
            FILTER_CNT_A::FILTER_CNT_1 => 1,
            FILTER_CNT_A::FILTER_CNT_2 => 2,
            FILTER_CNT_A::FILTER_CNT_3 => 3,
            FILTER_CNT_A::FILTER_CNT_4 => 4,
            FILTER_CNT_A::FILTER_CNT_5 => 5,
            FILTER_CNT_A::FILTER_CNT_6 => 6,
            FILTER_CNT_A::FILTER_CNT_7 => 7,
        }
    }
}
