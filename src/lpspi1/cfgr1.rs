...
impl From<MASTER_A> for bool {
    ...
    fn from(variant: MASTER_A) -> Self {
        match variant {
            MASTER_A::MASTER_0 => false,
            MASTER_A::MASTER_1 => true,
        }
    }
}
...
impl From<SAMPLE_A> for bool {
    ...
    fn from(variant: SAMPLE_A) -> Self {
        match variant {
            SAMPLE_A::SAMPLE_0 => false,
            SAMPLE_A::SAMPLE_1 => true,
        }
    }
}
...
impl From<AUTOPCS_A> for bool {
    ...
    fn from(variant: AUTOPCS_A) -> Self {
        match variant {
            AUTOPCS_A::AUTOPCS_0 => false,
            AUTOPCS_A::AUTOPCS_1 => true,
        }
    }
}
...
impl From<NOSTALL_A> for bool {
    ...
    fn from(variant: NOSTALL_A) -> Self {
        match variant {
            NOSTALL_A::NOSTALL_0 => false,
            NOSTALL_A::NOSTALL_1 => true,
        }
    }
}
...
impl From<OUTCFG_A> for bool {
    ...
    fn from(variant: OUTCFG_A) -> Self {
        match variant {
            OUTCFG_A::OUTCFG_0 => false,
            OUTCFG_A::OUTCFG_1 => true,
        }
    }
}
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PCSCFG_A {
    #[doc = "0: PCS\\[3:2\\] are enabled"]
    PCSCFG_0,
    #[doc = "1: PCS\\[3:2\\] are disabled"]
    PCSCFG_1,
}
impl From<PCSCFG_A> for bool {
    ...
    fn from(variant: PCSCFG_A) -> Self {
        match variant {
            PCSCFG_A::PCSCFG_0 => false,
            PCSCFG_A::PCSCFG_1 => true,
        }
    }
}
