#[doc = "Reader of register LOWPWR_CTRL_CLR"]
pub type R = crate::R<u32, super::LOWPWR_CTRL_CLR>;
#[doc = "Writer for register LOWPWR_CTRL_CLR"]
pub type W = crate::W<u32, super::LOWPWR_CTRL_CLR>;
#[doc = "Register LOWPWR_CTRL_CLR `reset()`'s with value 0x4001"]
impl crate::ResetValue for super::LOWPWR_CTRL_CLR {
    type Type = u32;
    #[inline(always)]
...
impl From<RC_OSC_EN_A> for bool {
    ...
    fn from(variant: RC_OSC_EN_A) -> Self {
        match variant {
            RC_OSC_EN_A::RC_OSC_EN_0 => false,
            RC_OSC_EN_A::RC_OSC_EN_1 => true,
        }
    }
}
...
impl From<OSC_SEL_A> for bool {
    ...
    fn from(variant: OSC_SEL_A) -> Self {
        match variant {
            OSC_SEL_A::OSC_SEL_0 => false,
            OSC_SEL_A::OSC_SEL_1 => true,
        }
    }
}
...
impl From<LPBG_SEL_A> for bool {
    ...
    fn from(variant: LPBG_SEL_A) -> Self {
        match variant {
            LPBG_SEL_A::LPBG_SEL_0 => false,
            LPBG_SEL_A::LPBG_SEL_1 => true,
        }
    }
}
...
impl From<XTALOSC_PWRUP_DELAY_A> for u8 {
    ...
    fn from(variant: XTALOSC_PWRUP_DELAY_A) -> Self {
        match variant {
            XTALOSC_PWRUP_DELAY_A::XTALOSC_PWRUP_DELAY_0 => 0,
            XTALOSC_PWRUP_DELAY_A::XTALOSC_PWRUP_DELAY_1 => 1,
            XTALOSC_PWRUP_DELAY_A::XTALOSC_PWRUP_DELAY_2 => 2,
            XTALOSC_PWRUP_DELAY_A::XTALOSC_PWRUP_DELAY_3 => 3,
        }
    }
}
...
impl From<XTALOSC_PWRUP_STAT_A> for bool {
    ...
    fn from(variant: XTALOSC_PWRUP_STAT_A) -> Self {
        match variant {
            XTALOSC_PWRUP_STAT_A::XTALOSC_PWRUP_STAT_0 => false,
            XTALOSC_PWRUP_STAT_A::XTALOSC_PWRUP_STAT_1 => true,
        }
    }
}
